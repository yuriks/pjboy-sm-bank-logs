...
$B3:870A 9D 92 0F    STA $0F92,x            ;} Instruction pointer = $86A7
$B3:870D 6B          RTL
}
...
;;; $882B: Instruction list pointers ;;;
{
...
$B3:8841 9D AA 0F    STA $0FAA,x[$7E:11EA]
$B3:8844 BD 7E 0F    LDA $0F7E,x[$7E:11BE]
$B3:8847 9D AC 0F    STA $0FAC,x[$7E:11EC]
$B3:884A 38          SEC
$B3:884B E9 10 00    SBC #$0010
$B3:884E 9F 00 78 7E STA $7E7800,x[$7E:7A40]
$B3:8852 A9 80 88    LDA #$8880
$B3:8855 9D B2 0F    STA $0FB2,x[$7E:11F2]
$B3:8858 A9 30 00    LDA #$0030
$B3:885B 9D AE 0F    STA $0FAE,x[$7E:11EE]
$B3:885E A9 00 00    LDA #$0000
$B3:8861 9D B0 0F    STA $0FB0,x[$7E:11F0]
$B3:8864 9F 02 78 7E STA $7E7802,x[$7E:7A42]
$B3:8868 A9 AB 87    LDA #$87AB
$B3:886B 9D 92 0F    STA $0F92,x[$7E:11D2]
$B3:886E BD B4 0F    LDA $0FB4,x[$7E:11F4]
$B3:8871 F0 06       BEQ $06    [$8879]
$B3:8873 A9 1D 8A    LDA #$8A1D
$B3:8876 9D 92 0F    STA $0F92,x[$7E:1092]
...
$B3:8887 D0 06       BNE $06    [$888F]
$B3:8889 A9 90 88    LDA #$8890
$B3:888C 9D B2 0F    STA $0FB2,x[$7E:11F2]
...
$B3:88BD 9D B2 0F    STA $0FB2,x[$7E:11F2]
$B3:88C0 BD 86 0F    LDA $0F86,x[$7E:11C6]
$B3:88C3 29 FF FE    AND #$FEFF
$B3:88C6 9D 86 0F    STA $0F86,x[$7E:11C6]
$B3:88C9 A9 00 00    LDA #$0000
$B3:88CC 9D 90 0F    STA $0F90,x[$7E:11D0]
$B3:88CF 3C A8 0F    BIT $0FA8,x[$7E:11E8]
$B3:88D2 30 05       BMI $05    [$88D9]
$B3:88D4 A9 02 00    LDA #$0002
$B3:88D7 80 03       BRA $03    [$88DC]

$B3:88D9 A9 00 00    LDA #$0000

$B3:88DC 9D B0 0F    STA $0FB0,x[$7E:11F0]
$B3:88DF 20 8B 89    JSR $898B  [$B3:898B]
$B3:88E2 6B          RTL
}
...
$B3:88EA 9D 80 0F    STA $0F80,x[$7E:11C0]
...
$B3:88FA DD 7E 0F    CMP $0F7E,x[$7E:11BE]
$B3:88FD 30 1C       BMI $1C    [$891B]
$B3:88FF BD 7E 0F    LDA $0F7E,x[$7E:11BE]
$B3:8902 CD FA 0A    CMP $0AFA  [$7E:0AFA]
$B3:8905 90 02       BCC $02    [$8909]
$B3:8907 80 12       BRA $12    [$891B]

$B3:8909 BD B0 0F    LDA $0FB0,x[$7E:11F0]
$B3:890C 09 01 00    ORA #$0001
$B3:890F 9D B0 0F    STA $0FB0,x[$7E:11F0]
$B3:8912 20 8B 89    JSR $898B  [$B3:898B]
$B3:8915 A9 1C 89    LDA #$891C
$B3:8918 9D B2 0F    STA $0FB2,x[$7E:11F2]
...
;;; $897E:  ;;;
{
$B3:897E DE AE 0F    DEC $0FAE,x[$7E:11EE]
$B3:8981 F0 01       BEQ $01    [$8984]
$B3:8983 6B          RTL

$B3:8984 A9 90 88    LDA #$8890
$B3:8987 9D B2 0F    STA $0FB2,x[$7E:11F2]
$B3:898A 6B          RTL
}
...
$B3:8991 DF 02 78 7E CMP $7E7802,x[$7E:7A42]
$B3:8995 F0 1F       BEQ $1F    [$89B6]
$B3:8997 9F 02 78 7E STA $7E7802,x[$7E:7A42]
$B3:899B 0A          ASL A
$B3:899C A8          TAY
$B3:899D BD B4 0F    LDA $0FB4,x[$7E:11F4]
$B3:89A0 D0 05       BNE $05    [$89A7]
$B3:89A2 B9 2B 88    LDA $882B,y[$B3:882F]
$B3:89A5 80 03       BRA $03    [$89AA]

$B3:89A7 B9 33 88    LDA $8833,y[$B3:8835]

$B3:89AA 9D 92 0F    STA $0F92,x[$7E:11D2]
$B3:89AD A9 01 00    LDA #$0001
$B3:89B0 9D 94 0F    STA $0F94,x[$7E:11D4]
$B3:89B3 9E 90 0F    STZ $0F90,x[$7E:11D0]
...
$B3:8B67 9D AE 0F    STA $0FAE,x[$7E:0FAE]
$B3:8B6A BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$B3:8B6D 9D B0 0F    STA $0FB0,x[$7E:0FB0]
$B3:8B70 BD 86 0F    LDA $0F86,x[$7E:0F86]
$B3:8B73 09 00 01    ORA #$0100
...
$B3:8B85 9E AC 0F    STZ $0FAC,x[$7E:0FAC]
$B3:8B88 A9 01 00    LDA #$0001
$B3:8B8B 9D 94 0F    STA $0F94,x[$7E:0F94]
$B3:8B8E 9E 90 0F    STZ $0F90,x[$7E:0F90]
$B3:8B91 A9 E1 8A    LDA #$8AE1
$B3:8B94 9D 92 0F    STA $0F92,x[$7E:0F92]
$B3:8B97 A9 CD 8B    LDA #$8BCD
$B3:8B9A 9D A8 0F    STA $0FA8,x[$7E:0FA8]
$B3:8B9D 6B          RTL
}
...
$B3:8BA1 FC A8 0F    JSR ($0FA8,x)[$B3:8BCD]
$B3:8BA4 20 A8 8B    JSR $8BA8  [$B3:8BA8]
$B3:8BA7 6B          RTL
}
...
$B3:8C11 CD FA 0A    CMP $0AFA  [$7E:0AFA]
$B3:8C14 30 3B       BMI $3B    [$8C51]
$B3:8C16 FE AC 0F    INC $0FAC,x[$7E:0FAC]
$B3:8C19 A9 01 00    LDA #$0001
$B3:8C1C 9D 94 0F    STA $0F94,x[$7E:0F94]
$B3:8C1F 9E 90 0F    STZ $0F90,x[$7E:0F90]
$B3:8C22 22 E5 AE A0 JSL $A0AEE5[$A0:AEE5]
$B3:8C26 10 14       BPL $14    [$8C3C]
$B3:8C28 A9 E1 8A    LDA #$8AE1
$B3:8C2B 9D 92 0F    STA $0F92,x[$7E:0FD2]
$B3:8C2E 9D D2 0F    STA $0FD2,x[$7E:1012]
$B3:8C31 9D 12 10    STA $1012,x[$7E:1052]
$B3:8C34 9D 52 10    STA $1052,x[$7E:1092]
$B3:8C37 9D 92 10    STA $1092,x[$7E:10D2]
$B3:8C3A 80 12       BRA $12    [$8C4E]

$B3:8C3C A9 21 8B    LDA #$8B21
$B3:8C3F 9D 92 0F    STA $0F92,x[$7E:0F92]
$B3:8C42 9D D2 0F    STA $0FD2,x[$7E:0FD2]
$B3:8C45 9D 12 10    STA $1012,x[$7E:1012]
$B3:8C48 9D 52 10    STA $1052,x[$7E:1052]
$B3:8C4B 9D 92 10    STA $1092,x[$7E:1092]

$B3:8C4E 20 52 8C    JSR $8C52  [$B3:8C52]
...
$B3:8C55 9D A8 0F    STA $0FA8,x[$7E:0FA8]
$B3:8C58 9D E8 0F    STA $0FE8,x[$7E:0FE8]
$B3:8C5B 9D 28 10    STA $1028,x[$7E:1028]
$B3:8C5E 9D 68 10    STA $1068,x[$7E:1068]
$B3:8C61 9D A8 10    STA $10A8,x[$7E:10A8]
$B3:8C64 A9 68 00    LDA #$0068
$B3:8C67 9F 04 78 7E STA $7E7804,x[$7E:7804]
$B3:8C6B A9 60 00    LDA #$0060
$B3:8C6E 9F 44 78 7E STA $7E7844,x[$7E:7844]
$B3:8C72 A9 58 00    LDA #$0058
$B3:8C75 9F 84 78 7E STA $7E7884,x[$7E:7884]
$B3:8C79 A9 70 00    LDA #$0070
$B3:8C7C 9F C4 78 7E STA $7E78C4,x[$7E:78C4]
$B3:8C80 A9 78 00    LDA #$0078
$B3:8C83 9F 04 79 7E STA $7E7904,x[$7E:7904]
$B3:8C87 A9 FF 8C    LDA #$8CFF
$B3:8C8A 9D B2 0F    STA $0FB2,x[$7E:0FB2]
$B3:8C8D A9 0C 8D    LDA #$8D0C
$B3:8C90 9D F2 0F    STA $0FF2,x[$7E:0FF2]
$B3:8C93 A9 4E 8D    LDA #$8D4E
$B3:8C96 9D 32 10    STA $1032,x[$7E:1032]
$B3:8C99 A9 90 8D    LDA #$8D90
$B3:8C9C 9D 72 10    STA $1072,x[$7E:1072]
$B3:8C9F A9 D2 8D    LDA #$8DD2
$B3:8CA2 9D B2 10    STA $10B2,x[$7E:10B2]
$B3:8CA5 60          RTS
}
...
$B3:8CD2 10 2A       BPL $2A    [$8CFE]
$B3:8CD4 BD B2 0F    LDA $0FB2,x[$7E:1032]
$B3:8CD7 9D A8 0F    STA $0FA8,x[$7E:1028]
$B3:8CDA BD 7E 0F    LDA $0F7E,x[$7E:0FFE]
$B3:8CDD 9F 02 78 7E STA $7E7802,x[$7E:7882]
$B3:8CE1 A9 01 00    LDA #$0001
$B3:8CE4 9D 94 0F    STA $0F94,x[$7E:1014]
$B3:8CE7 9E 90 0F    STZ $0F90,x[$7E:1010]
$B3:8CEA 22 E5 AE A0 JSL $A0AEE5[$A0:AEE5]
$B3:8CEE 10 08       BPL $08    [$8CF8]
$B3:8CF0 A9 E1 8A    LDA #$8AE1
$B3:8CF3 9D 92 0F    STA $0F92,x[$7E:1012]
$B3:8CF6 80 06       BRA $06    [$8CFE]

$B3:8CF8 A9 21 8B    LDA #$8B21
$B3:8CFB 9D 92 0F    STA $0F92,x[$7E:0F92]
...
$B3:8D02 FE AC 0F    INC $0FAC,x[$7E:0FEC]
$B3:8D05 A9 5A 8E    LDA #$8E5A
$B3:8D08 9D A8 0F    STA $0FA8,x[$7E:0FE8]
$B3:8D0B 60          RTS
$B3:8D0C AE 54 0E    LDX $0E54  [$7E:0E54]
$B3:8D0F FE AC 0F    INC $0FAC,x[$7E:102C]
...
$B3:8D33 DF 02 78 7E CMP $7E7802,x[$7E:7882]
$B3:8D37 10 14       BPL $14    [$8D4D]
$B3:8D39 BF 02 78 7E LDA $7E7802,x[$7E:7882]
$B3:8D3D 38          SEC
$B3:8D3E E9 10 00    SBC #$0010
$B3:8D41 9D 7E 0F    STA $0F7E,x[$7E:0FFE]
$B3:8D44 9E 80 0F    STZ $0F80,x[$7E:1000]
$B3:8D47 A9 5A 8E    LDA #$8E5A
$B3:8D4A 9D A8 0F    STA $0FA8,x[$7E:1028]
...
$B3:8D51 FE AC 0F    INC $0FAC,x[$7E:106C]
...
$B3:8D75 DF 02 78 7E CMP $7E7802,x[$7E:78C2]
$B3:8D79 10 14       BPL $14    [$8D8F]
$B3:8D7B BF 02 78 7E LDA $7E7802,x[$7E:78C2]
$B3:8D7F 38          SEC
$B3:8D80 E9 20 00    SBC #$0020
$B3:8D83 9D 7E 0F    STA $0F7E,x[$7E:103E]
$B3:8D86 9E 80 0F    STZ $0F80,x[$7E:1040]
$B3:8D89 A9 5A 8E    LDA #$8E5A
$B3:8D8C 9D A8 0F    STA $0FA8,x[$7E:1068]
...
$B3:8D93 FE AC 0F    INC $0FAC,x[$7E:10AC]
...
$B3:8DB7 DF 02 78 7E CMP $7E7802,x[$7E:7902]
$B3:8DBB 30 14       BMI $14    [$8DD1]
$B3:8DBD BF 02 78 7E LDA $7E7802,x[$7E:7902]
$B3:8DC1 18          CLC
$B3:8DC2 69 10 00    ADC #$0010
$B3:8DC5 9D 7E 0F    STA $0F7E,x[$7E:107E]
$B3:8DC8 9E 80 0F    STZ $0F80,x[$7E:1080]
$B3:8DCB A9 5A 8E    LDA #$8E5A
$B3:8DCE 9D A8 0F    STA $0FA8,x[$7E:10A8]
...
$B3:8DD5 FE AC 0F    INC $0FAC,x[$7E:10EC]
...
$B3:8DF9 DF 02 78 7E CMP $7E7802,x[$7E:7942]
$B3:8DFD 30 14       BMI $14    [$8E13]
$B3:8DFF BF 02 78 7E LDA $7E7802,x[$7E:7942]
$B3:8E03 18          CLC
$B3:8E04 69 20 00    ADC #$0020
$B3:8E07 9D 7E 0F    STA $0F7E,x[$7E:10BE]
$B3:8E0A 9E 80 0F    STZ $0F80,x[$7E:10C0]
$B3:8E0D A9 5A 8E    LDA #$8E5A
$B3:8E10 9D A8 0F    STA $0FA8,x[$7E:10E8]
...
$B3:8E5D FE AC 0F    INC $0FAC,x[$7E:0FEC]
$B3:8E60 BD AC 0F    LDA $0FAC,x[$7E:0FEC]
$B3:8E63 DF 04 78 7E CMP $7E7804,x[$7E:7844]
$B3:8E67 30 2A       BMI $2A    [$8E93]
$B3:8E69 9E AC 0F    STZ $0FAC,x[$7E:106C]
$B3:8E6C A9 01 00    LDA #$0001
$B3:8E6F 9D 94 0F    STA $0F94,x[$7E:1054]
$B3:8E72 9E 90 0F    STZ $0F90,x[$7E:1050]
$B3:8E75 A9 14 8E    LDA #$8E14
$B3:8E78 9D A8 0F    STA $0FA8,x[$7E:1068]
$B3:8E7B A9 05 8B    LDA #$8B05
$B3:8E7E 9D 92 0F    STA $0F92,x[$7E:1052]
$B3:8E81 22 E5 AE A0 JSL $A0AEE5[$A0:AEE5]
$B3:8E85 30 0C       BMI $0C    [$8E93]
$B3:8E87 A9 35 8E    LDA #$8E35
$B3:8E8A 9D A8 0F    STA $0FA8,x[$7E:1068]
$B3:8E8D A9 45 8B    LDA #$8B45
$B3:8E90 9D 92 0F    STA $0F92,x[$7E:1052]
...
$B3:8F52 9F 0E 78 7E STA $7E780E,x[$7E:78CE]
$B3:8F56 BD 7E 0F    LDA $0F7E,x[$7E:103E]
$B3:8F59 9F 10 78 7E STA $7E7810,x[$7E:78D0]
$B3:8F5D 9E 7C 0F    STZ $0F7C,x[$7E:103C]
$B3:8F60 9E 80 0F    STZ $0F80,x[$7E:1040]
$B3:8F63 A9 01 00    LDA #$0001
$B3:8F66 9D 94 0F    STA $0F94,x[$7E:1054]
$B3:8F69 9E 90 0F    STZ $0F90,x[$7E:1050]
$B3:8F6C A9 FC 8E    LDA #$8EFC
$B3:8F6F 9D 92 0F    STA $0F92,x[$7E:1052]
$B3:8F72 BD B4 0F    LDA $0FB4,x[$7E:1074]
$B3:8F75 D0 06       BNE $06    [$8F7D]
$B3:8F77 A9 24 8F    LDA #$8F24
$B3:8F7A 9D 92 0F    STA $0F92,x[$7E:1092]
...
$B3:8FFE F0 01       BEQ $01    [$9001]
$B3:9000 60          RTS

$B3:9001 A9 01 00    LDA #$0001
$B3:9004 9D 94 0F    STA $0F94,x[$7E:1054]
$B3:9007 9E 90 0F    STZ $0F90,x[$7E:1050]
$B3:900A A9 FC 8E    LDA #$8EFC
$B3:900D 9D 92 0F    STA $0F92,x[$7E:1052]
$B3:9010 A9 28 90    LDA #$9028
$B3:9013 9D A8 0F    STA $0FA8,x[$7E:1068]
$B3:9016 BD B4 0F    LDA $0FB4,x[$7E:1074]
$B3:9019 D0 0C       BNE $0C    [$9027]
$B3:901B A9 24 8F    LDA #$8F24
$B3:901E 9D 92 0F    STA $0F92,x[$7E:1092]
$B3:9021 A9 BD 90    LDA #$90BD
$B3:9024 9D A8 0F    STA $0FA8,x[$7E:10A8]
...
$B3:902B 20 A1 90    JSR $90A1  [$B3:90A1]
$B3:902E 22 70 AD A0 JSL $A0AD70[$A0:AD70]
$B3:9032 F0 2C       BEQ $2C    [$9060]
$B3:9034 BF 0E 78 7E LDA $7E780E,x
$B3:9038 9D 7A 0F    STA $0F7A,x
$B3:903B BF 10 78 7E LDA $7E7810,x
$B3:903F 9D 7E 0F    STA $0F7E,x
$B3:9042 9E 7C 0F    STZ $0F7C,x
$B3:9045 9E 80 0F    STZ $0F80,x
$B3:9048 A9 B5 8F    LDA #$8FB5
$B3:904B 9D A8 0F    STA $0FA8,x
$B3:904E A9 00 00    LDA #$0000
$B3:9051 9F 0C 78 7E STA $7E780C,x
$B3:9055 BD 86 0F    LDA $0F86,x
$B3:9058 09 00 01    ORA #$0100
$B3:905B 9D 86 0F    STA $0F86,x
$B3:905E 80 40       BRA $40    [$90A0]

$B3:9060 BF 0C 78 7E LDA $7E780C,x[$7E:78CC]
$B3:9064 D0 3A       BNE $3A    [$90A0]
$B3:9066 BD 7A 0F    LDA $0F7A,x[$7E:103A]
$B3:9069 38          SEC
$B3:906A ED F6 0A    SBC $0AF6  [$7E:0AF6]
$B3:906D C9 30 00    CMP #$0030
$B3:9070 10 2E       BPL $2E    [$90A0]
$B3:9072 A9 5A 91    LDA #$915A
$B3:9075 9D A8 0F    STA $0FA8,x[$7E:1068]
$B3:9078 9E AC 0F    STZ $0FAC,x[$7E:106C]
$B3:907B 9E AE 0F    STZ $0FAE,x[$7E:106E]
$B3:907E A9 28 00    LDA #$0028
$B3:9081 9D B0 0F    STA $0FB0,x[$7E:1070]
$B3:9084 A9 01 00    LDA #$0001
$B3:9087 9D B2 0F    STA $0FB2,x[$7E:1072]
$B3:908A BD 7A 0F    LDA $0F7A,x[$7E:103A]
$B3:908D 9F 08 78 7E STA $7E7808,x[$7E:78C8]
$B3:9091 A9 01 00    LDA #$0001
$B3:9094 9D 94 0F    STA $0F94,x[$7E:1054]
$B3:9097 9E 90 0F    STZ $0F90,x[$7E:1050]
$B3:909A A9 10 8F    LDA #$8F10
$B3:909D 9D 92 0F    STA $0F92,x[$7E:1052]
...
$B3:90C0 20 3A 91    JSR $913A  [$B3:913A]
$B3:90C3 22 70 AD A0 JSL $A0AD70[$A0:AD70]
$B3:90C7 F0 2C       BEQ $2C    [$90F5]
$B3:90C9 BF 0E 78 7E LDA $7E780E,x[$7E:790E]
$B3:90CD 9D 7A 0F    STA $0F7A,x[$7E:107A]
$B3:90D0 BF 10 78 7E LDA $7E7810,x[$7E:7910]
$B3:90D4 9D 7E 0F    STA $0F7E,x[$7E:107E]
$B3:90D7 9E 7C 0F    STZ $0F7C,x[$7E:107C]
$B3:90DA 9E 80 0F    STZ $0F80,x[$7E:1080]
$B3:90DD A9 B5 8F    LDA #$8FB5
$B3:90E0 9D A8 0F    STA $0FA8,x[$7E:10A8]
$B3:90E3 A9 00 00    LDA #$0000
$B3:90E6 9F 0C 78 7E STA $7E780C,x[$7E:790C]
$B3:90EA BD 86 0F    LDA $0F86,x[$7E:1086]
$B3:90ED 09 00 01    ORA #$0100
$B3:90F0 9D 86 0F    STA $0F86,x[$7E:1086]
$B3:90F3 80 44       BRA $44    [$9139]

$B3:90F5 BF 0C 78 7E LDA $7E780C,x[$7E:7A4C]
$B3:90F9 D0 3E       BNE $3E    [$9139]
$B3:90FB BD 7A 0F    LDA $0F7A,x[$7E:11BA]
$B3:90FE 38          SEC
$B3:90FF ED F6 0A    SBC $0AF6  [$7E:0AF6]
$B3:9102 49 FF FF    EOR #$FFFF
$B3:9105 1A          INC A
$B3:9106 C9 30 00    CMP #$0030
$B3:9109 10 2E       BPL $2E    [$9139]
$B3:910B A9 D8 91    LDA #$91D8
$B3:910E 9D A8 0F    STA $0FA8,x[$7E:11E8]
$B3:9111 9E AC 0F    STZ $0FAC,x[$7E:11EC]
$B3:9114 9E AE 0F    STZ $0FAE,x[$7E:11EE]
$B3:9117 A9 28 00    LDA #$0028
$B3:911A 9D B0 0F    STA $0FB0,x[$7E:11F0]
$B3:911D A9 01 00    LDA #$0001
$B3:9120 9D B2 0F    STA $0FB2,x[$7E:11F2]
$B3:9123 BD 7A 0F    LDA $0F7A,x[$7E:11BA]
$B3:9126 9F 08 78 7E STA $7E7808,x[$7E:7A48]
$B3:912A A9 01 00    LDA #$0001
$B3:912D 9D 94 0F    STA $0F94,x[$7E:11D4]
$B3:9130 9E 90 0F    STZ $0F90,x[$7E:11D0]
$B3:9133 A9 38 8F    LDA #$8F38
$B3:9136 9D 92 0F    STA $0F92,x[$7E:11D2]
...
$B3:9161 F0 3C       BEQ $3C    [$919F]
$B3:9163 BF 0E 78 7E LDA $7E780E,x[$7E:78CE]
$B3:9167 9D 7A 0F    STA $0F7A,x[$7E:103A]
$B3:916A BF 10 78 7E LDA $7E7810,x[$7E:78D0]
$B3:916E 9D 7E 0F    STA $0F7E,x[$7E:103E]
$B3:9171 9E 7C 0F    STZ $0F7C,x[$7E:103C]
$B3:9174 9E 80 0F    STZ $0F80,x[$7E:1040]
$B3:9177 A9 B5 8F    LDA #$8FB5
$B3:917A 9D A8 0F    STA $0FA8,x[$7E:1068]
$B3:917D A9 00 00    LDA #$0000
$B3:9180 9F 0C 78 7E STA $7E780C,x[$7E:78CC]
$B3:9184 A9 01 00    LDA #$0001
$B3:9187 9D 94 0F    STA $0F94,x[$7E:1054]
$B3:918A 9E 90 0F    STZ $0F90,x[$7E:1050]
$B3:918D A9 FC 8E    LDA #$8EFC
$B3:9190 9D 92 0F    STA $0F92,x[$7E:1052]
$B3:9193 BD 86 0F    LDA $0F86,x[$7E:1046]
$B3:9196 09 00 01    ORA #$0100
$B3:9199 9D 86 0F    STA $0F86,x[$7E:1046]
$B3:919C 4C D7 91    JMP $91D7  [$B3:91D7]

$B3:919F 20 A1 90    JSR $90A1  [$B3:90A1]
$B3:91A2 BD B2 0F    LDA $0FB2,x[$7E:1072]
$B3:91A5 D0 2D       BNE $2D    [$91D4]
$B3:91A7 20 56 92    JSR $9256  [$B3:9256]
$B3:91AA BD 7E 0F    LDA $0F7E,x[$7E:10BE]
$B3:91AD DF 10 78 7E CMP $7E7810,x[$7E:7950]
$B3:91B1 10 24       BPL $24    [$91D7]
$B3:91B3 A9 01 00    LDA #$0001
$B3:91B6 9F 0C 78 7E STA $7E780C,x
$B3:91BA 9D B2 0F    STA $0FB2,x
$B3:91BD A9 28 90    LDA #$9028
$B3:91C0 9D A8 0F    STA $0FA8,x
$B3:91C3 A9 01 00    LDA #$0001
$B3:91C6 9D 94 0F    STA $0F94,x
$B3:91C9 9E 90 0F    STZ $0F90,x
$B3:91CC A9 FC 8E    LDA #$8EFC
$B3:91CF 9D 92 0F    STA $0F92,x
$B3:91D2 80 03       BRA $03    [$91D7]

$B3:91D4 20 7A 92    JSR $927A  [$B3:927A]
...
$B3:91DF F0 3C       BEQ $3C    [$921D]
$B3:91E1 BF 0E 78 7E LDA $7E780E,x[$7E:7A4E]
$B3:91E5 9D 7A 0F    STA $0F7A,x[$7E:11BA]
$B3:91E8 BF 10 78 7E LDA $7E7810,x[$7E:7A50]
$B3:91EC 9D 7E 0F    STA $0F7E,x[$7E:11BE]
$B3:91EF 9E 7C 0F    STZ $0F7C,x[$7E:11BC]
$B3:91F2 9E 80 0F    STZ $0F80,x[$7E:11C0]
$B3:91F5 A9 B5 8F    LDA #$8FB5
$B3:91F8 9D A8 0F    STA $0FA8,x[$7E:11E8]
$B3:91FB A9 00 00    LDA #$0000
$B3:91FE 9F 0C 78 7E STA $7E780C,x[$7E:7A4C]
$B3:9202 A9 01 00    LDA #$0001
$B3:9205 9D 94 0F    STA $0F94,x[$7E:11D4]
$B3:9208 9E 90 0F    STZ $0F90,x[$7E:11D0]
$B3:920B A9 24 8F    LDA #$8F24
$B3:920E 9D 92 0F    STA $0F92,x[$7E:11D2]
$B3:9211 BD 86 0F    LDA $0F86,x[$7E:11C6]
$B3:9214 09 00 01    ORA #$0100
$B3:9217 9D 86 0F    STA $0F86,x[$7E:11C6]
$B3:921A 4C 55 92    JMP $9255  [$B3:9255]

$B3:921D 20 3A 91    JSR $913A  [$B3:913A]
$B3:9220 BD B2 0F    LDA $0FB2,x[$7E:11F2]
$B3:9223 D0 2D       BNE $2D    [$9252]
$B3:9225 20 56 92    JSR $9256  [$B3:9256]
$B3:9228 BF 10 78 7E LDA $7E7810,x
$B3:922C DD 7E 0F    CMP $0F7E,x
$B3:922F 30 24       BMI $24    [$9255]
$B3:9231 A9 01 00    LDA #$0001
$B3:9234 9F 0C 78 7E STA $7E780C,x
$B3:9238 9D B2 0F    STA $0FB2,x
$B3:923B A9 01 00    LDA #$0001
$B3:923E 9D 94 0F    STA $0F94,x
$B3:9241 9E 90 0F    STZ $0F90,x
$B3:9244 A9 24 8F    LDA #$8F24
$B3:9247 9D 92 0F    STA $0F92,x
$B3:924A A9 BD 90    LDA #$90BD
$B3:924D 9D A8 0F    STA $0FA8,x
$B3:9250 80 03       BRA $03    [$9255]

$B3:9252 20 7A 92    JSR $927A  [$B3:927A]
...
;;; $9256:  ;;;
{
$B3:9256 FE B0 0F    INC $0FB0,x[$7E:10F0]  ; Increment enemy $0FB0
$B3:9259 BD B0 0F    LDA $0FB0,x[$7E:10F0]  ;\
$B3:925C 0A          ASL A                  ;|
$B3:925D 0A          ASL A                  ;} Y = [enemy $0FB0] / 100h * 8 (quadratic speed table index)
$B3:925E 0A          ASL A                  ;|
$B3:925F A8          TAY                    ;/
...
;;; $927A:  ;;;
{
$B3:927A DE B0 0F    DEC $0FB0,x[$7E:1070]
$B3:927D 10 0B       BPL $0B    [$928A]
$B3:927F A9 00 00    LDA #$0000
$B3:9282 9D B0 0F    STA $0FB0,x[$7E:10F0]
$B3:9285 9D B2 0F    STA $0FB2,x[$7E:10F2]
$B3:9288 80 20       BRA $20    [$92AA]

$B3:928A BD B0 0F    LDA $0FB0,x[$7E:1070]  ;\
$B3:928D 0A          ASL A                  ;|
$B3:928E 0A          ASL A                  ;} Y = [enemy $0FB0] * 8 (quadratic speed table index)
$B3:928F 0A          ASL A                  ;|
$B3:9290 A8          TAY                    ;/
...
;;; $9339: Instruction lists - Botwoon ;;;
{
...
;;; $949B:  ;;;
{
$B3:949B             dw 003C,0044,006C,0074,
                        007C,0084,00AC,00B4,
                        009C,00A4,005C,0064,
                        00DC,00E4,008C,0094
}
...
$B3:95B3 A9 18 00    LDA #$0018             ;} Enemy $0FA8 = 18h
...
$B3:95C3 DE A8 0F    DEC $0FA8,x[$7E:0FA8]  ;} Decrement enemy $0FA8
$B3:95C6 DE A8 0F    DEC $0FA8,x[$7E:0FA8]  ;/
$B3:95C9 10 EE       BPL $EE    [$95B9]     ; If [enemy $0FA8] >= 0: go to LOOP
$B3:95CB A9 89 93    LDA #$9389             ;\
$B3:95CE 9D 92 0F    STA $0F92,x[$7E:0F92]  ;} Enemy instruction list pointer = $9389 (hide)
$B3:95D1 9F 36 80 7E STA $7E8036,x[$7E:8036]; Enemy $7E:8036 = $9389 (hide)
$B3:95D5 A9 78 98    LDA #$9878             ;\
$B3:95D8 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $9878
$B3:95DB A9 B7 9B    LDA #$9BB7             ;\
$B3:95DE 9D B0 0F    STA $0FB0,x[$7E:0FB0]  ;} Enemy $0FB0 = $9BB7
$B3:95E1 A9 C0 9D    LDA #$9DC0             ;\
$B3:95E4 9D B2 0F    STA $0FB2,x[$7E:0FB2]  ;} Enemy $0FB2 = $9DC0
$B3:95E7 A9 00 01    LDA #$0100             ;\
$B3:95EA 9F 00 80 7E STA $7E8000,x[$7E:8000];} Enemy $7E:8000 = 100h
$B3:95EE AD BB 94    LDA $94BB  [$B3:94BB]  ;\
$B3:95F1 9F 30 80 7E STA $7E8030,x[$7E:8030];} Enemy $7E:8030 = 2
$B3:95F5 AD BD 94    LDA $94BD  [$B3:94BD]  ;\
$B3:95F8 9D AC 0F    STA $0FAC,x[$7E:0FAC]  ;} Enemy $0FAC = 18h
$B3:95FB A9 01 00    LDA #$0001             ;\
$B3:95FE 9F 26 80 7E STA $7E8026,x[$7E:8026];} Enemy $7E:8026 = 1
$B3:9602 9F 28 80 7E STA $7E8028,x[$7E:8028]; Enemy $7E:8028 = 1
$B3:9606 9F 32 88 7E STA $7E8832,x[$7E:8832]; Enemy $7E:8832 = 1
$B3:960A A9 FF FF    LDA #$FFFF             ;\
$B3:960D 9F 2C 80 7E STA $7E802C,x[$7E:802C];} Enemy $7E:802C = FFFFh
$B3:9611 A9 00 00    LDA #$0000             ;\
$B3:9614 9F 2E 80 7E STA $7E802E,x[$7E:802E];} Enemy $7E:802E = 0
...
$B3:9624 9F 36 88 7E STA $7E8836,x[$7E:8836];} Enemy $7E:8836 = [enemy health]
$B3:9628 4A          LSR A                  ;\
$B3:9629 9F 38 88 7E STA $7E8838,x[$7E:8838];} Enemy $7E:8838 = [enemy health] / 2
$B3:962D 4A          LSR A                  ;\
$B3:962E 9F 3A 88 7E STA $7E883A,x[$7E:883A];} Enemy $7E:883A = [enemy health] / 4
$B3:9632 BD 7A 0F    LDA $0F7A,x[$7E:0F7A]  ;\
$B3:9635 9F 20 88 7E STA $7E8820,x[$7E:8820];} Enemy $7E:8820 = [enemy X position]
$B3:9639 9F 24 88 7E STA $7E8824,x[$7E:8824]; Enemy $7E:8824 = [enemy X position]
$B3:963D 9F 28 88 7E STA $7E8828,x[$7E:8828]; Enemy $7E:8828 = [enemy X position]
$B3:9641 9F 2C 88 7E STA $7E882C,x[$7E:882C]; Enemy $7E:882C = [enemy X position]
$B3:9645 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]  ;\
$B3:9648 9F 22 88 7E STA $7E8822,x[$7E:8822];} Enemy $7E:8822 = [enemy Y position]
$B3:964C 9F 26 88 7E STA $7E8826,x[$7E:8826]; Enemy $7E:8826 = [enemy Y position]
$B3:9650 9F 2A 88 7E STA $7E882A,x[$7E:882A]; Enemy $7E:882A = [enemy Y position]
$B3:9654 9F 2E 88 7E STA $7E882E,x[$7E:882E]; Enemy $7E:882E = [enemy Y position]
$B3:9658 BD 96 0F    LDA $0F96,x[$7E:0F96]  ;\
$B3:965B 4A          LSR A                  ;|
$B3:965C 4A          LSR A                  ;|
$B3:965D 4A          LSR A                  ;|
$B3:965E 4A          LSR A                  ;} Enemy $7E:881C = [enemy palette index] / 10h + 100h (palette data offset)
$B3:965F 18          CLC                    ;|
...
$B3:966E FC AE 0F    JSR ($0FAE,x)[$B3:9878]; Execute [enemy function pointer]
...
$B3:967F 0A          ASL A                  ;|
$B3:9680 A8          TAY                    ;} $12 = [9675 + [enemy $7E:803E] * 2]
...
$B3:96CD F0 25       BEQ $25    [$96F4]     ;} If [enemy $7E:801E] = 0: return
$B3:96CF BF 3C 80 7E LDA $7E803C,x[$7E:803C];\
$B3:96D3 F0 1F       BEQ $1F    [$96F4]     ;} If [enemy $7E:803C] = 0: return
$B3:96D5 A9 01 00    LDA #$0001             ;\
$B3:96D8 9F 20 80 7E STA $7E8020,x[$7E:8020];} Enemy $7E:8020 = 1
$B3:96DC A9 46 9A    LDA #$9A46             ;\
$B3:96DF 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $9A46 (die)
$B3:96E2 A9 F0 00    LDA #$00F0             ;\
$B3:96E5 9F 04 80 7E STA $7E8004,x[$7E:8004];} Enemy $7E:8004 = F0h
$B3:96E9 A9 00 00    LDA #$0000             ;\
$B3:96EC 9F 1E 80 7E STA $7E801E,x[$7E:801E];} $7E:801E = 0
$B3:96F0 9F 3C 80 7E STA $7E803C,x[$7E:803C]; $7E:803C = 0
...
;;; $96FF: Set Botwoon enemy projectiles Ah..22h as intangible ;;;
{
...
$B3:9832 C9 10 00    CMP #$0010             ;} If [enemy $7E:881E] = 10h: return
$B3:9835 F0 40       BEQ $40    [$9877]     ;/
$B3:9837 A8          TAY                    ;\
$B3:9838 BD 8C 0F    LDA $0F8C,x[$7E:0F8C]  ;|
$B3:983B D9 1B 98    CMP $981B,y[$B3:981B]  ;} If [enemy health] >= [$981B + [enemy $7E:881E]]: return
$B3:983E 10 37       BPL $37    [$9877]     ;/
$B3:9840 BF 1E 88 7E LDA $7E881E,x[$7E:881E];\
$B3:9844 0A          ASL A                  ;|
$B3:9845 0A          ASL A                  ;|
$B3:9846 0A          ASL A                  ;} $12 = [enemy $7E:881E] * 10h
$B3:9847 0A          ASL A                  ;|
$B3:9848 85 12       STA $12    [$7E:0012]  ;/
$B3:984A BF 1C 88 7E LDA $7E881C,x[$7E:881C];\
$B3:984E 85 14       STA $14    [$7E:0014]  ;} $14 = [enemy $7E:881C] (should be 1E0h)
...
$B3:9871 1A          INC A                  ;} Enemy $7E:881E += 2
$B3:9872 1A          INC A                  ;|
...
$B3:987F 3A          DEC A                  ;} Decrement enemy $7E:8000
$B3:9880 9F 00 80 7E STA $7E8000,x[$7E:8000];/
$B3:9884 D0 06       BNE $06    [$988C]     ; If [$7E:8000] = 0:
$B3:9886 A9 9D 98    LDA #$989D             ;\
$B3:9889 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $989D (go through hole)
...
$B3:98A0 BF 38 80 7E LDA $7E8038,x[$7E:8038];} If [enemy $7E:8038] = 0: go to BRANCH_MOVE_AROUND
$B3:98A4 F0 30       BEQ $30    [$98D6]     ;/
$B3:98A6 A9 00 00    LDA #$0000             ;\
$B3:98A9 9F 38 80 7E STA $7E8038,x[$7E:8038];} Enemy $7E:8038 = 0
$B3:98AD 64 12       STZ $12    [$7E:0012]  ; $12 = 0
$B3:98AF BF 26 80 7E LDA $7E8026,x[$7E:8026];\
$B3:98B3 D0 15       BNE $15    [$98CA]     ;} If [enemy $7E:8026] = 0:
$B3:98B5 BF 32 88 7E LDA $7E8832,x[$7E:8832];\
$B3:98B9 D0 0F       BNE $0F    [$98CA]     ;} If [enemy $7E:8032] = 0:
$B3:98BB BF 3E 80 7E LDA $7E803E,x[$7E:803E];\
$B3:98BF D0 09       BNE $09    [$98CA]     ;} If [enemy $7E:803E] = 0:
...
$B3:98CD 9F 32 88 7E STA $7E8832,x[$7E:8832];} Enemy $7E:8832 = 0
$B3:98D1 A6 12       LDX $12    [$7E:0012]  ;\
$B3:98D3 7C 8D 98    JMP ($988D,x)[$B3:98EC];} Go to [$988D + [$12]]

; BRANCH_MOVE_AROUND
$B3:98D6 FC B0 0F    JSR ($0FB0,x)[$B3:9BB7]; Execute [enemy $0FB0]
$B3:98D9 20 7B 9C    JSR $9C7B  [$B3:9C7B]  ; Execute $9C7B
$B3:98DC 20 90 9C    JSR $9C90  [$B3:9C90]  ; Execute $9C90
$B3:98DF FC B2 0F    JSR ($0FB2,x)[$B3:9DC0]; Execute [enemy $0FB2]
$B3:98E2 20 4D 9D    JSR $9D4D  [$B3:9D4D]  ; Execute $9D4D
$B3:98E5 20 3C 9D    JSR $9D3C  [$B3:9D3C]  ; Execute $9D3C
$B3:98E8 20 93 9F    JSR $9F93  [$B3:9F93]  ; Execute $9F93
$B3:98EB 60          RTS
}
...
$B3:98F2 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $99A4
$B3:98F5 A9 50 E2    LDA #$E250             ;\
$B3:98F8 9D B0 0F    STA $0FB0,x[$7E:0FB0]  ;} Enemy $0FB0 = $E250
$B3:98FB A9 00 00    LDA #$0000             ;\
$B3:98FE 9F 02 80 7E STA $7E8002,x[$7E:8002];} Enemy $7E:8002 = 0
$B3:9902 A9 C0 9D    LDA #$9DC0             ;\
$B3:9905 9D B2 0F    STA $0FB2,x[$7E:0FB2]  ;} Enemy $0FB2 = $9DC0
$B3:9908 A9 00 00    LDA #$0000             ;\
$B3:990B 9F 16 88 7E STA $7E8816,x[$7E:8816];} Enemy $7E:8016 = 0
$B3:990F 20 33 99    JSR $9933  [$B3:9933]  ; Execute $9933
$B3:9912 60          RTS
}
...
$B3:9919 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $99E4
$B3:991C A9 7D 9E    LDA #$9E7D             ;\
$B3:991F 9D B2 0F    STA $0FB2,x[$7E:0FB2]  ;} Enemy $0FB2 = $9E7D
$B3:9922 A9 30 00    LDA #$0030             ;\
$B3:9925 9F 02 80 7E STA $7E8002,x[$7E:8002];} Enemy $7E:8002 = 30h
...
;;; $9933:  ;;;
{
$B3:9933 20 5D 99    JSR $995D  [$B3:995D]
$B3:9936 64 12       STZ $12    [$7E:0012]
$B3:9938 BF 26 80 7E LDA $7E8026,x[$7E:8026]
$B3:993C F0 05       BEQ $05    [$9943]
$B3:993E A9 80 00    LDA #$0080
$B3:9941 85 12       STA $12    [$7E:0012]

$B3:9943 22 11 81 80 JSL $808111[$80:8111]
$B3:9947 29 18 00    AND #$0018
$B3:994A 85 14       STA $14    [$7E:0014]
$B3:994C BF 2E 80 7E LDA $7E802E,x[$7E:802E]
$B3:9950 0A          ASL A
$B3:9951 0A          ASL A
$B3:9952 18          CLC
$B3:9953 65 12       ADC $12    [$7E:0012]
$B3:9955 18          CLC
...
$B3:9961 D0 40       BNE $40    [$99A3]
$B3:9963 A9 00 00    LDA #$0000
$B3:9966 9F 3E 80 7E STA $7E803E,x[$7E:803E]
$B3:996A BD 8C 0F    LDA $0F8C,x[$7E:0F8C]
$B3:996D F0 34       BEQ $34    [$99A3]
$B3:996F 30 32       BMI $32    [$99A3]
$B3:9971 DF 38 88 7E CMP $7E8838,x[$7E:8838]
$B3:9975 10 2C       BPL $2C    [$99A3]
$B3:9977 DF 3A 88 7E CMP $7E883A,x[$7E:883A]
$B3:997B 10 02       BPL $02    [$997F]
$B3:997D 80 09       BRA $09    [$9988]

$B3:997F A9 01 00    LDA #$0001
$B3:9982 9F 3E 80 7E STA $7E803E,x
$B3:9986 80 07       BRA $07    [$998F]

$B3:9988 A9 02 00    LDA #$0002
$B3:998B 9F 3E 80 7E STA $7E803E,x[$7E:803E]
...
$B3:9999 9F 30 80 7E STA $7E8030,x[$7E:8030]
$B3:999D B9 BD 94    LDA $94BD,y[$B3:94C5]
$B3:99A0 9D AC 0F    STA $0FAC,x[$7E:0FAC]
...
$B3:99AB F0 0A       BEQ $0A    [$99B7]
$B3:99AD A9 00 00    LDA #$0000
$B3:99B0 9F 38 80 7E STA $7E8038,x[$7E:8038]
$B3:99B4 4C CA 99    JMP $99CA  [$B3:99CA]

$B3:99B7 FC B0 0F    JSR ($0FB0,x)[$B3:E250]
$B3:99BA 20 7B 9C    JSR $9C7B  [$B3:9C7B]
$B3:99BD 20 90 9C    JSR $9C90  [$B3:9C90]
$B3:99C0 FC B2 0F    JSR ($0FB2,x)[$B3:9DC0]
$B3:99C3 20 4D 9D    JSR $9D4D  [$B3:9D4D]
$B3:99C6 20 3C 9D    JSR $9D3C  [$B3:9D3C]
$B3:99C9 60          RTS

$B3:99CA A9 9D 98    LDA #$989D
$B3:99CD 9D AE 0F    STA $0FAE,x[$7E:0FAE]
$B3:99D0 A9 B7 9B    LDA #$9BB7
$B3:99D3 9D B0 0F    STA $0FB0,x[$7E:0FB0]
$B3:99D6 BF 26 80 7E LDA $7E8026,x[$7E:8026]
$B3:99DA F0 07       BEQ $07    [$99E3]
$B3:99DC A9 00 00    LDA #$0000
$B3:99DF 9F 2A 80 7E STA $7E802A,x[$7E:802A]
...
$B3:99EB D0 0A       BNE $0A    [$99F7]
$B3:99ED A9 00 00    LDA #$0000
$B3:99F0 9F 38 80 7E STA $7E8038,x[$7E:8038]
$B3:99F4 4C 02 9A    JMP $9A02  [$B3:9A02]

$B3:99F7 A9 00 00    LDA #$0000
$B3:99FA 9F 1C 80 7E STA $7E801C,x[$7E:801C]
$B3:99FE FC B2 0F    JSR ($0FB2,x)[$B3:9E7D]
$B3:9A01 60          RTS

$B3:9A02 A9 A4 99    LDA #$99A4
$B3:9A05 9D AE 0F    STA $0FAE,x[$7E:0FAE]
$B3:9A08 A9 50 E2    LDA #$E250
$B3:9A0B 9D B0 0F    STA $0FB0,x[$7E:0FB0]
$B3:9A0E A9 C0 9D    LDA #$9DC0
$B3:9A11 9D B2 0F    STA $0FB2,x[$7E:0FB2]
$B3:9A14 BF 1E 80 7E LDA $7E801E,x[$7E:801E]
$B3:9A18 D0 21       BNE $21    [$9A3B]
$B3:9A1A 22 11 81 80 JSL $808111[$80:8111]
$B3:9A1E 29 01 00    AND #$0001
$B3:9A21 9F 26 80 7E STA $7E8026,x[$7E:8026]
$B3:9A25 9F 28 80 7E STA $7E8028,x[$7E:8028]
$B3:9A29 F0 10       BEQ $10    [$9A3B]
$B3:9A2B A9 00 00    LDA #$0000
$B3:9A2E 9F 2A 80 7E STA $7E802A,x[$7E:802A]
$B3:9A32 A9 FF FF    LDA #$FFFF
$B3:9A35 9F 2C 80 7E STA $7E802C,x[$7E:802C]
$B3:9A39 80 07       BRA $07    [$9A42]

$B3:9A3B A9 00 00    LDA #$0000
$B3:9A3E 9F 16 88 7E STA $7E8816,x[$7E:8816]

$B3:9A42 20 33 99    JSR $9933  [$B3:9933]
$B3:9A45 60          RTS
}


;;; $9A46: Botwoon function - die - pre-death delay ;;;
{
$B3:9A46 AE 54 0E    LDX $0E54  [$7E:0E54]
$B3:9A49 BF 04 80 7E LDA $7E8004,x[$7E:8004];\
$B3:9A4D 1A          INC A                  ;} Increment enemy $7E:8004
$B3:9A4E 9F 04 80 7E STA $7E8004,x[$7E:8004];/
$B3:9A52 C9 00 01    CMP #$0100             ;\
$B3:9A55 30 06       BMI $06    [$9A5D]     ;} If [enemy $7E:8004] >= 100h:
$B3:9A57 A9 5E 9A    LDA #$9A5E             ;\
$B3:9A5A 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $9A5E

$B3:9A5D 60          RTS
}


;;; $9A5E: Botwoon function - die - falling to ground ;;;
{
$B3:9A5E AE 54 0E    LDX $0E54  [$7E:0E54]
$B3:9A61 BF 10 80 7E LDA $7E8010,x[$7E:8010];\
$B3:9A65 29 00 FF    AND #$FF00             ;|
$B3:9A68 EB          XBA                    ;|
$B3:9A69 0A          ASL A                  ;} Y = [enemy $7E:8010] / 100h * 8
$B3:9A6A 0A          ASL A                  ;|
$B3:9A6B 0A          ASL A                  ;|
$B3:9A6C A8          TAY                    ;/
...
$B3:9A94 9D AE 0F    STA $0FAE,x[$7E:0FAE]  ;} Enemy function pointer = $9ACA
...
$B3:9AA1 A9 1D 00    LDA #$001D             ; A = 1Dh
...
$B3:9AC1 18          CLC                    ;|
$B3:9AC2 69 C0 00    ADC #$00C0             ;} Enemy $7E:8010 += C0h
...
$B3:9AD1 F0 09       BEQ $09    [$9ADC]
$B3:9AD3 A9 F9 9A    LDA #$9AF9
$B3:9AD6 9D AE 0F    STA $0FAE,x[$7E:0FAE]
$B3:9AD9 20 DD 9A    JSR $9ADD  [$B3:9ADD]
...
$B3:9AEC 9F 06 80 7E STA $7E8006,x[$7E:8006]
$B3:9AF0 9F 08 80 7E STA $7E8008,x[$7E:8008]
$B3:9AF4 9F 0A 80 7E STA $7E800A,x[$7E:800A]
$B3:9AF8 60          RTS
}


;;; $9AF9: Botwoon function - dead ;;;
{
$B3:9AF9 BF 06 80 7E LDA $7E8006,x[$7E:8006]
$B3:9AFD C9 C0 00    CMP #$00C0
$B3:9B00 10 08       BPL $08    [$9B0A]
$B3:9B02 C9 40 00    CMP #$0040
$B3:9B05 10 1B       BPL $1B    [$9B22]
$B3:9B07 4C AD 9B    JMP $9BAD  [$B3:9BAD]

$B3:9B0A BD 86 0F    LDA $0F86,x[$7E:0F86]
$B3:9B0D 09 00 02    ORA #$0200
$B3:9B10 9D 86 0F    STA $0F86,x[$7E:0F86]
$B3:9B13 A9 02 00    LDA #$0002
$B3:9B16 22 A6 81 80 JSL $8081A6[$80:81A6]
...
$B3:9B2B 10 38       BPL $38    [$9B65]
$B3:9B2D A9 0C 00    LDA #$000C
$B3:9B30 9F 08 80 7E STA $7E8008,x[$7E:8008]
$B3:9B34 22 11 81 80 JSL $808111[$80:8111]
$B3:9B38 29 1F 00    AND #$001F
$B3:9B3B 18          CLC
$B3:9B3C 69 E8 00    ADC #$00E8
$B3:9B3F 85 12       STA $12    [$7E:0012]
$B3:9B41 22 11 81 80 JSL $808111[$80:8111]
...
$B3:9B56 85 16       STA $16    [$7E:0016]
$B3:9B58 A9 00 0A    LDA #$0A00
$B3:9B5B 85 18       STA $18    [$7E:0018]
$B3:9B5D 22 26 BC B4 JSL $B4BC26[$B4:BC26]
$B3:9B61 22 7B 95 B3 JSL $B3957B[$B3:957B]

$B3:9B65 BF 0A 80 7E LDA $7E800A,x[$7E:800A]
$B3:9B69 3A          DEC A
$B3:9B6A 9F 0A 80 7E STA $7E800A,x[$7E:800A]
$B3:9B6E 10 3D       BPL $3D    [$9BAD]
$B3:9B70 A9 04 00    LDA #$0004
$B3:9B73 9F 0A 80 7E STA $7E800A,x[$7E:800A]
$B3:9B77 A9 02 00    LDA #$0002
$B3:9B7A 85 24       STA $24    [$7E:0024]

$B3:9B7C 22 11 81 80 JSL $808111[$80:8111]
$B3:9B80 29 3F 00    AND #$003F
$B3:9B83 18          CLC
$B3:9B84 69 E0 00    ADC #$00E0
$B3:9B87 85 12       STA $12    [$7E:0012]
$B3:9B89 22 11 81 80 JSL $808111[$80:8111]
...
$B3:9B9E 85 16       STA $16    [$7E:0016]
$B3:9BA0 A9 00 0A    LDA #$0A00
$B3:9BA3 85 18       STA $18    [$7E:0018]
$B3:9BA5 22 26 BC B4 JSL $B4BC26[$B4:BC26]
$B3:9BA9 C6 24       DEC $24    [$7E:0024]
$B3:9BAB D0 CF       BNE $CF    [$9B7C]
...
$B3:9BBD 22 AE C0 A0 JSL $A0C0AE[$A0:C0AE]
...
$B3:9BDC DF 28 80 7E CMP $7E8028,x[$7E:8028]
$B3:9BE0 F0 12       BEQ $12    [$9BF4]
$B3:9BE2 BF 26 80 7E LDA $7E8026,x[$7E:8026]
$B3:9BE6 9F 28 80 7E STA $7E8028,x[$7E:8028]
$B3:9BEA A9 01 00    LDA #$0001
$B3:9BED 9F 38 80 7E STA $7E8038,x[$7E:8038]
$B3:9BF1 4C F7 9B    JMP $9BF7  [$B3:9BF7]

$B3:9BF4 20 48 9C    JSR $9C48  [$B3:9C48]
...
$B3:9BFC A8          TAY                    ;} Y = [enemy $7E:802E]
...
$B3:9C3E 85 14       STA $14    [$7E:0014]  ;} $12 = FFh
$B3:9C40 80 05       BRA $05    [$9C47]     ; Return

; BRANCH_Y_CLAMP_LOW
$B3:9C42 A9 01 FF    LDA #$FF01             ;\
$B3:9C45 85 14       STA $14    [$7E:0014]  ;} $12 = -FFh
...
$B3:9C81 B9 7A 0F    LDA $0F7A,y[$7E:0F7A]  ;} $7E:9000 + [enemy $0FAA] = [enemy X position]
$B3:9C84 9F 00 90 7E STA $7E9000,x[$7E:9000];/
$B3:9C88 B9 7E 0F    LDA $0F7E,y[$7E:0F7E]  ;\
$B3:9C8B 9F 02 90 7E STA $7E9002,x[$7E:9002];} $7E:9000 + [enemy $0FAA] + 2 = [enemy Y position]
$B3:9C8F 60          RTS
}
...
$B3:9DB8 C6 16       DEC $16    [$7E:0016]
$B3:9DBA 30 03       BMI $03    [$9DBF]
$B3:9DBC 4C 55 9D    JMP $9D55  [$B3:9D55]
...
$B3:9E26 F0 10       BEQ $10    [$9E38]
$B3:9E28 9D 92 0F    STA $0F92,x[$7E:0F92]
$B3:9E2B 9F 36 80 7E STA $7E8036,x[$7E:8036]
$B3:9E2F A9 01 00    LDA #$0001
$B3:9E32 9D 94 0F    STA $0F94,x[$7E:0F94]
$B3:9E35 9E 90 0F    STZ $0F90,x[$7E:0F90]

$B3:9E38 BF 28 88 7E LDA $7E8828,x[$7E:8828]
$B3:9E3C 9F 2C 88 7E STA $7E882C,x[$7E:882C]
$B3:9E40 BF 2A 88 7E LDA $7E882A,x[$7E:882A]
$B3:9E44 9F 2E 88 7E STA $7E882E,x[$7E:882E]
$B3:9E48 BF 24 88 7E LDA $7E8824,x[$7E:8824]
$B3:9E4C 9F 28 88 7E STA $7E8828,x[$7E:8828]
$B3:9E50 BF 26 88 7E LDA $7E8826,x[$7E:8826]
$B3:9E54 9F 2A 88 7E STA $7E882A,x[$7E:882A]
$B3:9E58 BF 20 88 7E LDA $7E8820,x[$7E:8820]
$B3:9E5C 9F 24 88 7E STA $7E8824,x[$7E:8824]
$B3:9E60 BF 22 88 7E LDA $7E8822,x[$7E:8822]
$B3:9E64 9F 26 88 7E STA $7E8826,x[$7E:8826]
$B3:9E68 BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$B3:9E6B 9F 20 88 7E STA $7E8820,x[$7E:8820]
$B3:9E6F BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$B3:9E72 9F 22 88 7E STA $7E8822,x[$7E:8822]
$B3:9E76 60          RTS
}
...
$B3:9E83 9D 9A 0F    STA $0F9A,x[$7E:0F9A]
$B3:9E86 22 66 C0 A0 JSL $A0C066[$A0:C066]
$B3:9E8A 9F 3A 80 7E STA $7E803A,x[$7E:803A]
$B3:9E8E 18          CLC
...
$B3:9E9F 9D 92 0F    STA $0F92,x[$7E:0F92]
$B3:9EA2 9F 36 80 7E STA $7E8036,x[$7E:8036]
$B3:9EA6 A9 01 00    LDA #$0001
$B3:9EA9 9D 94 0F    STA $0F94,x[$7E:0F94]
$B3:9EAC 9E 90 0F    STZ $0F90,x[$7E:0F90]
...
$B3:9ECC 9D B2 0F    STA $0FB2,x[$7E:0FB2]
$B3:9ECF BD AE 0F    LDA $0FAE,x[$7E:0FAE]
$B3:9ED2 C9 E4 99    CMP #$99E4
$B3:9ED5 F0 06       BEQ $06    [$9EDD]
$B3:9ED7 A9 34 9F    LDA #$9F34
$B3:9EDA 9D B2 0F    STA $0FB2,x

$B3:9EDD 7C B2 0F    JMP ($0FB2,x)[$B3:9EE0]
}
...
$B3:9F0D AD 32 0E    LDA $0E32  [$7E:0E32]  ;} Spawn Botwoon's spit enemy projectile
$B3:9F10 22 27 80 86 JSL $868027[$86:8027]  ;/
$B3:9F14 AD 0B 06    LDA $060B  [$7E:060B]
$B3:9F17 18          CLC
$B3:9F18 69 10 00    ADC #$0010
$B3:9F1B 29 FF 00    AND #$00FF
$B3:9F1E 8D 0B 06    STA $060B  [$7E:060B]
$B3:9F21 CE 0D 06    DEC $060D  [$7E:060D]
$B3:9F24 D0 E4       BNE $E4    [$9F0A]
$B3:9F26 A9 00 00    LDA #$0000
$B3:9F29 9F 34 88 7E STA $7E8834,x[$7E:8834]
$B3:9F2D A9 7A 9F    LDA #$9F7A
$B3:9F30 9D B2 0F    STA $0FB2,x[$7E:0FB2]
$B3:9F33 60          RTS
}
...
$B3:9F64 18          CLC
$B3:9F65 69 10 00    ADC #$0010
$B3:9F68 29 FF 00    AND #$00FF
$B3:9F6B 8D 0B 06    STA $060B  [$7E:060B]
$B3:9F6E CE 0D 06    DEC $060D  [$7E:060D]
$B3:9F71 D0 E4       BNE $E4    [$9F57]
$B3:9F73 A9 7A 9F    LDA #$9F7A
$B3:9F76 9D B2 0F    STA $0FB2,x
$B3:9F79 60          RTS
}
...
$B3:9F83 10 0D       BPL $0D    [$9F92]
$B3:9F85 A9 00 00    LDA #$0000
$B3:9F88 9F 02 80 7E STA $7E8002,x
$B3:9F8C A9 C0 9D    LDA #$9DC0
$B3:9F8F 9D B2 0F    STA $0FB2,x
...
$B3:9F97 F0 03       BEQ $03    [$9F9C]     ;} If [enemy $7E:802A] != 0:
$B3:9F99 4C FE 9F    JMP $9FFE  [$B3:9FFE]  ; Return

$B3:9F9C A9 18 00    LDA #$0018             ;\
$B3:9F9F 85 12       STA $12    [$7E:0012]  ;} $12 = 18h
...
$B3:9FAE BD 7A 0F    LDA $0F7A,x[$7E:0F7A]  ;} If [$949B + [$12]] <= [enemy X position] < [$949B + [$12] + 2]:
...
$B3:A00E 9F 1E 80 7E STA $7E801E,x          ;} Enemy $7E:801E = 1
...
$B3:A019 BD 8C 0F    LDA $0F8C,x[$7E:0F8C]  ;} Enemy $7E:8818 = [enemy health]
...
$B3:A028 DD 8C 0F    CMP $0F8C,x[$7E:0F8C]  ;} If [enemy $7E:8818] != [enemy health]:
...
$B3:A039 9F 1E 80 7E STA $7E801E,x[$7E:801E];} Enemy $7E:801E = 1
...
$B3:A050 9F 1E 80 7E STA $7E801E,x          ;} Enemy $7E:801E = 1
...
$B3:D880             db 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 01,01, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,01, 00,01, 01,00, 00,01, 00,01, 00,01, 01,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, 00,01, FF,00, FF,00, 00,01, FF,00, 00,01, FF,00, FF,00, FF,00, 00,01, FF,00, FF,00, FF,00, 00,01, FF,00, FF,00, 00,01, FF,00, FF,00, 00,01, FF,00, 00,01, FF,00, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01
$B3:DA00             db 80,00
$B3:DA02             db 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, FF,00, 00,01, 00,01, 00,01, 00,01, FF,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,FF, 01,00, 00,FF, 01,00, 01,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, FF,00, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, FF,00, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,01, 01,00, 01,00, 00,01, 01,00
$B3:DB9A             db 80,00
$B3:DB9C             db 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,01, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00
$B3:DD40             db 80,00
$B3:DD42             db 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,FF, 01,FF, 01,FF, 01,FF, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 01,FF, 00,FF, 01,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, FF,00, 00,FF, 00,FF, FF,00, 00,FF, 00,FF, FF,00, 00,FF, FF,00, 00,FF, FF,00, 00,FF, FF,00, 00,FF, FF,00, 00,FF, FF,00, FF,00, 00,FF, FF,00, FF,00, FF,00, 00,FF, FF,00, FF,00, FF,00, FF,00, FF,00, 00,FF, FF,00, FF,00, FF,00, 00,FF, FF,00, FF,00, 00,FF, FF,00, FF,FF, 00,FF, FF,00, 00,FF, FF,FF, 00,FF, 00,FF, 00,FF, FF,00, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 01,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 01,01, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 01,00, 00,FF
$B3:DE7C             db 80,00
$B3:DE7E             db 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, 00,FF, FF,00, 00,FF, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,01, 00,01, 01,00, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 01,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF
$B3:DFDE             db 80,00
$B3:DFE0             db 00,01, FF,00, 00,01, FF,00, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, 00,01, FF,00, 00,01, 00,01, 00,01, FF,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 01,00, 00,01, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, FF,00, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 00,01, 01,01, 00,01, 00,01, 01,00, 00,01, 01,00, 00,01, 01,01, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 00,01, 01,00, 01,00, 01,00, 01,00, 01,00, 00,FF, 01,00, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 01,00, 00,FF, 00,FF, 00,FF, 01,FF, 00,FF, 00,FF
$B3:E14E             db 80,00
}
...
{
$B3:E150             dw A05A,0000,0008,0000,
                        A32A,0000,0010,0000,
                        A6BC,0000,0018,0000,
                        AA24,0000,0000,0000,
                        ADFE,0000,0000,0000,
...
;;; $E556: Instruction list -  ;;;
{
$B3:E556             dx E545,E56E,  ; ???
                        0005,E736,
                        0005,E747,
                        0005,E753,
                        0005,E747,
...
;;; $E582: Instruction list -  ;;;
{
$B3:E582             dx E545,E59A,  ; ???
                        0006,E75F,
                        0006,E770,
                        0006,E77C,
                        0006,E770,
...
{
$B3:E5AE             dx 806B,E65C,  ; Enemy $0FB2 = $E65C
                        0003,E75F,
                        0003,E770,
                        0003,E77C,
                        0003,E770,
...
{
$B3:E5DA             dx 8074,       ; Enemy $0FB2 = RTS
                        8123,0008,  ; Timer = 0008h
                        0008,E736,
                        E610,FFFD,  ; Enemy X position += FFFDh
                        0008,E747,
                        E610,FFFD,  ; Enemy X position += FFFDh
                        0008,E753,
                        E610,FFFD,  ; Enemy X position += FFFDh
...
$B3:E663 9D 7C 0F    STA $0F7C,x[$7E:0FFC]
...
$B3:E673 22 33 82 80 JSL $808233[$80:8233]
$B3:E677 90 06       BCC $06    [$E67F]
$B3:E679 A9 DA E5    LDA #$E5DA
$B3:E67C 9D 92 0F    STA $0F92,x[$7E:1052]
...
$B3:E6D1 22 33 82 80 JSL $808233[$80:8233]
$B3:E6D5 90 0A       BCC $0A    [$E6E1]
$B3:E6D7 BD 86 0F    LDA $0F86,x
$B3:E6DA 09 00 02    ORA #$0200
$B3:E6DD 9D 86 0F    STA $0F86,x
$B3:E6E0 6B          RTL

$B3:E6E1 BD 86 0F    LDA $0F86,x[$7E:0FC6]
$B3:E6E4 09 00 A4    ORA #$A400
$B3:E6E7 9D 86 0F    STA $0F86,x[$7E:0FC6]
$B3:E6EA A9 01 00    LDA #$0001
$B3:E6ED 9D 94 0F    STA $0F94,x[$7E:0FD4]
$B3:E6F0 9E 90 0F    STZ $0F90,x[$7E:0FD0]
$B3:E6F3 9E 96 0F    STZ $0F96,x[$7E:0FD6]
$B3:E6F6 BC B4 0F    LDY $0FB4,x[$7E:0FF4]
$B3:E6F9 B9 18 E7    LDA $E718,y[$B3:E718]
$B3:E6FC 9D 7A 0F    STA $0F7A,x[$7E:0FBA]
$B3:E6FF B9 1E E7    LDA $E71E,y[$B3:E71E]
$B3:E702 9D 7E 0F    STA $0F7E,x[$7E:0FBE]
$B3:E705 B9 24 E7    LDA $E724,y[$B3:E724]
$B3:E708 9D B2 0F    STA $0FB2,x[$7E:0FF2]
$B3:E70B B9 2A E7    LDA $E72A,y[$B3:E72A]
$B3:E70E 9D 92 0F    STA $0F92,x[$7E:0FD2]
$B3:E711 B9 30 E7    LDA $E730,y[$B3:E730]
$B3:E714 9D A8 0F    STA $0FA8,x[$7E:0FE8]
$B3:E717 6B          RTL

$B3:E718             dw 0080, 00A0, 00E8
$B3:E71E             dw 00C8, 00C8, 00C8
$B3:E724             dw E680, E680, E670
$B3:E72A             dw E556, E582, E5C6
$B3:E730             dw FE00, 0280, 0000
}
...
;;; $E964: Instruction list -  ;;;
{
$B3:E964             dx 8123,0005,  ; Timer = 0005h
                        0003,EB1B,
...
;;; $E9D0: Instruction list -  ;;;
{
$B3:E9D0             dx 8123,0005,  ; Timer = 0005h
                        0002,EB1B,
                        EAC9,       ; Enemy X position -= 6
                        0002,EB4A,
                        EAC9,       ; Enemy X position -= 6
                        ...
                        EAC9,       ; Enemy X position -= 6
                        EAB8,EA34,  ; ???
                        8110,E9D4,  ; Decrement timer and go to $E9D4 if non-zero
                        8123,0005,  ; Timer = 0005h
                        0002,EC49,
                        EAD7,       ; Enemy X position += 6
                        0002,EC78,
                        ...
                        EAD7,       ; Enemy X position += 6
                        EAB8,EA38,  ; ???
                        8110,EA04,  ; Decrement timer and go to $EA04 if non-zero
                        80ED,E9D0   ; Go to $E9D0
}


;;; $EA34: Instruction list -  ;;;
{
$B3:EA34             dx 001E,EB1B,
                        005A,EC49,
                        EAD7,       ; Enemy X position += 6
                        0005,EC78,
                        EAD7,       ; Enemy X position += 6
...
$B3:EAEB 22 33 82 80 JSL $808233[$80:8233]
$B3:EAEF 90 0A       BCC $0A    [$EAFB]
$B3:EAF1 BD 86 0F    LDA $0F86,x
$B3:EAF4 09 00 02    ORA #$0200
$B3:EAF7 9D 86 0F    STA $0F86,x
$B3:EAFA 6B          RTL

$B3:EAFB BD 86 0F    LDA $0F86,x[$7E:0F86]
$B3:EAFE 09 00 20    ORA #$2000
$B3:EB01 9D 86 0F    STA $0F86,x[$7E:0F86]
$B3:EB04 A9 4D 80    LDA #$804D
$B3:EB07 9D 8E 0F    STA $0F8E,x[$7E:0F8E]
$B3:EB0A A9 01 00    LDA #$0001
$B3:EB0D 9D 94 0F    STA $0F94,x[$7E:0F94]
$B3:EB10 9E 90 0F    STZ $0F90,x[$7E:0F90]
$B3:EB13 A9 64 E9    LDA #$E964
$B3:EB16 9D 92 0F    STA $0F92,x[$7E:0F92]
$B3:EB19 6B          RTL
}


;;; $EB1A: Main AI - enemy $F313 (escape dachora) ;;;
{
$B3:EB1A 6B          RTL
}

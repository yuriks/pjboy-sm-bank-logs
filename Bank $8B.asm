...
$8B:BD1F A9 8C       LDA #$8C               ;} VRAM $0000..3FFF low bytes = FFh
                                            ;|
...
$8B:C3E2 8D 51 1F    STA $1F51  [$7E:1F51]  ;} Cinematic function = $C5CA
$8B:C3E5 60          RTS
...
$8B:C48C C9 CA C5    CMP #$C5CA             ;} If [cinematic function] = $C5CA:

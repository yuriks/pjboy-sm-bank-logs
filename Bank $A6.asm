...
$A6:9C58 A9 03 00    LDA #$0003
$A6:9C5B 22 AF A3 A0 JSL $A0A3AF[$A0:A3AF]
$A6:9C5F 22 EE B8 A0 JSL $A0B8EE[$A0:B8EE]
...
$A6:C90B A9 00 00    LDA #$0000
$A6:C90E 5C AF A3 A0 JMP $A0A3AF[$A0:A3AF]
...
$A6:CDC0 38          SEC
$A6:CDC1 EF 7A 0F 00 SBC $000F7A[$00:0F7A]
...
$A6:FC8A A9 00 00    LDA #$0000
$A6:FC8D 5C AF A3 A0 JMP $A0A3AF[$A0:A3AF]
...
$A6:FC9F A9 00 00    LDA #$0000
$A6:FCA2 22 AF A3 A0 JSL $A0A3AF[$A0:A3AF]

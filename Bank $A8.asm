...
{
$A8:8B12 22 3D A6 A0 JSL $A0A63D[$A0:A63D]
}
...
$A8:9796 22 ED AE A0 JSL $A0AEED[$A0:AEED]
$A8:979A 60          RTS
}
...
;;; $99AC: Wrecked Ship ghost palettes ;;;
{
...
$A8:9BB4 20 31 9C    JSR $9C31  [$A8:9C31]
$A8:9BB7 68          PLA
$A8:9BB8 1D AA 0F    ORA $0FAA,x[$7E:0FAA]
$A8:9BBB D0 73       BNE $73    [$9C30]
...
$A8:9BD9 9D AA 0F    STA $0FAA,x[$7E:0FAA]
$A8:9BDC A9 02 00    LDA #$0002
$A8:9BDF 9D AC 0F    STA $0FAC,x[$7E:0FAC]
$A8:9BE2 A9 00 00    LDA #$0000
$A8:9BE5 9F 02 78 7E STA $7E7802,x[$7E:7802]
$A8:9BE9 AD A2 9A    LDA $9AA2  [$A8:9AA2]
$A8:9BEC 9F 04 78 7E STA $7E7804,x[$7E:7804]
$A8:9BF0 AD A6 9A    LDA $9AA6  [$A8:9AA6]
$A8:9BF3 9D AA 0F    STA $0FAA,x[$7E:0FAA]
$A8:9BF6 A9 04 00    LDA #$0004
$A8:9BF9 9F 0A 78 7E STA $7E780A,x[$7E:780A]
$A8:9BFD AD F6 0A    LDA $0AF6  [$7E:0AF6]
$A8:9C00 9F 0C 78 7E STA $7E780C,x[$7E:780C]
$A8:9C04 9F 0E 78 7E STA $7E780E,x[$7E:780E]
$A8:9C08 9F 10 78 7E STA $7E7810,x[$7E:7810]
$A8:9C0C A9 0C 00    LDA #$000C
$A8:9C0F 9F 12 78 7E STA $7E7812,x[$7E:7812]
$A8:9C13 BD FA 0A    LDA $0AFA,x[$7E:0AFA]  ; <-- bug
$A8:9C16 9F 14 78 7E STA $7E7814,x[$7E:7814]
$A8:9C1A 9F 16 78 7E STA $7E7816,x[$7E:7816]
$A8:9C1E 9F 18 78 7E STA $7E7818,x[$7E:7818]
$A8:9C22 AD 9E 9A    LDA $9A9E  [$A8:9A9E]
$A8:9C25 9F 1A 78 7E STA $7E781A,x[$7E:781A]
$A8:9C29 AD 9C 9A    LDA $9A9C  [$A8:9A9C]
$A8:9C2C 9F 1C 78 7E STA $7E781C,x[$7E:781C]
...
$A8:9C92 9D 80 0F    STA $0F80,x[$7E:0F80]
...
$A8:9CB0 9F 02 78 7E STA $7E7802,x[$7E:7802]
...
$A8:9CC1 BF 02 78 7E LDA $7E7802,x[$7E:7802]
$A8:9CC5 18          CLC
$A8:9CC6 6D A0 9A    ADC $9AA0  [$A8:9AA0]
$A8:9CC9 9F 02 78 7E STA $7E7802,x[$7E:7802]
...
$A8:9E8D A0 00 00    LDY #$0000
$A8:9E90 AD 97 07    LDA $0797  [$7E:0797]
$A8:9E93 F0 03       BEQ $03    [$9E98]
$A8:9E95 4C 4A 9F    JMP $9F4A  [$A8:9F4A]
...
$A8:9EA7 AA          TAX
$A8:9EA8 18          CLC
$A8:9EA9 69 20 00    ADC #$0020
$A8:9EAC 85 14       STA $14    [$7E:0014]

$A8:9EAE BF 00 C2 7E LDA $7EC200,x[$7E:C320]
$A8:9EB2 DF 00 C0 7E CMP $7EC000,x[$7E:C120]
$A8:9EB6 D0 03       BNE $03    [$9EBB]
$A8:9EB8 4C 41 9F    JMP $9F41  [$A8:9F41]

$A8:9EBB 29 1F 00    AND #$001F
$A8:9EBE 85 12       STA $12    [$7E:0012]
$A8:9EC0 BF 00 C0 7E LDA $7EC000,x[$7E:C120]
$A8:9EC4 29 1F 00    AND #$001F
$A8:9EC7 C5 12       CMP $12    [$7E:0012]
$A8:9EC9 F0 16       BEQ $16    [$9EE1]
$A8:9ECB 10 03       BPL $03    [$9ED0]
$A8:9ECD 1A          INC A
...
$A8:9F45 10 03       BPL $03    [$9F4A]
$A8:9F47 4C AE 9E    JMP $9EAE  [$A8:9EAE]
...
$A8:A183 9D B2 0F    STA $0FB2,x[$7E:0FB2]  ;} Enemy $0FB2 = [enemy parameter 1]
...
$A8:A218 3A          DEC A                  ;} Decrement enemy $7E:802A
$A8:A219 9F 2A 80 7E STA $7E802A,x[$7E:806A];/
$A8:A21D 22 70 AD A0 JSL $A0AD70[$A0:AD70]  ; Check if enemy is on screen or not
...
$A8:A26F A9 40 00    LDA #$0040             ;} Enemy $7E:7810 = min(40h, [A])
...
$A8:A287 9F 2A 80 7E STA $7E802A,x[$7E:806A];} Enemy $7E:802A = 30h
$A8:A28B 60          RTS
}
...
$A8:A292 9E AC 0F    STZ $0FAC,x[$7E:0FEC]
$A8:A295 9E AE 0F    STZ $0FAE,x[$7E:0FEE]
...
$A8:A2BE 10 09       BPL $09    [$A2C9]
$A8:A2C0 A9 00 00    LDA #$0000
$A8:A2C3 9F 1E 80 7E STA $7E801E,x[$7E:805E]
$A8:A2C7 80 07       BRA $07    [$A2D0]

$A8:A2C9 A9 01 00    LDA #$0001
$A8:A2CC 9F 1E 80 7E STA $7E801E,x[$7E:821E]

$A8:A2D0 20 10 A3    JSR $A310  [$A8:A310]
...
$A8:A2FE 9F 24 80 7E STA $7E8024,x[$7E:8064]
$A8:A302 B9 A9 A0    LDA $A0A9,y[$A8:A0AD]
$A8:A305 9F 26 80 7E STA $7E8026,x[$7E:8066]
$A8:A309 A9 45 A4    LDA #$A445             ;\
$A8:A30C 9D A8 0F    STA $0FA8,x[$7E:0FE8]  ;} Enemy function = $A445
$A8:A30F 60          RTS
}
...
$A8:A6CB A8          TAY                    ;} Y = [enemy $7E:8800] (enemy projectile index)
...
$A8:A6E2 A8          TAY                    ;} Y = [enemy $7E:8802] (enemy projectile index)
...
$A8:A703 A8          TAY                    ;} Y = [enemy $7E:8804] (enemy projectile index)
...
$A8:A724 A8          TAY                    ;} Y = [enemy $7E:8806] (enemy projectile index)
...
$A8:A747 38          SEC
$A8:A748 E5 12       SBC $12    [$7E:0012]
$A8:A74A 29 FF 00    AND #$00FF
$A8:A74D 0A          ASL A
$A8:A74E AA          TAX
$A8:A74F 08          PHP
$A8:A750 64 14       STZ $14    [$7E:0014]
$A8:A752 64 16       STZ $16    [$7E:0016]
$A8:A754 BF C3 B1 A0 LDA $A0B1C3,x[$A0:B343]
$A8:A758 10 06       BPL $06    [$A760]
$A8:A75A 49 FF FF    EOR #$FFFF
$A8:A75D 1A          INC A
$A8:A75E E6 14       INC $14    [$7E:0014]

$A8:A760 29 00 FF    AND #$FF00
$A8:A763 EB          XBA
$A8:A764 E2 20       SEP #$20
$A8:A766 8D 02 42    STA $4202  [$7E:4202]
$A8:A769 AD 32 0E    LDA $0E32  [$7E:0E32]
$A8:A76C F0 24       BEQ $24    [$A792]
$A8:A76E 8D 03 42    STA $4203  [$7E:4203]
$A8:A771 EA          NOP
$A8:A772 EA          NOP
$A8:A773 EA          NOP
$A8:A774 C2 20       REP #$20
$A8:A776 AD 16 42    LDA $4216  [$7E:4216]
$A8:A779 29 00 FF    AND #$FF00
$A8:A77C EB          XBA
$A8:A77D 0A          ASL A
$A8:A77E 85 16       STA $16    [$7E:0016]
$A8:A780 A5 14       LDA $14    [$7E:0014]
$A8:A782 F0 0E       BEQ $0E    [$A792]
...
$A8:ABBD A9 04 00    LDA #$0004
$A8:ABC0 22 AF A3 A0 JSL $A0A3AF[$A0:A3AF]
...
$A8:B153 22 0B AF A0 JSL $A0AF0B[$A0:AF0B]
...
{
$A8:B40C 22 3D A6 A0 JSL $A0A63D[$A0:A63D]
}
...
;;; $C223:  ;;;
{
$A8:C223 A0 07 00    LDY #$0007

$A8:C226 98          TYA
$A8:C227 5A          PHY
$A8:C228 A0 98 D2    LDY #$D298
$A8:C22B 22 27 80 86 JSL $868027[$86:8027]
$A8:C22F 7A          PLY
$A8:C230 88          DEY
$A8:C231 10 F3       BPL $F3    [$C226]
$A8:C233 60          RTS
}
...
;;; $C234:  ;;;
{
$A8:C234 BD 52 0F    LDA $0F52,x[$7E:0F92]
$A8:C237 C9 91 C1    CMP #$C191
$A8:C23A 10 1E       BPL $1E    [$C25A]
$A8:C23C 38          SEC
...
$A8:C248 30 03       BMI $03    [$C24D]
$A8:C24A A9 00 00    LDA #$0000
...
$A8:C266 30 03       BMI $03    [$C26B]
$A8:C268 A9 00 00    LDA #$0000
...
$A8:C2A2 20 34 C2    JSR $C234  [$A8:C234]
$A8:C2A5 6B          RTL
}
...
$A8:C315 9D AA 0F    STA $0FAA,x[$7E:0FEA]
...
$A8:C35E 9D 54 0F    STA $0F54,x
$A8:C361 A9 91 C1    LDA #$C191
$A8:C364 9D 52 0F    STA $0F52,x
...
$A8:C425 9D AA 0F    STA $0FAA,x[$7E:106A]
...
$A8:C4BE 9D AA 0F    STA $0FAA,x[$7E:106A]
...
$A8:C4F3 9D 54 0F    STA $0F54,x
$A8:C4F6 A9 91 C1    LDA #$C191
$A8:C4F9 9D 52 0F    STA $0F52,x
...
$A8:C5C4 D0 28       BNE $28    [$C5EE]
$A8:C5C6 BD 96 0F    LDA $0F96,x[$7E:1056]
$A8:C5C9 48          PHA
$A8:C5CA 22 77 A4 A0 JSL $A0A477[$A0:A477]
$A8:C5CE AE 54 0E    LDX $0E54  [$7E:0E54]
$A8:C5D1 BD 8C 0F    LDA $0F8C,x[$7E:104C]
$A8:C5D4 F0 02       BEQ $02    [$C5D8]
$A8:C5D6 68          PLA
$A8:C5D7 6B          RTL

$A8:C5D8 BD 46 0F    LDA $0F46,x
$A8:C5DB 09 00 02    ORA #$0200
$A8:C5DE 9D 46 0F    STA $0F46,x
$A8:C5E1 68          PLA
$A8:C5E2 9D 96 0F    STA $0F96,x
$A8:C5E5 20 23 C2    JSR $C223  [$A8:C223]
$A8:C5E8 A9 00 0A    LDA #$0A00
$A8:C5EB 9D 96 0F    STA $0F96,x
...
$A8:CD3B 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:CDD6 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:CE1C 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:CEB7 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:CF01 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:CF9C 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:CFE2 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:D07D 29 FF FF    AND #$FFFF             ;} If enemy is touching Samus:
...
$A8:D9C1 22 EA AF A0 JSL $A0AFEA[$A0:AFEA]
$A8:D9C5 22 67 B0 A0 JSL $A0B067[$A0:B067]
...
$A8:DD8E 49 FF FF    EOR #$FFFF
$A8:DD91 1A          INC A

$A8:DD92 CD C7 DC    CMP $DCC7  [$A8:DCC7]
$A8:DD95 10 2D       BPL $2D    [$DDC4]
$A8:DD97 20 37 DD    JSR $DD37  [$A8:DD37]
$A8:DD9A A0 4B DC    LDY #$DC4B
$A8:DD9D A9 FE FF    LDA #$FFFE
$A8:DDA0 28          PLP
$A8:DDA1 30 06       BMI $06    [$DDA9]
$A8:DDA3 A0 BB DC    LDY #$DCBB
$A8:DDA6 A9 02 00    LDA #$0002
...
$A8:DDCD 9D 80 0F    STA $0F80,x[$7E:10C0]
...
$A8:DDFD 9D AA 0F    STA $0FAA,x
$A8:DE00 9D AC 0F    STA $0FAC,x
$A8:DE03 80 D9       BRA $D9    [$DDDE]
}
...
$A8:DE20 08          PHP
$A8:DE21 A0 E7 DB    LDY #$DBE7
$A8:DE24 A9 FE FF    LDA #$FFFE
$A8:DE27 28          PLP
$A8:DE28 30 06       BMI $06    [$DE30]
$A8:DE2A A9 02 00    LDA #$0002
$A8:DE2D A0 57 DC    LDY #$DC57
...
$A8:DE73 49 FF FF    EOR #$FFFF
$A8:DE76 1A          INC A

$A8:DE77 BF 08 78 7E LDA $7E7808,x[$7E:7948]
$A8:DE7B D0 0C       BNE $0C    [$DE89]
$A8:DE7D 28          PLP
$A8:DE7E 30 0B       BMI $0B    [$DE8B]
$A8:DE80 A0 73 DC    LDY #$DC73
$A8:DE83 BD AE 0F    LDA $0FAE,x[$7E:10AE]
$A8:DE86 10 0B       BPL $0B    [$DE93]
$A8:DE88 6B          RTL

$A8:DE89 28          PLP
$A8:DE8A 6B          RTL

$A8:DE8B A0 03 DC    LDY #$DC03
$A8:DE8E BD AE 0F    LDA $0FAE,x[$7E:10EE]
$A8:DE91 10 10       BPL $10    [$DEA3]
...
$A8:DEB6 A0 51 DC    LDY #$DC51
$A8:DEB9 BD AE 0F    LDA $0FAE,x
$A8:DEBC 30 03       BMI $03    [$DEC1]
$A8:DEBE A0 C1 DC    LDY #$DCC1
...
{
$A8:DF33 5A          PHY
$A8:DF34 A9 02 00    LDA #$0002
$A8:DF37 80 E7       BRA $E7    [$DF20]
}
...
{
$A8:DF39 5A          PHY
$A8:DF3A A9 04 00    LDA #$0004
$A8:DF3D 80 E1       BRA $E1    [$DF20]
}
...
$A8:DF50 A9 02 00    LDA #$0002

$A8:DF53 9F 08 78 7E STA $7E7808,x[$7E:7948]
$A8:DF57 A0 E7 DB    LDY #$DBE7
$A8:DF5A BD AE 0F    LDA $0FAE,x[$7E:10EE]
$A8:DF5D 30 03       BMI $03    [$DF62]
$A8:DF5F A0 57 DC    LDY #$DC57
...
$A8:DF6A F0 05       BEQ $05    [$DF71]
$A8:DF6C 3A          DEC A
$A8:DF6D 9F 08 78 7E STA $7E7808,x[$7E:7948]
}
...
$A8:DF82 22 AD C8 A0 JSL $A0C8AD[$A0:C8AD]
$A8:DF86 7A          PLY
$A8:DF87 6B          RTL

$A8:DF88 7A          PLY
$A8:DF89 A0 E9 DB    LDY #$DBE9
$A8:DF8C BD AE 0F    LDA $0FAE,x[$7E:0FAE]
$A8:DF8F 10 03       BPL $03    [$DF94]
$A8:DF91 A0 59 DC    LDY #$DC59
...
;;; $DF9D:  ;;;
{
$A8:DF9D 22 3D A6 A0 JSL $A0A63D[$A0:A63D]
$A8:DFA1 6B          RTL
}
...
$A8:E3C9 20 EF E3    JSR $E3EF  [$A8:E3EF]
$A8:E3CC AE 54 0E    LDX $0E54  [$7E:0E54]
$A8:E3CF FC A8 0F    JSR ($0FA8,x)[$A8:E405]
$A8:E3D2 AE 54 0E    LDX $0E54  [$7E:0E54]
$A8:E3D5 FC AA 0F    JSR ($0FAA,x)[$A8:E462]
$A8:E3D8 6B          RTL
}
...
$A8:E3DF 9D A8 0F    STA $0FA8,x[$7E:16E8]
$A8:E3E2 22 DD AE A0 JSL $A0AEDD[$A0:AEDD]
$A8:E3E6 30 06       BMI $06    [$E3EE]
$A8:E3E8 A9 24 E4    LDA #$E424
$A8:E3EB 9D A8 0F    STA $0FA8,x[$7E:16E8]
...
$A8:E3F5 9D AA 0F    STA $0FAA,x[$7E:16EA]
$A8:E3F8 22 E5 AE A0 JSL $A0AEE5[$A0:AEE5]
$A8:E3FC 30 06       BMI $06    [$E404]
$A8:E3FE A9 62 E4    LDA #$E462
$A8:E401 9D AA 0F    STA $0FAA,x[$7E:16EA]
...
$A8:E645 9D AA 0F    STA $0FAA,x[$7E:10EA]
...
$A8:E67B 0D 00 01    ORA $0100  [$7E:0100]  ; Bug (non-immediate mode)
$A8:E67E 9D 86 0F    STA $0F86,x
$A8:E681 6B          RTL

$A8:E682             dw E5D1, E5D1, E609    ; Instruction list pointers
$A8:E688             dw E694, E6B7, E6DC    ; Wrecked Ship spark functions
}
...
$A8:E691 7C AA 0F    JMP ($0FAA,x)[$A8:E6B7]
}
...
$A8:E6E2 9D B2 0F    STA $0FB2,x[$7E:1132]
$A8:E6E5 6B          RTL
...
;;; $E6F6:  ;;;
{
$A8:E6F6 BD B0 0F    LDA $0FB0,x[$7E:10F0]
$A8:E6F9 10 0B       BPL $0B    [$E706]
$A8:E6FB 22 11 81 80 JSL $808111[$80:8111]
$A8:E6FF 29 3F 00    AND #$003F
$A8:E702 18          CLC
$A8:E703 69 04 00    ADC #$0004

$A8:E706 18          CLC
$A8:E707 65 12       ADC $12    [$7E:0012]
...
$A8:E842 A0 4C 80    LDY #$804C

$A8:E845 8C 8C 17    STY $178C  [$7E:178C]
$A8:E848 A9 A8 00    LDA #$00A8
$A8:E84B 8D 8E 17    STA $178E  [$7E:178E]
...
$A8:E85F 8D 98 17    STA $1798  [$7E:1798]
...
$A8:E8B4 89 04 00    BIT #$0004
$A8:E8B7 F0 62       BEQ $62    [$E91B]
$A8:E8B9 A0 6E E8    LDY #$E86E
$A8:E8BC 8C 8C 17    STY $178C  [$7E:178C]
...
$A8:E918 8D 98 17    STA $1798  [$7E:1798]
...
$A8:F21A 09 00 20    ORA #$2000
$A8:F21D 9D 86 0F    STA $0F86,x[$7E:0FC6]
$A8:F220 A9 01 00    LDA #$0001
$A8:F223 9D 94 0F    STA $0F94,x[$7E:0FD4]
$A8:F226 9E 90 0F    STZ $0F90,x[$7E:0FD0]
$A8:F229 A9 4E EA    LDA #$EA4E
$A8:F22C 9D 92 0F    STA $0F92,x[$7E:0FD2]
$A8:F22F BD 3E 0F    LDA $0F3E,x[$7E:0F7E]
$A8:F232 9D 7E 0F    STA $0F7E,x[$7E:0FBE]
$A8:F235 BD 3A 0F    LDA $0F3A,x[$7E:0F7A]
$A8:F238 9D 7A 0F    STA $0F7A,x[$7E:0FBA]
$A8:F23B A9 F3 F6    LDA #$F6F3
$A8:F23E 9D A8 0F    STA $0FA8,x[$7E:0FE8]
$A8:F241 BD 56 0F    LDA $0F56,x[$7E:0F96]
$A8:F244 9D 96 0F    STA $0F96,x[$7E:0FD6]
$A8:F247 BD 58 0F    LDA $0F58,x[$7E:0F98]
$A8:F24A 9D 98 0F    STA $0F98,x[$7E:0FD8]
$A8:F24D BD 74 0F    LDA $0F74,x[$7E:0FB4]
$A8:F250 10 09       BPL $09    [$F25B]
$A8:F252 BD 86 0F    LDA $0F86,x[$7E:0FC6]
$A8:F255 09 00 02    ORA #$0200
...
$A8:F25F 7C A8 0F    JMP ($0FA8,x)[$A8:F268]
}
...
$A8:F287 30 16       BMI $16    [$F29F]
$A8:F289 A9 FF FF    LDA #$FFFF
$A8:F28C 80 0D       BRA $0D    [$F29B]

$A8:F28E BF 12 78 7E LDA $7E7812,x[$7E:7892]
$A8:F292 49 FF FF    EOR #$FFFF
$A8:F295 1A          INC A
$A8:F296 80 03       BRA $03    [$F29B]

$A8:F298 A9 01 00    LDA #$0001
...
$A8:F2B1 A0 00 00    LDY #$0000
$A8:F2B4 BF 0E 78 7E LDA $7E780E,x[$7E:798E]
$A8:F2B8 49 FF FF    EOR #$FFFF
$A8:F2BB 1A          INC A
$A8:F2BC 9F 0E 78 7E STA $7E780E,x[$7E:798E]
$A8:F2C0 30 03       BMI $03    [$F2C5]
$A8:F2C2 A0 04 00    LDY #$0004

$A8:F2C5 B9 B0 F3    LDA $F3B0,y[$A8:F3B4]
$A8:F2C8 9D 92 0F    STA $0F92,x[$7E:1112]
$A8:F2CB B9 B2 F3    LDA $F3B2,y[$A8:F3B6]
$A8:F2CE 9D D2 0F    STA $0FD2,x[$7E:1152]
$A8:F2D1 A9 01 00    LDA #$0001
$A8:F2D4 9D 94 0F    STA $0F94,x[$7E:1114]
$A8:F2D7 9D D4 0F    STA $0FD4,x[$7E:1154]

; BRANCH_NO_COLLISION
$A8:F2DA 22 AD C8 A0 JSL $A0C8AD[$A0:C8AD]
$A8:F2DE AD F6 0A    LDA $0AF6  [$7E:0AF6]
$A8:F2E1 38          SEC
$A8:F2E2 FD 7A 0F    SBC $0F7A,x[$7E:0F7A]
...
$A8:F2F2 30 01       BMI $01    [$F2F5]
$A8:F2F4 6B          RTL

$A8:F2F5 AD FA 0A    LDA $0AFA  [$7E:0AFA]
$A8:F2F8 38          SEC
$A8:F2F9 FD 7E 0F    SBC $0F7E,x[$7E:0F7E]
$A8:F2FC C9 20 00    CMP #$0020
$A8:F2FF 10 01       BPL $01    [$F302]
$A8:F301 6B          RTL

$A8:F302 85 18       STA $18    [$7E:0018]
$A8:F304 A5 12       LDA $12    [$7E:0012]
$A8:F306 30 36       BMI $36    [$F33E]
$A8:F308 A9 02 00    LDA #$0002
$A8:F30B 9F 00 78 7E STA $7E7800,x[$7E:7980]
$A8:F30F A9 00 00    LDA #$0000
$A8:F312 9F 04 78 7E STA $7E7804,x[$7E:7984]
$A8:F316 9F 06 78 7E STA $7E7806,x[$7E:7986]
$A8:F31A 9F 08 78 7E STA $7E7808,x[$7E:7988]
$A8:F31E A9 00 20    LDA #$2000
$A8:F321 9F 0A 78 7E STA $7E780A,x[$7E:798A]
$A8:F325 A9 80 00    LDA #$0080
$A8:F328 9D B2 0F    STA $0FB2,x[$7E:1132]
$A8:F32B A9 01 00    LDA #$0001
$A8:F32E 9F 0E 78 7E STA $7E780E,x[$7E:798E]
$A8:F332 A9 90 00    LDA #$0090
$A8:F335 9F 1C 78 7E STA $7E781C,x[$7E:799C]
$A8:F339 A0 04 00    LDY #$0004
$A8:F33C 80 34       BRA $34    [$F372]

$A8:F33E A9 FE FF    LDA #$FFFE
$A8:F341 9F 00 78 7E STA $7E7800,x[$7E:7800]
$A8:F345 A9 00 00    LDA #$0000
$A8:F348 9F 04 78 7E STA $7E7804,x[$7E:7804]
$A8:F34C 9F 06 78 7E STA $7E7806,x[$7E:7806]
$A8:F350 A9 FF FF    LDA #$FFFF
$A8:F353 9F 08 78 7E STA $7E7808,x[$7E:7808]
$A8:F357 9F 0E 78 7E STA $7E780E,x[$7E:780E]
$A8:F35B A9 00 E0    LDA #$E000
$A8:F35E 9F 0A 78 7E STA $7E780A,x[$7E:780A]
$A8:F362 A9 FF 00    LDA #$00FF
$A8:F365 9D B2 0F    STA $0FB2,x[$7E:0FB2]
$A8:F368 A9 F0 00    LDA #$00F0
$A8:F36B 9F 1C 78 7E STA $7E781C,x[$7E:781C]
$A8:F36F A0 00 00    LDY #$0000

$A8:F372 B9 B0 F3    LDA $F3B0,y[$A8:F3B0]
$A8:F375 9D 92 0F    STA $0F92,x[$7E:0F92]
$A8:F378 B9 B2 F3    LDA $F3B2,y[$A8:F3B2]
$A8:F37B 9D D2 0F    STA $0FD2,x[$7E:0FD2]
$A8:F37E A9 01 00    LDA #$0001
$A8:F381 9D 94 0F    STA $0F94,x[$7E:0F94]
$A8:F384 9D D4 0F    STA $0FD4,x[$7E:0FD4]
$A8:F387 BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$A8:F38A 18          CLC
$A8:F38B 65 12       ADC $12    [$7E:0012]
$A8:F38D 9D AA 0F    STA $0FAA,x[$7E:0FAA]
$A8:F390 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$A8:F393 9D AC 0F    STA $0FAC,x[$7E:0FAC]
$A8:F396 A9 B8 F3    LDA #$F3B8
$A8:F399 9D A8 0F    STA $0FA8,x[$7E:0FA8]
$A8:F39C A5 18       LDA $18    [$7E:0018]
$A8:F39E 9F 24 78 7E STA $7E7824,x[$7E:7824]
$A8:F3A2 A5 14       LDA $14    [$7E:0014]
$A8:F3A4 9F 22 78 7E STA $7E7822,x[$7E:7822]
$A8:F3A8 A9 00 00    LDA #$0000
$A8:F3AB 9F 20 78 7E STA $7E7820,x[$7E:7820]
$A8:F3AF 6B          RTL

$A8:F3B0             dw E9FA,EA4E, EA24,EA5E
}
...
$A8:F48F 22 AD C8 A0 JSL $A0C8AD[$A0:C8AD]
...
$A8:F4FF 22 AD C8 A0 JSL $A0C8AD[$A0:C8AD]
...
$A8:F522 9D A8 0F    STA $0FA8,x[$7E:1128]
$A8:F525 6B          RTL
}
...
;;; $F526:  ;;;
{
$A8:F526 A0 FA E9    LDY #$E9FA
$A8:F529 A9 4E EA    LDA #$EA4E
$A8:F52C 85 12       STA $12    [$7E:0012]
$A8:F52E BF 0E 78 7E LDA $7E780E,x[$7E:780E]
$A8:F532 30 08       BMI $08    [$F53C]
$A8:F534 A0 24 EA    LDY #$EA24
$A8:F537 A9 5E EA    LDA #$EA5E
$A8:F53A 85 12       STA $12    [$7E:0012]

$A8:F53C 98          TYA
$A8:F53D 9D 92 0F    STA $0F92,x[$7E:0F92]
$A8:F540 A9 01 00    LDA #$0001
$A8:F543 9D 94 0F    STA $0F94,x[$7E:0F94]
$A8:F546 BD E8 0F    LDA $0FE8,x[$7E:0FE8]
$A8:F549 C9 F3 F6    CMP #$F6F3
$A8:F54C D0 0B       BNE $0B    [$F559]
$A8:F54E A5 12       LDA $12    [$7E:0012]
$A8:F550 9D D2 0F    STA $0FD2,x[$7E:0FD2]
$A8:F553 A9 01 00    LDA #$0001
$A8:F556 9D D4 0F    STA $0FD4,x[$7E:0FD4]
...
$A8:F57B 9F 10 78 7E STA $7E7810,x[$7E:7910]
...
$A8:F614 22 AD C8 A0 JSL $A0C8AD[$A0:C8AD]
$A8:F618 BF 10 78 7E LDA $7E7810,x[$7E:7890]
$A8:F61C 18          CLC
$A8:F61D 6D 82 F1    ADC $F182  [$A8:F182]
$A8:F620 9F 10 78 7E STA $7E7810,x[$7E:7890]
...
$A8:F641 30 34       BMI $34    [$F677]
$A8:F643 A9 00 00    LDA #$0000
$A8:F646 9F 10 78 7E STA $7E7810,x[$7E:7890]
$A8:F64A A9 FC FF    LDA #$FFFC
$A8:F64D 9F 12 78 7E STA $7E7812,x[$7E:7892]
$A8:F651 A9 E3 F5    LDA #$F5E3
$A8:F654 9D A8 0F    STA $0FA8,x[$7E:1028]
$A8:F657 A9 0C 00    LDA #$000C
$A8:F65A 9F 1E 78 7E STA $7E781E,x[$7E:789E]
$A8:F65E A0 C2 EA    LDY #$EAC2
$A8:F661 BD 92 0F    LDA $0F92,x[$7E:1012]
$A8:F664 C9 A6 EA    CMP #$EAA6
$A8:F667 30 03       BMI $03    [$F66C]
$A8:F669 A0 DA EA    LDY #$EADA

$A8:F66C 98          TYA
$A8:F66D 9D 92 0F    STA $0F92,x[$7E:1012]
$A8:F670 A9 01 00    LDA #$0001
$A8:F673 9D 94 0F    STA $0F94,x[$7E:1014]
$A8:F676 6B          RTL

$A8:F677 A9 01 00    LDA #$0001
$A8:F67A 9F 12 78 7E STA $7E7812,x
$A8:F67E 6B          RTL
}
...
;;; $F6B3:  ;;;
{
$A8:F6B3 A0 F2 EA    LDY #$EAF2
$A8:F6B6 BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$A8:F6B9 CD F6 0A    CMP $0AF6  [$7E:0AF6]
$A8:F6BC 10 03       BPL $03    [$F6C1]
$A8:F6BE A0 10 EB    LDY #$EB10

$A8:F6C1 98          TYA
$A8:F6C2 9D 92 0F    STA $0F92,x[$7E:0F92]
$A8:F6C5 A9 01 00    LDA #$0001
$A8:F6C8 9D 94 0F    STA $0F94,x[$7E:0F94]
$A8:F6CB A9 E3 F5    LDA #$F5E3
$A8:F6CE 9D A8 0F    STA $0FA8,x[$7E:0FA8]
$A8:F6D1 6B          RTL
}
...
$A8:F6ED 9F 1E 78 7E STA $7E781E,x[$7E:781E]
$A8:F6F1 7A          PLY
$A8:F6F2 6B          RTL
}
...
$A8:F6F6 9D 7A 0F    STA $0F7A,x[$7E:0FBA]
$A8:F6F9 BD 3E 0F    LDA $0F3E,x[$7E:0F7E]
$A8:F6FC 9D 7E 0F    STA $0F7E,x[$7E:0FBE]
$A8:F6FF 6B          RTL
}
...
{
$A8:F701 22 3D A6 A0 JSL $A0A63D[$A0:A63D]
$A8:F705 AE 54 0E    LDX $0E54  [$7E:0E54]
$A8:F708 BD 8C 0F    LDA $0F8C,x[$7E:0F8C]
$A8:F70B F0 20       BEQ $20    [$F72D]
$A8:F70D DD F4 0F    CMP $0FF4,x[$7E:10F4]
$A8:F710 F0 22       BEQ $22    [$F734]
$A8:F712 30 20       BMI $20    [$F734]
$A8:F714 BD 8A 0F    LDA $0F8A,x[$7E:108A]
$A8:F717 9D CA 0F    STA $0FCA,x[$7E:10CA]
$A8:F71A BD 9E 0F    LDA $0F9E,x[$7E:109E]
$A8:F71D 9D DE 0F    STA $0FDE,x[$7E:10DE]
$A8:F720 BD A0 0F    LDA $0FA0,x[$7E:10A0]
$A8:F723 9D E0 0F    STA $0FE0,x[$7E:10E0]
$A8:F726 BD 9C 0F    LDA $0F9C,x[$7E:109C]
$A8:F729 9D DC 0F    STA $0FDC,x[$7E:10DC]

$A8:F72C 6B          RTL

$A8:F72D A9 00 02    LDA #$0200
$A8:F730 9D C6 0F    STA $0FC6,x[$7E:0FC6]
$A8:F733 6B          RTL

$A8:F734 BF 28 78 7E LDA $7E7828,x[$7E:7928]
$A8:F738 D0 F2       BNE $F2    [$F72C]
$A8:F73A A9 01 00    LDA #$0001
$A8:F73D 9F 28 78 7E STA $7E7828,x[$7E:7928]
$A8:F741 A9 5A F5    LDA #$F55A
$A8:F744 9D A8 0F    STA $0FA8,x[$7E:10A8]
$A8:F747 A9 00 00    LDA #$0000
$A8:F74A 9F 10 78 7E STA $7E7810,x[$7E:7910]
$A8:F74E A9 01 00    LDA #$0001
$A8:F751 9F 12 78 7E STA $7E7812,x[$7E:7912]
$A8:F755 DA          PHX
$A8:F756 8A          TXA
$A8:F757 18          CLC
$A8:F758 69 40 00    ADC #$0040
$A8:F75B 8D 54 0E    STA $0E54  [$7E:0E54]
$A8:F75E AA          TAX
$A8:F75F BD A8 0F    LDA $0FA8,x[$7E:10E8]
$A8:F762 C9 CF F7    CMP #$F7CF
$A8:F765 F0 63       BEQ $63    [$F7CA]
$A8:F767 BD 7E 0F    LDA $0F7E,x[$7E:10BE]
$A8:F76A 9F 0E 78 7E STA $7E780E,x[$7E:794E]
$A8:F76E BD 7A 0F    LDA $0F7A,x[$7E:10BA]
$A8:F771 9F 10 78 7E STA $7E7810,x[$7E:7950]
$A8:F775 20 8D F9    JSR $F98D  [$A8:F98D]
$A8:F778 20 51 F8    JSR $F851  [$A8:F851]
$A8:F77B 20 7F F8    JSR $F87F  [$A8:F87F]
$A8:F77E A9 00 E0    LDA #$E000
$A8:F781 9D B2 0F    STA $0FB2,x[$7E:10F2]
$A8:F784 A9 CF F7    LDA #$F7CF
$A8:F787 9D A8 0F    STA $0FA8,x[$7E:10E8]
$A8:F78A A9 DB F7    LDA #$F7DB
$A8:F78D 9F 00 78 7E STA $7E7800,x[$7E:7940]
$A8:F791 BF 0E 78 7E LDA $7E780E,x[$7E:794E]
$A8:F795 38          SEC
$A8:F796 FF 16 78 7E SBC $7E7816,x[$7E:7956]
$A8:F79A 9F 0C 78 7E STA $7E780C,x[$7E:794C]
$A8:F79E BD 7A 0F    LDA $0F7A,x[$7E:10BA]
$A8:F7A1 9F 0A 78 7E STA $7E780A,x[$7E:794A]
$A8:F7A5 BF 14 78 7E LDA $7E7814,x[$7E:7954]
$A8:F7A9 9D AA 0F    STA $0FAA,x[$7E:10EA]
$A8:F7AC A9 7E EA    LDA #$EA7E
$A8:F7AF 9D 92 0F    STA $0F92,x[$7E:10D2]
$A8:F7B2 A9 4D 80    LDA #$804D
$A8:F7B5 9D 8E 0F    STA $0F8E,x[$7E:10CE]
$A8:F7B8 A9 01 00    LDA #$0001
$A8:F7BB 9D 94 0F    STA $0F94,x[$7E:10D4]
$A8:F7BE 9E 90 0F    STZ $0F90,x[$7E:10D0]
$A8:F7C1 BD 86 0F    LDA $0F86,x[$7E:10C6]
$A8:F7C4 09 00 08    ORA #$0800
$A8:F7C7 9D 86 0F    STA $0F86,x[$7E:10C6]

$A8:F7CA 68          PLA
$A8:F7CB 8D 54 0E    STA $0E54  [$7E:0E54]
$A8:F7CE 6B          RTL
}

...
; Ki-hunter wings - falling
$A8:ECA8             dx 0002, C3F4,F8,6149, C3FC,F8,6148

; Ki-hunter wings - falling (unused)
$A8:ECB4             dx 0002, C3F4,F8,6149, C3FC,F8,6148

; Ki-hunter - swiping - facing left
...
; Ki-hunter - swiping - facing right

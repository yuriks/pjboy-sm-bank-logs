...
$B2:8C04             dx 0002, 0000,0006,C58A,9E5A, 0000,0003,B440,99BC
...
$B2:971C             dx 0001, FFF3,FFED,000A,001E,876C,8779
...
$B2:9B6E             dx 0001, FFF9,FFED,0006,0000,876C,883E
...
$B2:9D6C             dx 0001, FFF9,FFED,0006,0000,876C,883E
...
$B2:B1DA             dx 000A, 81F7,FF,2107, 0004,11,2144, 0004,09,2143, 01F7,09,E149, 01FF,09,E148, 81F4,FF,2107, 01F5,0B,E149, 01FD,0B,E148, 01FE,13,2144, 01FE,0B,2143
...
$B2:B474             dx 000A, 81F9,FF,6107, 01F4,11,6144, 01F4,09,6143, 0001,09,A149, 01F9,09,A148, 81FC,FF,6107, 0003,0B,A149, 01FB,0B,A148, 01FA,13,6144, 01FA,0B,6143
...
;;; $ECE4: Instruction list - moving down wall - facing right ;;;
{
$B2:ECE4             dx EF83,F034,  ; Enemy function = $F034
                        000A,89B0,
                        EF83,F034,  ; Enemy function = $F034
                        8123,0004   ; Timer = 4
$B2:ECF4             dx 000A,88A0,
                        EE40,FFFD,  ; Move enemy -3 pixels down and change direction on collision - facing right
                        0008,88B2,
                        EE40,FFFD,  ; Move enemy -3 pixels down and change direction on collision - facing right
                        0005,88C4,
                        EE40,FFFD,  ; Move enemy -3 pixels down and change direction on collision - facing right
                        ...
                        EEA4        ; Randomly choose a direction - facing right
}


;;; $ED36: Instruction list - moving up wall - facing right ;;;
{
$B2:ED36             dx EF83,F034,  ; Enemy function = $F034
                        8123,0004   ; Timer = 4
$B2:ED3E             dx 000A,88A0,
                        EE40,0003,  ; Move enemy 3 pixels down and change direction on collision - facing right
                        0008,88B2,
                        EE40,0003,  ; Move enemy 3 pixels down and change direction on collision - facing right
                        0005,88C4,
                        EE40,0003,  ; Move enemy 3 pixels down and change direction on collision - facing right
...
;;; $EDA4: Instruction list - moving down wall - facing left ;;;
{
$B2:EDA4             dx EF83,F0C8,  ; Enemy function = $F0C8
                        000A,891E,
                        EF83,F0C8,  ; Enemy function = $F0C8
                        8123,0004   ; Timer = 4
$B2:EDB4             dx 000A,8932,
                        EE72,0003,  ; Move enemy 3 pixels down and change direction on collision - facing left
                        0008,8944,
                        EE72,0003,  ; Move enemy 3 pixels down and change direction on collision - facing left
                        0005,8956,
                        EE72,0003,  ; Move enemy 3 pixels down and change direction on collision - facing left
                        ...
                        EEBC        ; Randomly choose a direction - facing left
}


;;; $EDF6: Instruction list - moving up wall - facing left ;;;
{
$B2:EDF6             dx EF83,F0C8,  ; Enemy function = $F0C8
                        8123,0004   ; Timer = 4
$B2:EDFE             dx 000A,8932,
                        EE72,FFFD,  ; Move enemy -3 pixels down and change direction on collision - facing left
                        0008,8944,
                        EE72,FFFD,  ; Move enemy -3 pixels down and change direction on collision - facing left
                        0005,8956,
                        EE72,FFFD,  ; Move enemy -3 pixels down and change direction on collision - facing left
...
;;; $EE40: Instruction - move enemy [[Y]] pixels down and change direction on collision - facing right ;;;
{
$B2:EE40 DA          PHX
...
$B2:EE61 A0 36 ED    LDY #$ED36             ; Y = $ED36
...
;;; $EE72: Instruction - move enemy [[Y]] pixels down and change direction on collision - facing left ;;;
{
$B2:EE72 DA          PHX
...
$B2:EE93 A0 AC ED    LDY #$EDAC             ; Y = $EDAC
...
;;; $EEA4: Instruction - randomly choose a direction - facing right ;;;
{
$B2:EEA4 DA          PHX
$B2:EEA5 A0 36 ED    LDY #$ED36             ; Y = $ED36
...
$B2:EEB7 A0 EC EC    LDY #$ECEC             ; Y = $ECEC
...
;;; $EEBC: Instruction - randomly choose a direction - facing left ;;;
{
$B2:EEBC DA          PHX
$B2:EEBD A0 AC ED    LDY #$EDAC             ; Y = $EDAC
...
$B2:EECF A0 F6 ED    LDY #$EDF6             ; Y = $EDF6
...
$B2:F05D 22 C6 B0 A0 JSL $A0B0C6[$A0:B0C6]
$B2:F061 18          CLC
...
$B2:F073 22 B2 B0 A0 JSL $A0B0B2[$A0:B0B2]
...
$B2:F0BA 80 0B       BRA $0B    [$F0C7]

$B2:F0BC BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$B2:F0BF 29 F8 FF    AND #$FFF8
...
$B2:F0F1 22 C6 B0 A0 JSL $A0B0C6[$A0:B0C6]
$B2:F0F5 18          CLC
...
$B2:F107 22 B2 B0 A0 JSL $A0B0B2[$A0:B0B2]
...
$B2:F56C 85 16       STA $16    [$7E:0016]
$B2:F56E B9 04 00    LDA $0004,y[$B2:F36C]
$B2:F571 85 18       STA $18    [$7E:0018]
$B2:F573 BD 7A 0F    LDA $0F7A,x[$7E:0FBA]
$B2:F576 85 12       STA $12    [$7E:0012]
$B2:F578 BD 7E 0F    LDA $0F7E,x[$7E:0FBE]
$B2:F57B 85 14       STA $14    [$7E:0014]
$B2:F57D B9 00 00    LDA $0000,y[$B2:F368]
...
$B2:F597 38          SEC
$B2:F598 ED F6 0A    SBC $0AF6  [$7E:0AF6]
$B2:F59B 85 12       STA $12    [$7E:0012]
$B2:F59D A9 01 00    LDA #$0001
$B2:F5A0 9D 94 0F    STA $0F94,x[$7E:0FD4]
$B2:F5A3 A0 2E F2    LDY #$F22E
$B2:F5A6 A5 12       LDA $12    [$7E:0012]
$B2:F5A8 10 03       BPL $03    [$F5AD]
$B2:F5AA A0 20 F4    LDY #$F420
...
$B2:F5BA 38          SEC
$B2:F5BB ED F6 0A    SBC $0AF6  [$7E:0AF6]
$B2:F5BE 85 12       STA $12    [$7E:0012]
$B2:F5C0 A9 01 00    LDA #$0001
$B2:F5C3 9D 94 0F    STA $0F94,x
$B2:F5C6 A0 2E F3    LDY #$F32E
$B2:F5C9 A5 12       LDA $12    [$7E:0012]
$B2:F5CB 10 03       BPL $03    [$F5D0]
$B2:F5CD A0 1A F5    LDY #$F51A
...
$B2:F5E1 A0 DA F2    LDY #$F2DA
$B2:F5E4 BD B4 0F    LDA $0FB4,x[$7E:0FB4]
$B2:F5E7 89 01 00    BIT #$0001
$B2:F5EA F0 03       BEQ $03    [$F5EF]
$B2:F5EC A0 CC F4    LDY #$F4CC

$B2:F5EF 98          TYA
$B2:F5F0 9D 92 0F    STA $0F92,x[$7E:0F92]
$B2:F5F3 9D AC 0F    STA $0FAC,x[$7E:0FAC]
$B2:F5F6 BD B4 0F    LDA $0FB4,x[$7E:0FB4]
$B2:F5F9 89 01 00    BIT #$0001
$B2:F5FC F0 0F       BEQ $0F    [$F60D]
$B2:F5FE BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$B2:F601 9D B0 0F    STA $0FB0,x[$7E:0FB0]
$B2:F604 18          CLC
$B2:F605 7D B6 0F    ADC $0FB6,x[$7E:0FB6]
$B2:F608 9D B2 0F    STA $0FB2,x[$7E:0FB2]
$B2:F60B 80 0D       BRA $0D    [$F61A]

$B2:F60D BD 7A 0F    LDA $0F7A,x[$7E:0FBA]
$B2:F610 9D B2 0F    STA $0FB2,x[$7E:0FF2]
$B2:F613 38          SEC
$B2:F614 FD B6 0F    SBC $0FB6,x[$7E:0FF6]
$B2:F617 9D B0 0F    STA $0FB0,x[$7E:0FF0]

$B2:F61A BD B2 0F    LDA $0FB2,x[$7E:0FB2]
$B2:F61D 38          SEC
$B2:F61E FD B0 0F    SBC $0FB0,x[$7E:0FB0]
$B2:F621 4A          LSR A
$B2:F622 85 14       STA $14    [$7E:0014]
$B2:F624 18          CLC
$B2:F625 7D B0 0F    ADC $0FB0,x[$7E:0FB0]
$B2:F628 9D AE 0F    STA $0FAE,x[$7E:0FAE]
$B2:F62B BD AE 0F    LDA $0FAE,x[$7E:0FAE]
...
$B2:F695 9F E0 C3 7E STA $7EC3E0,x[$7E:C3E0]
$B2:F699 C8          INY
$B2:F69A C8          INY
$B2:F69B E8          INX
$B2:F69C E8          INX
...
$B2:F6A5 FC A8 0F    JSR ($0FA8,x)[$B2:804B]
$B2:F6A8 6B          RTL
}
...
$B2:F6C2 38          SEC
$B2:F6C3 ED F6 0A    SBC $0AF6  [$7E:0AF6]
$B2:F6C6 85 12       STA $12    [$7E:0012]
$B2:F6C8 A0 2E F2    LDY #$F22E
$B2:F6CB A5 12       LDA $12    [$7E:0012]
$B2:F6CD 10 03       BPL $03    [$F6D2]
$B2:F6CF A0 20 F4    LDY #$F420

$B2:F6D2 98          TYA
$B2:F6D3 9D 92 0F    STA $0F92,x[$7E:0F92]
$B2:F6D6 9D AC 0F    STA $0FAC,x[$7E:0FAC]
$B2:F6D9 A9 01 00    LDA #$0001
$B2:F6DC 9D 94 0F    STA $0F94,x[$7E:0F94]
$B2:F6DF 60          RTS

$B2:F6E0 20 2E F7    JSR $F72E  [$B2:F72E]
$B2:F6E3 60          RTS
...
$B2:FCC0 9D A8 0F    STA $0FA8,x[$7E:0FA8]
$B2:FCC3 FA          PLX
$B2:FCC4 7A          PLY
$B2:FCC5 C8          INY
$B2:FCC6 C8          INY
...
$B2:FD56 38          SEC
$B2:FD57 FD 7A 0F    SBC $0F7A,x[$7E:0FFA]
$B2:FD5A 30 03       BMI $03    [$FD5F]
$B2:FD5C A0 0E FC    LDY #$FC0E
...
$B2:FD7A 9F 00 78 7E STA $7E7800,x[$7E:7880]
$B2:FD7E 18          CLC
$B2:FD7F 69 EF FF    ADC #$FFEF
...
$B2:FDBC DD B0 0F    CMP $0FB0,x[$7E:1030]
$B2:FDBF 10 0C       BPL $0C    [$FDCD]

$B2:FDC1 A9 C6 FB    LDA #$FBC6
$B2:FDC4 9D 92 0F    STA $0F92,x[$7E:1092]
$B2:FDC7 A9 01 00    LDA #$0001
$B2:FDCA 9D 94 0F    STA $0F94,x[$7E:1094]
...
$B2:FDE0 38          SEC
$B2:FDE1 FD 7A 0F    SBC $0F7A,x[$7E:103A]
$B2:FDE4 30 03       BMI $03    [$FDE9]
$B2:FDE6 A0 0E FC    LDY #$FC0E

$B2:FDE9 98          TYA
$B2:FDEA 9D 92 0F    STA $0F92,x[$7E:1052]
$B2:FDED A9 01 00    LDA #$0001
$B2:FDF0 9D 94 0F    STA $0F94,x[$7E:1054]
$B2:FDF3 60          RTS
...
$B2:FE04 9F 00 78 7E STA $7E7800,x[$7E:7800]
$B2:FE08 18          CLC                    
$B2:FE09 69 10 00    ADC #$0010             
...
$B2:FE1F 9D 7A 0F    STA $0F7A,x[$7E:0F7A]  
$B2:FE22 28          PLP                    
...
$B2:FE38 DD B2 0F    CMP $0FB2,x[$7E:0FB2]
$B2:FE3B 30 0C       BMI $0C    [$FE49]

$B2:FE3D A9 48 FC    LDA #$FC48
$B2:FE40 9D 92 0F    STA $0F92,x[$7E:1052]
$B2:FE43 A9 01 00    LDA #$0001
$B2:FE46 9D 94 0F    STA $0F94,x[$7E:1054]
...
$B2:FE4F A0 08 00    LDY #$0008

$B2:FE52 B9 18 0C    LDA $0C18,y[$7E:0C20]
$B2:FE55 D0 06       BNE $06    [$FE5D]
$B2:FE57 88          DEY
$B2:FE58 88          DEY
$B2:FE59 10 F7       BPL $F7    [$FE52]
$B2:FE5B 80 48       BRA $48    [$FEA5]
...
$B2:FE86 38          SEC
$B2:FE87 ED F6 0A    SBC $0AF6  [$7E:0AF6]
$B2:FE8A 85 12       STA $12    [$7E:0012]
$B2:FE8C A0 4C FB    LDY #$FB4C             ; Y = $FB4C (flinch - facing left)
$B2:FE8F A5 12       LDA $12    [$7E:0012]
$B2:FE91 10 03       BPL $03    [$FE96]
$B2:FE93 A0 58 FB    LDY #$FB58             ; Y = $FB58 (flinch - facing right)

$B2:FE96 98          TYA
$B2:FE97 9D 92 0F    STA $0F92,x[$7E:0F92]
$B2:FE9A A9 01 00    LDA #$0001
$B2:FE9D 9D 94 0F    STA $0F94,x[$7E:0F94]
$B2:FEA0 FA          PLX

...
;;; $88FC: Door headers ;;;
{
; Room $94CC, door list index 2
; Room $962A, door list index 2
; Room $97B5, door list index 2
; Room $9938, door list index 2
; Room $9AD9, door list index 9
; Room $9E9F, door list index 3
; Room $A322, door list index 5
; Room $A66A, door list index 2
; Room $A6A1, door list index 3
; Room $A7DE, door list index 5
; Room $AF3F, door list index 2
; Room $B236, door list index 3
$83:88FC             dw 0000

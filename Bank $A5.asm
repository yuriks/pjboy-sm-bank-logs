...
$A5:8806 8D 92 0F    STA $0F92  [$7E:0F92]  ;} Draygon instruction list pointer = $97D1
$A5:8809 A9 01 00    LDA #$0001             ;\
$A5:880C 8D 94 0F    STA $0F94  [$7E:0F94]  ;} Draygon instruction timer = 1
$A5:880F A9 01 00    LDA #$0001             ;\
$A5:8812 8F 00 80 7E STA $7E8000[$7E:8000]  ;} 
$A5:8816 60          RTS
}
...
$A5:888C 4A          LSR A                  ;} $2E = (swoop Y position index) / 4 (swoop duration)
$A5:888D 4A          LSR A                  ;|
...
$A5:88AA 8E AA 0F    STX $0FAA  [$7E:0FAA]  ; $0FAA = (swoop Y position index)
$A5:88AD 8E AC 0F    STX $0FAC  [$7E:0FAC]  ; $0FAC = (swoop Y position index)
$A5:88B0 60          RTS
}
...
$A5:88FD 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8900 60          RTS
}
...
$A5:8904 29 0F 00    AND #$000F
$A5:8907 D0 18       BNE $18    [$8921]
$A5:8909 A9 FE 98    LDA #$98FE
$A5:890C 8D 92 0F    STA $0F92  [$7E:0F92]
$A5:890F AF 00 80 7E LDA $7E8000[$7E:8000]
$A5:8913 F0 06       BEQ $06    [$891B]
$A5:8915 A9 90 9C    LDA #$9C90
$A5:8918 8D 92 0F    STA $0F92  [$7E:0F92]

$A5:891B A9 01 00    LDA #$0001
$A5:891E 8D 94 0F    STA $0F94  [$7E:0F94]
...
$A5:894D 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8950 60          RTS
}
...
$A5:89BD 38          SEC
$A5:89BE ED F6 0A    SBC $0AF6  [$7E:0AF6]
...
$A5:89D8 8D AE 0F    STA $0FAE  [$7E:0FAE]
$A5:89DB A5 2A       LDA $2A    [$7E:002A]
$A5:89DD 8D B0 0F    STA $0FB0  [$7E:0FB0]
$A5:89E0 A9 00 8A    LDA #$8A00
$A5:89E3 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:89E6 A9 BB 97    LDA #$97BB
$A5:89E9 8D 92 0F    STA $0F92  [$7E:0F92]
$A5:89EC A9 01 00    LDA #$0001
$A5:89EF 8D 94 0F    STA $0F94  [$7E:0F94]
$A5:89F2 A9 00 00    LDA #$0000
$A5:89F5 8F 00 80 7E STA $7E8000[$7E:8000]
$A5:89F9 AD AC 0F    LDA $0FAC  [$7E:0FAC]
$A5:89FC 8D AA 0F    STA $0FAA  [$7E:0FAA]
$A5:89FF 60          RTS
}
...
$A5:8A4C 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8A4F 60          RTS
}
...
$A5:8ADF 29 01 00    AND #$0001             ;} If [random number] % 2 != 0: (swoop (else goop))
$A5:8AE2 F0 18       BEQ $18    [$8AFC]     ;/
$A5:8AE4 A9 F4 87    LDA #$87F4
$A5:8AE7 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8AEA 9C AA 0F    STZ $0FAA  [$7E:0FAA]
$A5:8AED AF 00 78 7E LDA $7E7800[$7E:7800]
$A5:8AF1 8D 7A 0F    STA $0F7A  [$7E:0F7A]
$A5:8AF4 AF 02 78 7E LDA $7E7802[$7E:7802]
$A5:8AF8 8D 7E 0F    STA $0F7E  [$7E:0F7E]
$A5:8AFB 60          RTS

$A5:8AFC A9 0A 8B    LDA #$8B0A
$A5:8AFF 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8B02 AF 00 78 7E LDA $7E7800[$7E:7800]
$A5:8B06 8D 7A 0F    STA $0F7A  [$7E:0F7A]
$A5:8B09 60          RTS
}
...
$A5:8B16 8D 7E 0F    STA $0F7E  [$7E:0F7E]
$A5:8B19 A9 00 00    LDA #$0000
$A5:8B1C 8D B0 0F    STA $0FB0  [$7E:0FB0]
$A5:8B1F A9 01 00    LDA #$0001
$A5:8B22 8D AE 0F    STA $0FAE  [$7E:0FAE]
$A5:8B25 A9 00 00    LDA #$0000
$A5:8B28 8F 1A 78 7E STA $7E781A[$7E:781A]
$A5:8B2C A9 06 9C    LDA #$9C06
$A5:8B2F 8D 52 10    STA $1052  [$7E:1052]
$A5:8B32 A9 01 00    LDA #$0001
$A5:8B35 8D 54 10    STA $1054  [$7E:1054]
$A5:8B38 A9 52 8B    LDA #$8B52
$A5:8B3B 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8B3E A9 D1 97    LDA #$97D1
$A5:8B41 8D 92 0F    STA $0F92  [$7E:0F92]
$A5:8B44 A9 01 00    LDA #$0001
$A5:8B47 8D 94 0F    STA $0F94  [$7E:0F94]
$A5:8B4A A9 01 00    LDA #$0001
$A5:8B4D 8F 00 80 7E STA $7E8000[$7E:8000]
$A5:8B51 60          RTS
}
...
$A5:8BA1 8D 7C 0F    STA $0F7C  [$7E:0F7C]
...
$A5:8C00 8D 7C 0F    STA $0F7C  [$7E:0F7C]
...
$A5:8C1C 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8C1F 60          RTS

$A5:8C20 A9 DA 9B    LDA #$9BDA
$A5:8C23 8D 52 10    STA $1052  [$7E:1052]
$A5:8C26 A9 01 00    LDA #$0001
$A5:8C29 8D 54 10    STA $1054  [$7E:1054]
$A5:8C2C A9 33 8C    LDA #$8C33
$A5:8C2F 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8C32 60          RTS
}
...
$A5:8C61 8D 7C 0F    STA $0F7C  [$7E:0F7C]
...
$A5:8C72 10 01       BPL $01    [$8C75]

$A5:8C74 60          RTS

$A5:8C75 A9 B3 89    LDA #$89B3
$A5:8C78 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8C7B A9 50 02    LDA #$0250
$A5:8C7E 8D 7A 0F    STA $0F7A  [$7E:0F7A]
$A5:8C81 A9 B0 FF    LDA #$FFB0
$A5:8C84 8D 7E 0F    STA $0F7E  [$7E:0F7E]
$A5:8C87 AD AC 0F    LDA $0FAC  [$7E:0FAC]
$A5:8C8A 8D AA 0F    STA $0FAA  [$7E:0FAA]
$A5:8C8D 60          RTS
}
...
$A5:8C98 8D 7E 0F    STA $0F7E  [$7E:0F7E]
$A5:8C9B A9 00 00    LDA #$0000
$A5:8C9E 8D B0 0F    STA $0FB0  [$7E:0FB0]
$A5:8CA1 A9 01 00    LDA #$0001
$A5:8CA4 8D AE 0F    STA $0FAE  [$7E:0FAE]
$A5:8CA7 A9 00 00    LDA #$0000
$A5:8CAA 8F 1A 78 7E STA $7E781A[$7E:781A]
$A5:8CAE A9 06 9C    LDA #$9C06
$A5:8CB1 8D 52 10    STA $1052  [$7E:1052]
$A5:8CB4 A9 01 00    LDA #$0001
$A5:8CB7 8D 54 10    STA $1054  [$7E:1054]
$A5:8CBA A9 D4 8C    LDA #$8CD4
$A5:8CBD 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8CC0 A9 BB 97    LDA #$97BB
$A5:8CC3 8D 92 0F    STA $0F92  [$7E:0F92]
$A5:8CC6 A9 01 00    LDA #$0001
$A5:8CC9 8D 94 0F    STA $0F94  [$7E:0F94]
$A5:8CCC A9 00 00    LDA #$0000
$A5:8CCF 8F 00 80 7E STA $7E8000[$7E:8000]
$A5:8CD3 60          RTS
}
...
$A5:8D23 8D 7C 0F    STA $0F7C  [$7E:0F7C]
...
$A5:8D7F 8D 7C 0F    STA $0F7C  [$7E:0F7C]
...
$A5:8D9B 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8D9E 60          RTS

$A5:8D9F A9 E7 97    LDA #$97E7
$A5:8DA2 8D 52 10    STA $1052  [$7E:1052]
$A5:8DA5 A9 01 00    LDA #$0001
$A5:8DA8 8D 54 10    STA $1054  [$7E:1054]
$A5:8DAB A9 B2 8D    LDA #$8DB2
$A5:8DAE 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8DB1 60          RTS
}
...
$A5:8DE5 8D 7C 0F    STA $0F7C  [$7E:0F7C]
...
$A5:8DF6 30 08       BMI $08    [$8E00]

$A5:8DF8 60          RTS

$A5:8DF9 A9 19 8E    LDA #$8E19
$A5:8DFC 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8DFF 60          RTS

$A5:8E00 A9 F4 87    LDA #$87F4
$A5:8E03 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8E06 A9 B0 FF    LDA #$FFB0
$A5:8E09 8D 7A 0F    STA $0F7A  [$7E:0F7A]
$A5:8E0C A9 B0 FF    LDA #$FFB0
$A5:8E0F 8D 7E 0F    STA $0F7E  [$7E:0F7E]
$A5:8E12 AD AC 0F    LDA $0FAC  [$7E:0FAC]
$A5:8E15 8D AA 0F    STA $0FAA  [$7E:0FAA]
$A5:8E18 60          RTS
}
...
$A5:8E24 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8E27 60          RTS

$A5:8E28 AD 86 0F    LDA $0F86  [$7E:0F86]
$A5:8E2B 09 00 04    ORA #$0400
$A5:8E2E 8D 86 0F    STA $0F86  [$7E:0F86]
$A5:8E31 A0 08 00    LDY #$0008
$A5:8E34 AF 00 80 7E LDA $7E8000[$7E:8000]
$A5:8E38 D0 03       BNE $03    [$8E3D]
$A5:8E3A A0 F8 FF    LDY #$FFF8

$A5:8E3D 98          TYA
$A5:8E3E 18          CLC
$A5:8E3F 6D 7A 0F    ADC $0F7A  [$7E:0F7A]
$A5:8E42 38          SEC
$A5:8E43 ED F6 0A    SBC $0AF6  [$7E:0AF6]
...
$A5:8EE5 8F 0E 78 7E STA $7E780E[$7E:780E]
$A5:8EE9 A9 00 00    LDA #$0000
$A5:8EEC 8F 0A 78 7E STA $7E780A[$7E:780A]
$A5:8EF0 8F 12 78 7E STA $7E7812[$7E:7812]
$A5:8EF4 A9 C0 00    LDA #$00C0
$A5:8EF7 8F 10 78 7E STA $7E7810[$7E:7810]
$A5:8EFB A9 00 08    LDA #$0800
$A5:8EFE 8F 16 78 7E STA $7E7816[$7E:7816]
$A5:8F02 A9 1E 8F    LDA #$8F1E
$A5:8F05 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8F08 60          RTS

$A5:8F09 A9 10 8F    LDA #$8F10
$A5:8F0C 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8F0F 60          RTS
}
...
$A5:8F19 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:8F1C 60          RTS
}
...
$A5:901C 22 B2 B0 A0 JSL $A0B0B2[$A0:B0B2]
$A5:9020 18          CLC
...
$A5:9031 AF 10 78 7E LDA $7E7810[$7E:7810]
...
$A5:90B5 8F 14 78 7E STA $7E7814[$7E:7814]
...
$A5:90C7 30 04       BMI $04    [$90CD]
$A5:90C9 20 A9 94    JSR $94A9  [$A5:94A9]
$A5:90CC 60          RTS

$A5:90CD A9 05 91    LDA #$9105
$A5:90D0 8D A8 0F    STA $0FA8  [$7E:0FA8]
$A5:90D3 60          RTS
}
...
$A5:933B 64 18       STZ $18    [$7E:0018]  ;} Create sprite object 18h (breath bubbles?) at position (10h, 180h) with palette 7
...
$A5:9385 A0 FE 98    LDY #$98FE             ; Y = $98FE
...
$A5:93A1 A0 FC 99    LDY #$99FC             ; Y = $99FC
...
$A5:93BD A0 25 98    LDY #$9825             ; Y = $9825
...
$A5:93F2 8F 00 80 7E STA $7E8000[$7E:8000]  ;} $7E:8000 = 0
...
$A5:940E 8F 00 80 7E STA $7E8000[$7E:8000]  ;} $7E:8000 = 1

; BRANCH_SET_NEXT_INSTRUCTION
$A5:9412 8C 92 0F    STY $0F92  [$7E:0F92]  ; Draygon instruction list pointer = [Y]
$A5:9415 A9 01 00    LDA #$0001             ;\
$A5:9418 8D 94 0F    STA $0F94  [$7E:0F94]  ;} Draygon instruction timer = 1
...
$A5:9451 8F 00 80 7E STA $7E8000[$7E:8000]  ;} $7E:8000 = 0
...
$A5:9476 8F 00 80 7E STA $7E8000[$7E:8000]  ;} $7E:8000 = 1

; BRANCH_SET_NEXT_INSTRUCTION
$A5:947A 8C 92 0F    STY $0F92  [$7E:0F92]  ; Draygon instruction list pointer = [Y]
$A5:947D A9 01 00    LDA #$0001             ;\
$A5:9480 8D 94 0F    STA $0F94  [$7E:0F94]  ;} Draygon instruction timer = 1
...
;;; $950D:  ;;;
{
$A5:950D             dw 97E7, 9813, 9805, 9BDA, 9C06, 9BF8, 0000,
                        9889, 9867, 987B, 98FE, 9C7E, 9C5A, 9C70, 9C90, 0000,
                        9944, 99AE, 99B4, 99BA, 99C0, 9CD6, 9D50, 9D56, 9D5C, 9D62, 0000,
                        99C6, 99FC, 9D68, 9D9E, 0000
}
...
{
$A5:95EA 22 97 A4 A0 JSL $A0A497[$A0:A497]
$A5:95EE 80 1D       BRA $1D    [$960D]
}
...
;;; $A13E: Handle Draygon fight intro movement ;;;
{
$A5:A13E 5A          PHY
...
$A5:C4C5 AD 7E 0F    LDA $0F7E  [$7E:0F7E]
$A5:C4C8 38          SEC
...
$A5:C4DD F0 33       BEQ $33    [$C512]
$A5:C4DF A0 BA 99    LDY #$99BA
$A5:C4E2 C9 20 00    CMP #$0020
$A5:C4E5 30 1B       BMI $1B    [$C502]
$A5:C4E7 A0 B4 99    LDY #$99B4
$A5:C4EA C9 60 00    CMP #$0060
$A5:C4ED 30 13       BMI $13    [$C502]
$A5:C4EF A0 C0 99    LDY #$99C0
$A5:C4F2 C9 A0 00    CMP #$00A0
$A5:C4F5 30 0B       BMI $0B    [$C502]
$A5:C4F7 A0 AE 99    LDY #$99AE
$A5:C4FA C9 E0 00    CMP #$00E0
$A5:C4FD 30 03       BMI $03    [$C502]
$A5:C4FF A0 BA 99    LDY #$99BA

$A5:C502 9D B2 0F    STA $0FB2,x[$7E:0FF2]
$A5:C505 98          TYA
$A5:C506 9D 92 0F    STA $0F92,x[$7E:0FD2]
$A5:C509 A9 01 00    LDA #$0001
$A5:C50C 9D 94 0F    STA $0F94,x[$7E:0FD4]
$A5:C50F 9E 90 0F    STZ $0F90,x[$7E:0FD0]
...
$A5:C54B AD 7E 0F    LDA $0F7E  [$7E:0F7E]
$A5:C54E 38          SEC
...
$A5:C563 F0 33       BEQ $33    [$C598]
$A5:C565 A0 5C 9D    LDY #$9D5C
$A5:C568 C9 20 00    CMP #$0020
$A5:C56B 30 1B       BMI $1B    [$C588]
$A5:C56D A0 50 9D    LDY #$9D50
$A5:C570 C9 60 00    CMP #$0060
$A5:C573 30 13       BMI $13    [$C588]
$A5:C575 A0 62 9D    LDY #$9D62
$A5:C578 C9 A0 00    CMP #$00A0
$A5:C57B 30 0B       BMI $0B    [$C588]
$A5:C57D A0 56 9D    LDY #$9D56
$A5:C580 C9 E0 00    CMP #$00E0
$A5:C583 30 03       BMI $03    [$C588]
$A5:C585 A0 5C 9D    LDY #$9D5C

$A5:C588 9D B2 0F    STA $0FB2,x[$7E:0FF2]
$A5:C58B 98          TYA
$A5:C58C 9D 92 0F    STA $0F92,x[$7E:0FD2]
$A5:C58F A9 01 00    LDA #$0001
$A5:C592 9D 94 0F    STA $0F94,x[$7E:0FD4]
$A5:C595 9E 90 0F    STZ $0F90,x[$7E:0FD0]
...
$A5:CE07             db 03,00, 03,00, 03,00, 02,FF, 03,00, 03,FF, 03,00, 02,FF,
                        ...
                        01,FF, 02,FE, 01,FF, 02,FE, 01,FF, 01,FE, 02,FF, 01,FE,
                        ...
                        01,02, 00,02, 02,02, 01,01, 01,02, 01,02, 02,02

; Unused?
$A5:DF45             db 02,01, 01,02, 02,02, 02,01, 01,02, 02,02, 02,01, 02,02,
                        02,01, 02,02, 02,02, 02,01, 02,02, 01,02, 02,01, 02,02,
                        02,02, 01,01, 02,02, 01,02, 02,02, 01,02, 02,01, 01,02,
                        02,02, 01,02, 02,01, 01,02, 02,02, 01,01, 02,01, 02,02,
                        02,01, 01,01, 02,01, 02,01, 02,01, 03,01, 02,00, 02,01,
                        00,FF, 00,FE, 00,FF, 01,FF, 00,FF, 00,FE, 00,FF, 00,FF,
                        01,FE, 00,FF, 00,FF, 00,FE, 00,FF, 01,FF, 00,FE, 00,FF,
                        00,FF, 01,FE, 00,FF, 00,FE, 01,FF, 00,FF, 00,FE, 01,FF,
                        00,FE, 00,FF, 01,FE, 00,FF, 01,FE, 00,FF, 01,FE, 00,FF,
                        01,FE, 01,FE, 00,FF, 01,FE, 00,FF, 01,FE, 01,FE, 01,FE,
                        01,FF, 00,FE, 01,FE, 01,FE, 01,FF, 01,FE, 01,FE, 01,FE,
                        01,FE, 01,FE, 01,FE, 01,FF, 02,FE, 01,FF, 01,FF, 01,FF,
                        01,FF, 01,00, 01,00, 01,01, 01,01, 00,01, 01,02, 00,01,
                        00,02, 01,02, 00,02, 00,02, 00,02, 00,02, 00,01, 00,02,
                        00,02, 00,01, 00,02, FF,02, 00,01, 00,02, 00,01, FF,02,
                        00,01, 00,02, 00,01, FF,01, 00,02, 00,01, FF,02, 00,01,
                        00,01, FF,02, 00,01, 00,02, 00,01, 00,02, 00,01, 00,02,
                        00,01, 00,02, 00,02, 00,01, 00,02, 00,02, 01,02, 00,02,
                        01,02, 00,01, 01,02, 00,02, 01,02, 01,01, 00,02, 01,01,
                        01,02, 01,01, 00,01, 01,01, 01,01, 01,00, 01,01, 01,00,
                        01,00, 01,00, 01,FF, 01,FF, 01,00, 01,FF, 01,FE, 00,FF,
                        01,FF, 01,FE, 01,FF, 01,FE, 00,FE, 01,FE, 01,FE, 01,FE,
                        00,FE, 01,FD, 00,FE, 01,FE, 01,FD, 00,FE, 01,FD, 00,FE,
                        00,FE, 01,FD, 00,FE, 01,FD, 00,FE, 00,FD, 01,FE, 00,FE,
                        00,FD, 00,FE, 01,FE, 00,FE, 00,FE, 00,FE, 01,FE, 00,FE,
                        00,FF, 00,FE, 00,FF, 01,FF, 00,FF, 00,FF, 00,FF, 01,FF,
                        00,FF, 01,00, 00,01, 01,00, 00,01, 00,01, 01,01, 00,01,
                        01,02, 00,01, 01,02, 00,01, 00,02, 01,02, 00,02, 00,01,
                        01,02, 00,02, 00,01, 01,02, 00,02, 00,01, 00,02, 00,01,
                        00,02, 01,01, 00,02, 00,01, 00,02, 00,01, 00,02, 00,01,
                        01,02, 00,01, 00,02, 00,01, 00,02, 01,01, 00,02, 00,01,
                        01,02, 00,01, 00,02, 01,01, 00,02, 01,01, 00,02, 01,01,
                        01,02, 00,01, 01,01, 01,02, 01,01, 01,01, 01,01, 01,01,
                        01,01, 02,01, 01,01, 01,01, 01,01, 02,00, 01,01, 02,01,
                        01,01, 02,00, 02,00, 02,00, 01,00, 02,00, 02,00, 01,00,
                        02,00, 02,00, 02,00, 01,00, 02,00, 01,00, 02,00, 02,00,
                        01,FF, 02,00, 01,00, 02,FF, 01,00, 02,FF, 01,00, 01,FF,
                        02,FF, 01,FF, 01,FF, 01,FF, 01,FF, 01,FF, 02,FF, 01,FF,
                        01,FF, 01,FF, 01,FE, 01,FF, 01,FF, 00,FE, 01,FF, 01,FE,
                        01,FF, 01,FE, 01,FF, 01,FE, 01,FF, 01,FE, 00,FF, 01,FE,
                        01,FF, 01,FE, 01,FF, 01,FE, 01,FF, 01,FE, 00,FF, 01,FE,
                        01,FF, 01,FE, 01,FF, 00,FE, 01,FF, 01,FE, 00,FF, 01,FE,
                        00,FF, 01,FE, 00,FF, 00,FE, 01,FF, 00,FE, 00,FE, 00,FF,
                        00,FE, 00,FF, 00,FE, FF,FE, 00,FF, 00,FE, FF,FE, 00,FE,
                        FF,FF, FF,FE, FF,FE, FF,FF, FF,FE, FF,FE, FF,FF, FF,FE,
                        FF,FF, FF,FF, FF,FE, FE,FF, FF,FF, FF,FF, FE,FF, FF,00,
                        FF,FF, FE,FF, FF,00, FF,00, FE,00, FF,00, FF,01, FF,00,
                        FE,01, FF,00, FF,01, FF,01, FF,01, FE,01, FF,02, FF,01,
                        FF,02, FF,01, FF,02, FF,01, FF,02, 00,02, FF,01, FF,02,
                        FF,02, 00,02, FF,02, FF,02, 00,01, FF,02, 00,02, 00,02,
                        FF,01, 00,02, 00,02, 00,01, 00,02, 00,02, 00,01, 00,02,
                        00,01, 00,02, 00,02, 00,01, 00,02, 01,01, 00,02, 00,01,
                        01,02, 00,02, 01,01, 00,02, 01,01, 00,02, 01,01, 00,02,
                        01,01, 00,02, 01,01, 01,02, 00,02, 01,01, 01,02, 01,01,
                        00,02, 01,01, 01,02, 01,01, 01,02, 01,01, 01,01, 01,02,
                        01,01, 01,01, 01,01, 01,01, 01,01, 01,01, 02,01, 01,01,
                        01,01, 01,01, 02,00, 01,01, 02,01, 01,00, 02,01, 01,00,
                        02,00, 01,01, 02,00, 01,00, 02,00, 02,00, 01,00, 02,00,
                        02,00, 02,00, 01,00, 02,00, 02,00, 01,00, 02,00, 02,00,
                        01,FF, 02,00, 02,00, 02,00, 01,00, 02,00, 02,FF, 01,00,
                        02,00, 01,00, 02,00, 02,FF, 01,00, 02,00, 02,00, 01,00,
                        02,00, 01,FF, 02,00, 01,00, 02,00, 02,00, 01,00, 02,00,
                        01,FF, 02,00, 02,00, 01,00, 02,00, 01,00, 02,00, 02,00,
                        01,00, 02,00, 01,00, 02,00, 02,00, 01,00, 02,00, 01,00,
                        02,00, 02,00, 01,00, 02,00, 02,00, 01,00, 02,00, 01,00,
                        02,00, 02,00
}
}

...
;;; $8090: Layer blending configuration 4 - Phantoon intro ;;;
{
; Used by Phantoon
...
$88:8353 9C 88 19    STZ $1988  [$7E:1988]  ; $1988 = 0
...
$88:B0C5 09 0C 00    ORA #$000C             ;} Layer blending configuration = Ch
...
$88:B188 C9 04 00    CMP #$0004             ;} If [$059A] < 4: go to BRANCH_B1D3
...
$88:B1D6 0A          ASL A                  ;} X = [$05A4] * 2
$88:B1D7 AA          TAX                    ;/
$88:B1D8 AD A8 05    LDA $05A8  [$7E:05A8]  ;\
$88:B1DB 0A          ASL A                  ;} Y = [$05A8] * 2
$88:B1DC A8          TAY                    ;/
...
$88:B1E7 38          SEC                    ;|
$88:B1E8 ED A4 05    SBC $05A4  [$7E:05A4]  ;} $7E:9C00 + [X] = [$05A6] - [$05A4]
$88:B1EB 9F 00 9C 7E STA $7E9C00,x          ;/
$88:B1EF DA          PHX                    ;\
$88:B1F0 BB          TYX                    ;|
$88:B1F1 AD AA 05    LDA $05AA  [$7E:05AA]  ;|
$88:B1F4 38          SEC                    ;} $7E:9C00 + [Y] = [$05AA] - [$05A8]
...
$88:B20D EE A4 05    INC $05A4  [$7E:05A4]  ; Increment $05A4
$88:B210 CE A8 05    DEC $05A8  [$7E:05A8]  ; Decrement $05A8
$88:B213 88          DEY                    ;\
$88:B214 88          DEY                    ;} Y -= 2
$88:B215 E8          INX                    ;\
$88:B216 E8          INX                    ;} X += 2
...
$88:B417 29 FF 00    AND #$00FF             ;} A = FFh - ([lava/acid Y position] - [layer 1 Y position]) % 100h
...
$88:B482 0A          ASL A                  ;} HDMA object table pointer = $B62A + (1FFh - [A]) * 3
$88:B483 18          CLC                    ;|
...
$88:C460 8D 6C 19    STA $196C  [$7E:196C]  ;} FX rising function = $C428
...
$88:C4F6 80 03       BRA $03    [$C4FB]     ;|
                                            ;} $14 = [layer 1 X position] + ±[FX $192C]
$88:C4F8 29 FF 00    AND #$00FF             ;|
                                            ;|
$88:C4FB 18          CLC                    ;|
$88:C4FC 6D 11 09    ADC $0911  [$7E:0911]  ;|
$88:C4FF 85 14       STA $14    [$7E:0014]  ;/
$88:C501 DE 20 19    DEC $1920,x[$7E:1920]  ; Decrement FX $1920
$88:C504 D0 11       BNE $11    [$C517]     ; If [FX $1920] = 0:
$88:C506 A9 0A 00    LDA #$000A             ;\
$88:C509 9D 20 19    STA $1920,x[$7E:1920]  ;} FX $1920 = Ah
$88:C50C BD 14 19    LDA $1914,x[$7E:1914]  ;\
$88:C50F 1A          INC A                  ;|
$88:C510 1A          INC A                  ;} FX $1914 = ([FX $1914] + 2) % 20h
$88:C511 29 1E 00    AND #$001E             ;|
$88:C514 9D 14 19    STA $1914,x[$7E:1914]  ;/

$88:C517 BD 14 19    LDA $1914,x[$7E:1914]  ;\
$88:C51A AA          TAX                    ;} X = [FX $1914]
$88:C51B A0 1E       LDY #$1E               ; Y = 1Eh

; LOOP
$88:C51D A5 14       LDA $14    [$7E:0014]  ;\
$88:C51F 18          CLC                    ;|
$88:C520 79 6E C4    ADC $C46E,y[$88:C48C]  ;} $7E:9C04 + [X] = [$14] + [$C46E + [Y]]
$88:C523 9F 04 9C 7E STA $7E9C04,x[$7E:9C06];/
$88:C527 CA          DEX                    ;\
$88:C528 CA          DEX                    ;|
$88:C529 8A          TXA                    ;} X = ([X] - 2) % 20h
...
$88:C540 18          CLC                    ;|
$88:C541 69 40 00    ADC #$0040             ;} FX $192C += 40h
...
$88:C553 18          CLC                    ;} A = [FX Y position] - [layer 1 Y position] + 100h
$88:C554 69 00 01    ADC #$0100             ;/
$88:C557 10 08       BPL $08    [$C561]     ; If [A] < 0:
$88:C559 29 0F 00    AND #$000F             ;\
$88:C55C 09 00 01    ORA #$0100             ;} A = [A] & Fh | 100h
$88:C55F 80 08       BRA $08    [$C569]     ; Go to BRANCH_MERGE_2

$88:C561 C9 00 02    CMP #$0200             ;\
$88:C564 90 03       BCC $03    [$C569]     ;} If [A] < 200h: go to BRANCH_MERGE_2
...
$88:C574 0A          ASL A                  ;} HDMA object table pointer = $C645 + (1FFh - [A]) * 3
$88:C575 18          CLC                    ;|
...
$88:C58C 8F 44 9C 7E STA $7E9C44[$7E:9C44]
$88:C590 AD 78 0A    LDA $0A78  [$7E:0A78]
$88:C593 D0 0B       BNE $0B    [$C5A0]
$88:C595 AD 7E 19    LDA $197E  [$7E:197E]
$88:C598 29 02 00    AND #$0002
$88:C59B D0 08       BNE $08    [$C5A5]
$88:C59D 9E B4 18    STZ $18B4,x

$88:C5A0 20 36 C6    JSR $C636  [$88:C636]
$88:C5A3 80 03       BRA $03    [$C5A8]

$88:C5A5 20 E4 C5    JSR $C5E4  [$88:C5E4]

$88:C5A8 BD C0 18    LDA $18C0,x[$7E:18C2]
$88:C5AB 29 FF 00    AND #$00FF
$88:C5AE A8          TAY
$88:C5AF AD 5E 19    LDA $195E  [$7E:195E]
$88:C5B2 30 17       BMI $17    [$C5CB]
$88:C5B4 38          SEC
$88:C5B5 ED 15 09    SBC $0915  [$7E:0915]
$88:C5B8 18          CLC
$88:C5B9 69 00 01    ADC #$0100
$88:C5BC 10 08       BPL $08    [$C5C6]
$88:C5BE 29 0F 00    AND #$000F
$88:C5C1 09 00 01    ORA #$0100
$88:C5C4 80 08       BRA $08    [$C5CE]

$88:C5C6 C9 00 02    CMP #$0200
$88:C5C9 90 03       BCC $03    [$C5CE]

$88:C5CB A9 FF 01    LDA #$01FF
...
$88:C5EC 9D 20 19    STA $1920,x[$7E:1922]
...
$88:C60A 68          PLA
$88:C60B 18          CLC
$88:C60C 69 1E 00    ADC #$001E
$88:C60F 29 1E 00    AND #$001E
$88:C612 AA          TAX
$88:C613 A9 0F 00    LDA #$000F
$88:C616 85 12       STA $12    [$7E:0012]

$88:C618 A5 B5       LDA $B5    [$7E:00B5]
$88:C61A 18          CLC
$88:C61B 79 6E C4    ADC $C46E,y[$88:C470]
...
$88:C62F A8          TAY
$88:C630 C6 12       DEC $12    [$7E:0012]
$88:C632 10 E4       BPL $E4    [$C618]
$88:C634 FA          PLX
$88:C635 60          RTS
}
...
$88:C63B 9F 48 9C 7E STA $7E9C48,x[$7E:9C66]
$88:C63F CA          DEX
$88:C640 CA          DEX
...
$88:D96C             dx 8655,88,    ; HDMA table bank = $88
                        866A,7E,    ; Indirect HDMA data bank = $7E
                        D981,       ; HDMA object $1938 = randomly ±400h/±600h
...
;;; $D981: Instruction - HDMA object $1938 = randomly ±400h/±600h ;;;
{
$88:D981 DA          PHX
...
$88:D9AF F0 02       BEQ $02    [$D9B3]     ;} If time is frozen: return
$88:D9B1 AB          PLB
$88:D9B2 6B          RTL
...
$88:D9C2 09 00 FF    ORA #$FF00             ;} BG3 Y position = [HDMA object $1944] - [layer 1 Y position] + [HDMA object $1915]
...
$88:D9D4 18          CLC                    ;|
$88:D9D5 69 00 FA    ADC #$FA00             ;} HDMA object $1915 += FAh
$88:D9D8 9D 14 19    STA $1914,x[$7E:1916]  ;/
$88:D9DB AD 15 09    LDA $0915  [$7E:0915]  ;\
$88:D9DE 9D 44 19    STA $1944,x[$7E:1946]  ;} HDMA object $1944 = [layer 1 Y position]
...
$88:D9F0 09 00 FF    ORA #$FF00             ;} BG3 X position = [HDMA object $1950] - [layer 1 X position] + [HDMA object $1921]
...
$88:DA02 18          CLC                    ;|
$88:DA03 7D 38 19    ADC $1938,x[$7E:193A]  ;} HDMA object $1920 += [HDMA object $1938]
$88:DA06 9D 20 19    STA $1920,x[$7E:1922]  ;/
$88:DA09 AD 11 09    LDA $0911  [$7E:0911]  ;\
$88:DA0C 9D 50 19    STA $1950,x[$7E:1952]  ;} HDMA object $1950 = [layer 1 X position]
$88:DA0F AB          PLB
$88:DA10 6B          RTL
}
}
...
$88:DA4A 84 5B       STY $5B    [$7E:005B]
$88:DA4C AD 84 19    LDA $1984  [$7E:1984]
$88:DA4F 8D 86 19    STA $1986  [$7E:1986]
$88:DA52 AD 78 0A    LDA $0A78  [$7E:0A78]
$88:DA55 F0 02       BEQ $02    [$DA59]
$88:DA57 AB          PLB
$88:DA58 6B          RTL
...
$88:DAB8 AA          TAX
$88:DAB9 A0 1E       LDY #$1E

$88:DABB A5 12       LDA $12    [$7E:0012]
$88:DABD 18          CLC
$88:DABE 6D F6 0A    ADC $0AF6  [$7E:0AF6]
...
$88:DACF 88          DEY
$88:DAD0 88          DEY
$88:DAD1 10 E8       BPL $E8    [$DABB]
$88:DAD3 AE B2 18    LDX $18B2  [$7E:18B2]
$88:DAD6 A9 F0 FF    LDA #$FFF0
$88:DAD9 14 14       TRB $14    [$7E:0014]
$88:DADB A5 14       LDA $14    [$7E:0014]
$88:DADD 0A          ASL A
$88:DADE 18          CLC
$88:DADF 65 14       ADC $14    [$7E:0014]
...
$88:DB97             dx 06, 0C, B777        ;} Spawn PLM $B777 (clear access to Tourian elevator)
...
$88:DBCE 18          CLC
$88:DBCF 6D 15 09    ADC $0915  [$7E:0915]
...
$88:DC5C 9D E4 18    STA $18E4,x[$7E:18E6]
$88:DC5F FE CC 18    INC $18CC,x[$7E:18CE]
$88:DC62 FE CC 18    INC $18CC,x[$7E:18CE]

$88:DC65 20 CB DB    JSR $DBCB  [$88:DBCB]
$88:DC68 6B          RTL
}
...
$88:DCC3 8F 20 CD 7E STA $7ECD20[$7E:CD20]
$88:DCC7 20 CB DB    JSR $DBCB  [$88:DBCB]
$88:DCCA 6B          RTL
}
...
$88:DDEE 84 75       STY $75    [$7E:0075]
$88:DDF0 A0 80       LDY #$80
$88:DDF2 84 76       STY $76    [$7E:0076]
$88:DDF4 A9 2C 00    LDA #$002C
$88:DDF7 8D 86 19    STA $1986  [$7E:1986]
$88:DDFA E2 20       SEP #$20
$88:DDFC DA          PHX
$88:DDFD BD 20 19    LDA $1920,x
$88:DE00 09 0F       ORA #$0F
$88:DE02 A2 0F       LDX #$0F

$88:DE04 9F 00 9D 7E STA $7E9D00,x
$88:DE08 3A          DEC A
$88:DE09 CA          DEX
$88:DE0A 10 F8       BPL $F8    [$DE04]
$88:DE0C FA          PLX
...
{
$88:DE10 A9 80 00    LDA #$0080             ; A = 20h (blue intensity)
$88:DE13 80 03       BRA $03    [$DE18]
}
...
{
$88:DE18 9D 20 19    STA $1920,x[$7E:1920]  ; HDMA object $1920 = [A]
$88:DE1B 9E 14 19    STZ $1914,x[$7E:1914]  ; HDMA object $1914 = 0
$88:DE1E AD 9C 09    LDA $099C  [$7E:099C]  ;\
$88:DE21 C9 37 E7    CMP #$E737             ;} If [door transition function] != $E737 (last step: fading in):
...
$88:DE42 C9 10 00    CMP #$0010             ;} If [HDMA object $1914] = 10h: go to BRANCH_DE6D
$88:DE45 F0 26       BEQ $26    [$DE6D]     ;/
$88:DE47 DA          PHX
$88:DE48 08          PHP
$88:DE49 E2 20       SEP #$20
$88:DE4B BD 20 19    LDA $1920,x[$7E:1920]  ;\
$88:DE4E 85 14       STA $14    [$7E:0014]  ;} $14 = [HDMA object $1920]
$88:DE50 BD 14 19    LDA $1914,x[$7E:1914]  ; A = [HDMA object $1914]
...
$88:DE67 28          PLP
$88:DE68 FA          PLX
$88:DE69 FE 14 19    INC $1914,x[$7E:1914]  ; Increment HDMA object $1914
$88:DE6C 6B          RTL
...
$88:DE9C 84 75       STY $75    [$7E:0075]
$88:DE9E A0 80       LDY #$80
$88:DEA0 84 76       STY $76    [$7E:0076]
$88:DEA2 A9 2C 00    LDA #$002C
$88:DEA5 8D 86 19    STA $1986  [$7E:1986]
$88:DEA8 BD 14 19    LDA $1914,x[$7E:1914]
$88:DEAB F0 25       BEQ $25    [$DED2]
$88:DEAD DA          PHX
$88:DEAE 08          PHP
$88:DEAF E2 20       SEP #$20
$88:DEB1 BD 20 19    LDA $1920,x[$7E:1920]
$88:DEB4 85 14       STA $14    [$7E:0014]
$88:DEB6 BD 14 19    LDA $1914,x[$7E:1914]
$88:DEB9 A2 0F       LDX #$0F

$88:DEBB 85 12       STA $12    [$7E:0012]
$88:DEBD 05 14       ORA $14    [$7E:0014]
$88:DEBF 9F 00 9D 7E STA $7E9D00,x[$7E:9D0F]
$88:DEC3 A5 12       LDA $12    [$7E:0012]
$88:DEC5 3A          DEC A
$88:DEC6 10 02       BPL $02    [$DECA]
$88:DEC8 A9 00       LDA #$00

$88:DECA CA          DEX
$88:DECB 10 EE       BPL $EE    [$DEBB]
$88:DECD 28          PLP
$88:DECE FA          PLX
$88:DECF DE 14 19    DEC $1914,x[$7E:1914]
...
;;; $DF4F: Instruction list -  ;;;
{
$88:DF4F             dx 8655,88,    ; HDMA table bank = $88
                        866A,88,    ; Indirect HDMA data bank = $88
                        85B4,88DF91,; Call external function $88:DF91
...
;;; $DF77: Instruction list -  ;;;
{
$88:DF77             dx 8655,88,    ; HDMA table bank = $88
                        866A,88,    ; Indirect HDMA data bank = $88
                        85B4,88DF92,; Call external function $88:DF92
                        8570,88DF93 ; Pre-instruction = $88:DF93
$88:DF87             dx 0001,E01F,
                        85EC,DF87   ; Go to $DF87
}


;;; $DF8F: Instruction list -  ;;;
{
; Probably just a dead instruction from the above list
$88:DF8F             dx 8682        ; Sleep
}
...
$88:DFCA 30 07       BMI $07    [$DFD3]
$88:DFCC C9 C0 00    CMP #$00C0
$88:DFCF 30 29       BMI $29    [$DFFA]
$88:DFD1 80 1A       BRA $1A    [$DFED]

$88:DFD3 A9 01 00    LDA #$0001
$88:DFD6 9D E4 18    STA $18E4,x[$7E:18E6]
$88:DFD9 A9 6B DF    LDA #$DF6B
$88:DFDC 9D CC 18    STA $18CC,x[$7E:18CE]
$88:DFDF 6B          RTL

$88:DFE0 A9 01 00    LDA #$0001
$88:DFE3 9D E4 18    STA $18E4,x[$7E:18E6]
$88:DFE6 A9 71 DF    LDA #$DF71
$88:DFE9 9D CC 18    STA $18CC,x[$7E:18CE]
$88:DFEC 6B          RTL

$88:DFED A9 01 00    LDA #$0001
$88:DFF0 9D E4 18    STA $18E4,x[$7E:18E6]
$88:DFF3 A9 65 DF    LDA #$DF65
$88:DFF6 9D CC 18    STA $18CC,x[$7E:18CE]
$88:DFF9 6B          RTL

$88:DFFA A9 01 00    LDA #$0001
$88:DFFD 9D E4 18    STA $18E4,x[$7E:18E6]
$88:E000 A9 5F DF    LDA #$DF5F
$88:E003 9D CC 18    STA $18CC,x[$7E:18CE]
$88:E006 6B          RTL
}
...
$88:E038 85 74       STA $74    [$7E:0074]  ;} Colour math subscreen backdrop colour 0 = [$0DF0]
$88:E03A AD F1 0D    LDA $0DF1  [$7E:0DF1]  ;\
$88:E03D 85 75       STA $75    [$7E:0075]  ;} Colour math subscreen backdrop colour 1 = [$0DF1]
$88:E03F AD F2 0D    LDA $0DF2  [$7E:0DF2]  ;\
$88:E042 85 76       STA $76    [$7E:0076]  ;} Colour math subscreen backdrop colour 2 = [$0DF2]
$88:E044 C2 20       REP #$20
$88:E046 A9 12 00    LDA #$0012             ;\
$88:E049 8D 86 19    STA $1986  [$7E:1986]  ;} Layer blending configuration = 12h
...
$88:E06E 85 74       STA $74    [$7E:0074]  ;} Colour math subscreen backdrop colour 0 = [$0DF0]
$88:E070 AD F1 0D    LDA $0DF1  [$7E:0DF1]  ;\
$88:E073 85 75       STA $75    [$7E:0075]  ;} Colour math subscreen backdrop colour 1 = [$0DF1]
$88:E075 AD F2 0D    LDA $0DF2  [$7E:0DF2]  ;\
$88:E078 85 76       STA $76    [$7E:0076]  ;} Colour math subscreen backdrop colour 2 = [$0DF2]
$88:E07A C2 20       REP #$20               
$88:E07C A9 12 00    LDA #$0012             ;\
$88:E07F 8D 86 19    STA $1986  [$7E:1986]  ;} Layer blending configuration = 12h
...
$88:E095 18          CLC                    ;|
$88:E096 69 08 00    ADC #$0008             ;} $0DEE += 8
$88:E099 8D EE 0D    STA $0DEE  [$7E:0DEE]  ;/
$88:E09C A8          TAY                    ; Y = [$0DEE]
...
$88:E1A6 C9 00 FF    CMP #$FF00             ;} If [suit pickup light beam left/right positions] = 00,FFh:
...
$88:E1BD 89 00 FF    BIT #$FF00             ;} If [$0DF3] = 0:
...
$88:E27B 9C 8B 0A    STZ $0A8B  [$7E:0A8B]  ;} $0A88..91 = 01,$9800, 00,00...
...
$88:E28A 8F 00 98 7E STA $7E9800[$7E:9800]  ;} $7E:9800 = FFh,00
$88:E28E 9C EC 0D    STZ $0DEC  [$7E:0DEC]  ;\
$88:E291 9C EE 0D    STZ $0DEE  [$7E:0DEE]  ;|
$88:E294 9C F0 0D    STZ $0DF0  [$7E:0DF0]  ;} $0DEC..F3 = 0
...
$88:E2AB A9 0B 00    LDA #$000B             ; A = Bh
$88:E2AE 22 84 F0 90 JSL $90F084[$90:F084]  ; Execute $90:F084
$88:E2B2 18          CLC                    ; Clear carry
$88:E2B3 60          RTS
}
...
$88:E451 70 13       BVS $13    [$E466]     ;} If [$1988] & 4000h != 0: go to BRANCH_1A
$88:E453 AE 74 10    LDX $1074  [$7E:1074]  ;\
$88:E456 F0 06       BEQ $06    [$E45E]     ;} If [enemy 3 $0FB4] = 0: go to BRANCH_4
$88:E458 E0 FF       CPX #$FF               ;\
$88:E45A F0 12       BEQ $12    [$E46E]     ;} If [enemy 3 $0FB4] = FFh: go to BRANCH_DELETE
$88:E45C 80 0E       BRA $0E    [$E46C]     ; Return

; BRANCH_4
$88:E45E A9 04 00    LDA #$0004             ;\
$88:E461 8D 86 19    STA $1986  [$7E:1986]  ;} Layer blending configuration = 4
$88:E464 80 06       BRA $06    [$E46C]     ; Return

; BRANCH_1A
$88:E466 A9 1A 00    LDA #$001A             ;\
$88:E469 8D 86 19    STA $1986  [$7E:1986]  ;} Layer blending configuration = 1Ah
...
$88:E471 8D 86 19    STA $1986  [$7E:1986]  ;} Layer blending configuration = 4
...
$88:E48D DA          PHX
$88:E48E 8D 34 10    STA $1034  [$7E:1034]
$88:E491 9C 6E 10    STZ $106E  [$7E:106E]
$88:E494 9C 70 10    STZ $1070  [$7E:1070]
$88:E497 A5 16       LDA $16    [$7E:0016]
$88:E499 8D 72 10    STA $1072  [$7E:1072]
...
$88:E4C3 8D F4 0F    STA $0FF4  [$7E:0FF4]
$88:E4C6 89 01 00    BIT #$0001
$88:E4C9 D0 52       BNE $52    [$E51D]
...
$88:E4F1 8F 01 90 7E STA $7E9001[$7E:9001]
...
$88:E556 9D 14 19    STA $1914,x[$7E:1916]
$88:E559 A9 01 00    LDA #$0001
$88:E55C 9D 20 19    STA $1920,x[$7E:1922]
$88:E55F 9E 2C 19    STZ $192C,x[$7E:192E]
$88:E562 9E 38 19    STZ $1938,x[$7E:193A]
$88:E565 28          PLP
$88:E566 60          RTS
}
...
$88:E57D 9D E4 18    STA $18E4,x[$7E:18E6]
$88:E580 28          PLP
$88:E581 6B          RTL

$88:E582 89 01 00    BIT #$0001
$88:E585 D0 0C       BNE $0C    [$E593]
$88:E587 A9 08 00    LDA #$0008
$88:E58A 85 1C       STA $1C    [$7E:001C]
$88:E58C A9 40 00    LDA #$0040
$88:E58F 85 1E       STA $1E    [$7E:001E]
$88:E591 80 0A       BRA $0A    [$E59D]

$88:E593 A9 04 00    LDA #$0004
$88:E596 85 1C       STA $1C    [$7E:001C]
$88:E598 A9 80 00    LDA #$0080
$88:E59B 85 1E       STA $1E    [$7E:001E]

$88:E59D DA          PHX
$88:E59E DE 20 19    DEC $1920,x[$7E:1922]
$88:E5A1 D0 18       BNE $18    [$E5BB]
$88:E5A3 A9 01 00    LDA #$0001
$88:E5A6 9D 20 19    STA $1920,x[$7E:1922]
...
$88:E5BE 85 14       STA $14    [$7E:0014]
$88:E5C0 A2 00 00    LDX #$0000

$88:E5C3 DA          PHX
$88:E5C4 A6 14       LDX $14    [$7E:0014]
$88:E5C6 BF 43 B4 A0 LDA $A0B443,x[$A0:B451]
$88:E5CA 10 03       BPL $03    [$E5CF]
$88:E5CC 4C 56 E6    JMP $E656  [$88:E656]

$88:E5CF 85 12       STA $12    [$7E:0012]
...
$88:E616 AD 16 42    LDA $4216  [$7E:4216]
...
$88:E647 85 14       STA $14    [$7E:0014]
$88:E649 FA          PLX
$88:E64A A5 B5       LDA $B5    [$7E:00B5]
$88:E64C 18          CLC
$88:E64D 65 12       ADC $12    [$7E:0012]
$88:E64F 9F 00 91 7E STA $7E9100,x[$7E:9100]
$88:E653 4C DE E6    JMP $E6DE  [$88:E6DE]
...
$88:E6D2 85 14       STA $14    [$7E:0014]
$88:E6D4 FA          PLX
$88:E6D5 A5 B5       LDA $B5    [$7E:00B5]
$88:E6D7 38          SEC
$88:E6D8 E5 12       SBC $12    [$7E:0012]
$88:E6DA 9F 00 91 7E STA $7E9100,x[$7E:913E]

$88:E6DE E8          INX
$88:E6DF E8          INX
$88:E6E0 E4 1E       CPX $1E    [$7E:001E]
$88:E6E2 10 03       BPL $03    [$E6E7]
$88:E6E4 4C C3 E5    JMP $E5C3  [$88:E5C3]

$88:E6E7 AD F4 0F    LDA $0FF4  [$7E:0FF4]
$88:E6EA 89 01 00    BIT #$0001
...
$88:E727             dx 8655,88,    ; HDMA table bank = $88
                        866A,88,    ; Indirect HDMA data bank = $88
                        85B4,88E726,; Call external function $88:E726 (RTL)
...
$88:E77D 8D 86 19    STA $1986  [$7E:1986]  ;} Layer blending configuration = 24h, layer blending window 2 configuration = none
$88:E780 E2 20       SEP #$20
$88:E782 A9 E4       LDA #$E4               ; >_<;
$88:E784 A9 64       LDA #$64               ;\
$88:E786 8F 00 9C 7E STA $7E9C00[$7E:9C00]  ;|
$88:E78A C2 20       REP #$20               ;|
$88:E78C A9 00 9D    LDA #$9D00             ;} $7E:9C00..04 = 64h,$9D00, 00h,00h
...
$88:E7C2 C9 13 00    CMP #$0013
$88:E7C5 F0 1E       BEQ $1E    [$E7E5]
$88:E7C7 A9 24 00    LDA #$0024
$88:E7CA 8D 86 19    STA $1986  [$7E:1986]
$88:E7CD AD 98 09    LDA $0998  [$7E:0998]
$88:E7D0 C9 1B 00    CMP #$001B
...
$88:E7DF AB          PLB                    ;/
$88:E7E0 20 ED E7    JSR $E7ED  [$88:E7ED]

$88:E7E3 28          PLP
$88:E7E4 6B          RTL

$88:E7E5 AE B2 18    LDX $18B2  [$7E:18B2]
$88:E7E8 9E B4 18    STZ $18B4,x
$88:E7EB 28          PLP
$88:E7EC 6B          RTL
}

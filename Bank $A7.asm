...
;;; $86C7: Kraid BG target palette 6 ;;;
{
...
$A7:94BD 09 10 00    ORA #$0010             ;} Kill beam
...
;;; $A916: Kraid lint initial function timers ;;;
{
...
;;; $A920: Kraid backwards speed ;;;
{
$A7:A920             dw 0003
}


;;; $A922: Unused. Kraid backwards fast speed ;;;
{
$A7:A922             dw 0004
}
...
$A7:A988 E8          INX                    ;} BG target palette 6 = [$86C7..E6]
$A7:A989 E8          INX                    ;|
$A7:A98A C8          INY                    ;|
$A7:A98B C8          INY                    ;|
...
$A7:A9A2 8F 04 78 7E STA $7E7804[$7E:7804]  ;} $7E:7804 = 0
...
$A7:AA4A 8F 3E 78 7E STA $7E783E[$7E:783E]  ;} $7E:783E = 0
...
$A7:AA83 A9 38 03    LDA #$0338             ;|
                                            ;|
$A7:AA86 9F C0 2F 7E STA $7E2FC0,x[$7E:2FFE];} $7E:2FC0..FF = 0338h (used to gradually delete Kraid's GFX)
$A7:AA8A CA          DEX                    ;|
$A7:AA8B CA          DEX                    ;|
...
$A7:AA9E E8          INX                    ;} BG target palette 3 = [$AAA6..C5]
$A7:AA9F E8          INX                    ;|
...
$A7:AB64 20 43 A9    JSR $A943  [$A7:A943]  ; Else (Kraid dead): Set enemy properties to dead
$A7:AB67 6B          RTL
}
...
$A7:AB98 20 43 A9    JSR $A943  [$A7:A943]  ; Else (Kraid dead): Set enemy properties to dead
$A7:AB9B 6B          RTL
}
...
$A7:ABC6 20 43 A9    JSR $A943  [$A7:A943]  ; Else (Kraid dead): Set enemy properties to dead
$A7:ABC9 6B          RTL
}
...
$A7:ABF4 20 43 A9    JSR $A943  [$A7:A943]  ; Else (Kraid dead): Set enemy properties to dead
$A7:ABF7 6B          RTL
}
...
$A7:AC1D 20 43 A9    JSR $A943  [$A7:A943]  ; Else (Kraid dead): Set enemy properties to dead
$A7:AC20 6B          RTL
}
...
{
$A7:AC21 20 AA AF    JSR $AFAA  [$A7:AFAA]  ; Enemy shot - Kraid's mouth
$A7:AC24 20 37 B3    JSR $B337  [$A7:B337]  ; Kraid palette handling
$A7:AC27 20 81 B1    JSR $B181  [$A7:B181]  ; Enemy shot - Kraid's body
$A7:AC2A 20 F3 B0    JSR $B0F3  [$A7:B0F3]  ; Enemy touch - Kraid
...
$A7:ADA7 E8          INX                    ;} BG target palette 6 = [$86C7..E6]
$A7:ADA8 E8          INX                    ;|
$A7:ADA9 C8          INY                    ;|
$A7:ADAA C8          INY                    ;|
...
$A7:ADCC A5 5D       LDA $5D    [$7E:005D]  ;} Queue transfer of $A7:A716..A915 to VRAM $3F00..FF
...
$A7:AE29 B0 01       BCS $01    [$AE2C]     ; If not reached target colour: return
$A7:AE2B 6B          RTL
...
{
$A7:AEE4 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction
...
;;; $AF32: Process Kraid instruction ($0FAA/$0FAC) ;;;
{
...
$A7:AF3A F0 01       BEQ $01    [$AF3D]     ; If [Kraid instruction timer] = 0: execute Kraid instruction

$A7:AF3C 60          RTS
}


;;; $AF3D: Execute Kraid instruction ($0FAA) ;;;
{
...
;     m: Kraid's mouth projectile hitbox, FFFFh means no hitbox
; If p & 8000h != 0:
;     pppp
...
$A7:AF6A A9 A7       LDA #$A7               ;} Queue transfer of 2C0h bytes from $A7:0000 + [[Kraid instruction list pointer] - 6] to VRAM BG2 tilemap base
...
;;; $AF88: Execute next Kraid instruction ;;;
{
...
$A7:AF92 80 A9       BRA $A9    [$AF3D]     ; Go to execute Kraid instruction
}
...
$A7:AF9C FA          PLX
$A7:AF9D 80 E9       BRA $E9    [$AF88]     ; Go to execute next Kraid instruction
}
...
$A7:AFA7 FA          PLX
$A7:AFA8 80 DE       BRA $DE    [$AF88]     ; Go to execute next Kraid instruction
}


;;; $AFAA: Enemy shot - Kraid's mouth ;;;
{
...
$A7:AFBA 38          SEC                    ;|
$A7:AFBB E9 08 00    SBC #$0008             ;} A = [[Kraid instruction list pointer] - 2]
$A7:AFBE AA          TAX                    ;|
...
$A7:AFF7 0A          ASL A                  ;\
$A7:AFF8 AA          TAX                    ;} X = [projectile counter] * 2
...
$A7:B008 18          CLC                    ;|
$A7:B009 7D C8 0B    ADC $0BC8,x[$7E:0BCC]  ;} If projectile bottom boundary < Kraid top boundary: go to BRANCH_NEXT
$A7:B00C C5 14       CMP $14    [$7E:0014]  ;|
$A7:B00E 30 3C       BMI $3C    [$B04C]     ;/
$A7:B010 BD 64 0B    LDA $0B64,x[$7E:0B66]  ;\
$A7:B013 18          CLC                    ;|
$A7:B014 7D B4 0B    ADC $0BB4,x[$7E:0BB6]  ;} If projectile right boundary < Kraid left boundary: go to BRANCH_NEXT
...
; BRANCH_NEXT
$A7:B04C CA          DEX                    ;\
$A7:B04D CA          DEX                    ;} X -= 2 (next projectile index)
$A7:B04E 10 A9       BPL $A9    [$AFF9]     ; If [X] >= 0: go to LOOP

$A7:B050 FA          PLX
$A7:B051 C0 00 00    CPY #$0000             ;\
$A7:B054 D0 01       BNE $01    [$B057]     ;} If [Y] = 0: return
$A7:B056 60          RTS
...
$A7:B081 C9 60 C3    CMP #$C360             ;} If [Kraid function] >= $C360: return
$A7:B084 10 44       BPL $44    [$B0CA]     ;/
$A7:B086 A9 60 C3    LDA #$C360             ;\
$A7:B089 8D A8 0F    STA $0FA8  [$7E:0FA8]  ;} Kraid function = $C360
...
;;; $B0F3: Enemy touch - Kraid ;;;
{
$A7:B0F3 AD A8 0F    LDA $0FA8  [$7E:0FA8]  ;\
$A7:B0F6 C9 60 C3    CMP #$C360             ;} If [Kraid function] >= $C360: return
$A7:B0F9 10 64       BPL $64    [$B15F]     ;/
$A7:B0FB AD F6 0A    LDA $0AF6  [$7E:0AF6]  ;\
$A7:B0FE 18          CLC                    ;|
$A7:B0FF 6D FE 0A    ADC $0AFE  [$7E:0AFE]  ;} $12 = Samus right boundary
...
$A7:B1A3 AA          TAX                    ;} X = [[Kraid instruction list pointer] - 4]
...
$A7:B1C8 0A          ASL A                  ;\
$A7:B1C9 AA          TAX                    ;} X = [projectile counter] * 2 (shouldn't this be decremented first?)
...
$A7:B6D7 DA          PHX
$A7:B6D8 5A          PHY
$A7:B6D9 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction
...
{
$A7:B965 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction ($0FAA)
...
{
$A7:BBEA 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction
...
$A7:C3F9 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction ($0FAA)
...
{
$A7:C4A4 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction ($0FAA)
...
{
$A7:C4C8 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction ($0FAA)
...
{
$A7:C537 20 32 AF    JSR $AF32  [$A7:AF32]  ; Process Kraid instruction ($0FAA)
...
{
;;; $E81E: Instruction list - yyyy ;;;
{
$A7:E81E             dx 0005,EFFF,
                        812F        ; Sleep
}
...
;;; $E854: Instruction list - yyyy ;;;
{
$A7:E854             dx 0001,EF6B,
                        812F        ; Sleep
}


;;; $E85A: Instruction list - yyyy ;;;
{
$A7:E85A             dx 000C,EF90,
                        000C,EFB5,
                        0006,EFDA,
                        000C,EFB5,
                        000C,EF90,
...
;;; $F225..FF81: Dachora ;;;
{
;;; $F225: Palette - enemy $F225 (dachora) ;;;
{
...
{
;;; $F345: Instruction list - yyyy ;;;
{
$A7:F345             dx 0005,F9C4,
                        0005,F9F3,
                        0005,FA22,
                        0005,FA5B,
                        0005,FA8A,
...
;;; $F361: Instruction list - yyyy ;;;
{
$A7:F361             dx 0003,F9C4,
                        0003,F9F3,
                        0003,FA22,
                        0003,FA5B,
                        0003,FA8A,
...
;;; $F37D: Instruction list - yyyy ;;;
{
$A7:F37D             dx 0001,F9C4,
                        0001,F9F3,
                        0001,FA22,
                        0001,FA5B,
                        0001,FA8A,
...
$A7:F4E3 09 00 20    ORA #$2000
$A7:F4E6 9D 86 0F    STA $0F86,x[$7E:1186]
$A7:F4E9 A9 4D 80    LDA #$804D
$A7:F4EC 9D 8E 0F    STA $0F8E,x[$7E:118E]
$A7:F4EF A9 01 00    LDA #$0001
$A7:F4F2 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F4F5 9E 90 0F    STZ $0F90,x[$7E:1190]
$A7:F4F8 BD B4 0F    LDA $0FB4,x[$7E:11B4]
$A7:F4FB 30 17       BMI $17    [$F514]
$A7:F4FD F0 08       BEQ $08    [$F507]
$A7:F4FF A9 5B F4    LDA #$F45B
$A7:F502 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F505 80 06       BRA $06    [$F50D]

$A7:F507 A9 99 F3    LDA #$F399
$A7:F50A 9D 92 0F    STA $0F92,x

$A7:F50D A9 70 F5    LDA #$F570
$A7:F510 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F513 6B          RTL

$A7:F514 89 01 00    BIT #$0001
$A7:F517 F0 08       BEQ $08    [$F521]
$A7:F519 A9 B9 F4    LDA #$F4B9
$A7:F51C 9D 92 0F    STA $0F92,x[$7E:11D2]
$A7:F51F 80 06       BRA $06    [$F527]

$A7:F521 A9 F7 F3    LDA #$F3F7
$A7:F524 9D 92 0F    STA $0F92,x

$A7:F527 A9 8C F9    LDA #$F98C
$A7:F52A 9D B2 0F    STA $0FB2,x[$7E:11F2]
$A7:F52D 6B          RTL
}
...
$A7:F597 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F59A 80 06       BRA $06    [$F5A2]

$A7:F59C A9 C9 F3    LDA #$F3C9
$A7:F59F 9D 92 0F    STA $0F92,x

$A7:F5A2 A9 01 00    LDA #$0001
$A7:F5A5 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F5A8 A9 BC F5    LDA #$F5BC
$A7:F5AB 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F5AE AD CD F4    LDA $F4CD  [$A7:F4CD]
$A7:F5B1 9D A8 0F    STA $0FA8,x[$7E:11A8]
...
;;; $F5BC:  ;;;
{
$A7:F5BC DE A8 0F    DEC $0FA8,x[$7E:11A8]
$A7:F5BF D0 2B       BNE $2B    [$F5EC]
$A7:F5C1 BD B4 0F    LDA $0FB4,x[$7E:11B4]
$A7:F5C4 F0 0E       BEQ $0E    [$F5D4]
$A7:F5C6 A9 07 F4    LDA #$F407
$A7:F5C9 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F5CC A9 5E F6    LDA #$F65E
$A7:F5CF 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F5D2 80 0C       BRA $0C    [$F5E0]

$A7:F5D4 A9 45 F3    LDA #$F345
$A7:F5D7 9D 92 0F    STA $0F92,x
$A7:F5DA A9 ED F5    LDA #$F5ED
$A7:F5DD 9D B2 0F    STA $0FB2,x

$A7:F5E0 A9 01 00    LDA #$0001
$A7:F5E3 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F5E6 A9 01 00    LDA #$0001
$A7:F5E9 9D B0 0F    STA $0FB0,x[$7E:11B0]
...
;;; $F5ED:  ;;;
{
$A7:F5ED 20 D5 F6    JSR $F6D5  [$A7:F6D5]
...
$A7:F618 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F61B A9 01 00    LDA #$0001
$A7:F61E 9D B0 0F    STA $0FB0,x[$7E:11B0]

$A7:F621 A9 01 00    LDA #$0001
$A7:F624 9D B4 0F    STA $0FB4,x[$7E:11B4]
$A7:F627 A9 01 00    LDA #$0001
$A7:F62A 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F62D 9E A8 0F    STZ $0FA8,x[$7E:11A8]
$A7:F630 9E AA 0F    STZ $0FAA,x[$7E:11AA]
$A7:F633 A0 25 F2    LDY #$F225
$A7:F636 20 35 F5    JSR $F535  [$A7:F535]
$A7:F639 6B          RTL

$A7:F63A BD 7A 0F    LDA $0F7A,x[$7E:117A]
$A7:F63D C9 60 00    CMP #$0060
...
$A7:F656 9D B2 0F    STA $0FB2,x
$A7:F659 9E B0 0F    STZ $0FB0,x
$A7:F65C 80 C3       BRA $C3    [$F621]
}
...
$A7:F677 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F67A A9 ED F5    LDA #$F5ED
$A7:F67D 9D B2 0F    STA $0FB2,x[$7E:11B2]

$A7:F680 9E B4 0F    STZ $0FB4,x[$7E:11B4]
$A7:F683 9E A8 0F    STZ $0FA8,x[$7E:11A8]
$A7:F686 A0 25 F2    LDY #$F225
$A7:F689 20 35 F5    JSR $F535  [$A7:F535]

$A7:F68C 9E B0 0F    STZ $0FB0,x[$7E:11B0]
$A7:F68F 9E AA 0F    STZ $0FAA,x[$7E:11AA]
$A7:F692 A9 01 00    LDA #$0001
$A7:F695 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F698 6B          RTL

$A7:F699 BD 7A 0F    LDA $0F7A,x[$7E:117A]
$A7:F69C C9 80 04    CMP #$0480
$A7:F69F 10 01       BPL $01    [$F6A2]
$A7:F6A1 6B          RTL

$A7:F6A2 A9 B3 F4    LDA #$F4B3
$A7:F6A5 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F6A8 A9 8F F7    LDA #$F78F
$A7:F6AB 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F6AE AD CF F4    LDA $F4CF  [$A7:F4CF]
$A7:F6B1 9D A8 0F    STA $0FA8,x[$7E:11A8]
$A7:F6B4 BD 7E 0F    LDA $0F7E,x[$7E:117E]
$A7:F6B7 18          CLC
$A7:F6B8 69 08 00    ADC #$0008
...
$A7:F6C5 80 C5       BRA $C5    [$F68C]

; Unused branch
$A7:F6C7 A9 99 F3    LDA #$F399
$A7:F6CA 9D 92 0F    STA $0F92,x
$A7:F6CD A9 70 F5    LDA #$F570
$A7:F6D0 9D B2 0F    STA $0FB2,x
$A7:F6D3 80 AB       BRA $AB    [$F680]
}
...
$A7:F732 BD AA 0F    LDA $0FAA,x[$7E:11AA]
...
;;; $F78F:  ;;;
{
$A7:F78F 20 0A F9    JSR $F90A  [$A7:F90A]
$A7:F792 DE A8 0F    DEC $0FA8,x[$7E:11A8]
$A7:F795 D0 6E       BNE $6E    [$F805]
$A7:F797 BD 92 0F    LDA $0F92,x[$7E:1192]
$A7:F79A 1A          INC A
$A7:F79B 1A          INC A
$A7:F79C 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F79F A9 01 00    LDA #$0001
$A7:F7A2 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F7A5 A9 06 F8    LDA #$F806
$A7:F7A8 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F7AB 9E E8 0F    STZ $0FE8,x[$7E:11E8]
$A7:F7AE 9E EE 0F    STZ $0FEE,x[$7E:11EE]
$A7:F7B1 9E 2E 10    STZ $102E,x[$7E:122E]
$A7:F7B4 9E 6E 10    STZ $106E,x[$7E:126E]
$A7:F7B7 9E AE 10    STZ $10AE,x[$7E:12AE]
$A7:F7BA 9E AC 0F    STZ $0FAC,x[$7E:11AC]
$A7:F7BD 9E AE 0F    STZ $0FAE,x[$7E:11AE]
$A7:F7C0 BD 7E 0F    LDA $0F7E,x[$7E:117E]
$A7:F7C3 38          SEC
$A7:F7C4 E9 08 00    SBC #$0008
...
$A7:F7D4 F0 11       BEQ $11    [$F7E7]
$A7:F7D6 A9 B9 F4    LDA #$F4B9
$A7:F7D9 9D D2 0F    STA $0FD2,x[$7E:11D2]
$A7:F7DC 9D 12 10    STA $1012,x[$7E:1212]
$A7:F7DF 9D 52 10    STA $1052,x[$7E:1252]
$A7:F7E2 9D 92 10    STA $1092,x[$7E:1292]
$A7:F7E5 80 0F       BRA $0F    [$F7F6]

$A7:F7E7 A9 F7 F3    LDA #$F3F7
$A7:F7EA 9D D2 0F    STA $0FD2,x
$A7:F7ED 9D 12 10    STA $1012,x
$A7:F7F0 9D 52 10    STA $1052,x
$A7:F7F3 9D 92 10    STA $1092,x

$A7:F7F6 A9 01 00    LDA #$0001
$A7:F7F9 9D D4 0F    STA $0FD4,x[$7E:11D4]
$A7:F7FC 9D 14 10    STA $1014,x[$7E:1214]
$A7:F7FF 9D 54 10    STA $1054,x[$7E:1254]
$A7:F802 9D 94 10    STA $1094,x[$7E:1294]
...
;;; $F806:  ;;;
{
$A7:F806 20 0A F9    JSR $F90A  [$A7:F90A]
$A7:F809 20 9A F8    JSR $F89A  [$A7:F89A]
...
$A7:F82B 85 12       STA $12    [$7E:0012]  ;} Enemy Y velocity += [enemy Y acceleration]
$A7:F82D BD A8 0F    LDA $0FA8,x[$7E:11A8]  ;|
$A7:F830 7D AC 0F    ADC $0FAC,x[$7E:11AC]  ;|
$A7:F833 9D A8 0F    STA $0FA8,x[$7E:11A8]  ;/
$A7:F836 85 14       STA $14    [$7E:0014]  ; $14.$12 = [enemy Y velocity]
...
$A7:F84B 49 FF FF    EOR #$FFFF             ;} Negate $14.$12
$A7:F84E 1A          INC A                  ;|
$A7:F84F 85 12       STA $12    [$7E:0012]  ;|
$A7:F851 D0 02       BNE $02    [$F855]     ;|
$A7:F853 E6 14       INC $14    [$7E:0014]  ;/

$A7:F855 22 86 C7 A0 JSL $A0C786[$A0:C786]  ; Move enemy down by [$14].[$12]
$A7:F859 90 3E       BCC $3E    [$F899]     ; If not collided with block: return
$A7:F85B BD B4 0F    LDA $0FB4,x[$7E:11B4]
$A7:F85E D0 0E       BNE $0E    [$F86E]
$A7:F860 A9 C1 F4    LDA #$F4C1
$A7:F863 9D 92 0F    STA $0F92,x
$A7:F866 A9 01 00    LDA #$0001
$A7:F869 9D B4 0F    STA $0FB4,x
$A7:F86C 80 09       BRA $09    [$F877]

$A7:F86E A9 FF F3    LDA #$F3FF
$A7:F871 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F874 9E B4 0F    STZ $0FB4,x[$7E:11B4]

$A7:F877 A9 35 F9    LDA #$F935
$A7:F87A 9D B2 0F    STA $0FB2,x[$7E:11B2]
$A7:F87D A9 01 00    LDA #$0001
$A7:F880 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F883 9E A8 0F    STZ $0FA8,x[$7E:11A8]
$A7:F886 9E AA 0F    STZ $0FAA,x[$7E:11AA]
$A7:F889 9E B0 0F    STZ $0FB0,x[$7E:11B0]
$A7:F88C A0 25 F2    LDY #$F225
$A7:F88F 20 35 F5    JSR $F535  [$A7:F535]
...
$A7:F89D F0 05       BEQ $05    [$F8A4]
$A7:F89F 3A          DEC A
$A7:F8A0 9D E8 0F    STA $0FE8,x[$7E:11E8]
$A7:F8A3 60          RTS

$A7:F8A4 AD D1 F4    LDA $F4D1  [$A7:F4D1]
$A7:F8A7 9D E8 0F    STA $0FE8,x[$7E:11E8]
$A7:F8AA BD EE 0F    LDA $0FEE,x[$7E:11EE]
$A7:F8AD D0 13       BNE $13    [$F8C2]
$A7:F8AF BD 7A 0F    LDA $0F7A,x[$7E:117A]
$A7:F8B2 9D BA 0F    STA $0FBA,x[$7E:11BA]
$A7:F8B5 BD 7E 0F    LDA $0F7E,x[$7E:117E]
$A7:F8B8 9D BE 0F    STA $0FBE,x[$7E:11BE]
$A7:F8BB AD D3 F4    LDA $F4D3  [$A7:F4D3]
$A7:F8BE 9D EE 0F    STA $0FEE,x[$7E:11EE]
$A7:F8C1 60          RTS

$A7:F8C2 BD 2E 10    LDA $102E,x[$7E:122E]
$A7:F8C5 D0 13       BNE $13    [$F8DA]
$A7:F8C7 BD 7A 0F    LDA $0F7A,x[$7E:117A]
$A7:F8CA 9D FA 0F    STA $0FFA,x[$7E:11FA]
$A7:F8CD BD 7E 0F    LDA $0F7E,x[$7E:117E]
$A7:F8D0 9D FE 0F    STA $0FFE,x[$7E:11FE]
$A7:F8D3 AD D3 F4    LDA $F4D3  [$A7:F4D3]
$A7:F8D6 9D 2E 10    STA $102E,x[$7E:122E]
$A7:F8D9 60          RTS

$A7:F8DA BD 6E 10    LDA $106E,x[$7E:126E]
$A7:F8DD D0 13       BNE $13    [$F8F2]
$A7:F8DF BD 7A 0F    LDA $0F7A,x[$7E:117A]
$A7:F8E2 9D 3A 10    STA $103A,x[$7E:123A]
$A7:F8E5 BD 7E 0F    LDA $0F7E,x[$7E:117E]
$A7:F8E8 9D 3E 10    STA $103E,x[$7E:123E]
$A7:F8EB AD D3 F4    LDA $F4D3  [$A7:F4D3]
$A7:F8EE 9D 6E 10    STA $106E,x[$7E:126E]
$A7:F8F1 60          RTS

$A7:F8F2 BD AE 10    LDA $10AE,x[$7E:12AE]
$A7:F8F5 D0 12       BNE $12    [$F909]
$A7:F8F7 BD 7A 0F    LDA $0F7A,x[$7E:117A]
$A7:F8FA 9D 7A 10    STA $107A,x[$7E:127A]
$A7:F8FD BD 7E 0F    LDA $0F7E,x[$7E:117E]
$A7:F900 9D 7E 10    STA $107E,x[$7E:127E]
$A7:F903 AD D3 F4    LDA $F4D3  [$A7:F4D3]
$A7:F906 9D AE 10    STA $10AE,x[$7E:12AE]
...
$A7:F91D 18          CLC
$A7:F91E 69 00 01    ADC #$0100
$A7:F921 9D B0 0F    STA $0FB0,x[$7E:11B0]
$A7:F924 C9 00 04    CMP #$0400
$A7:F927 30 03       BMI $03    [$F92C]
$A7:F929 9E B0 0F    STZ $0FB0,x[$7E:11B0]
...
$A7:F940 85 12       STA $12    [$7E:0012]  ;} Enemy Y velocity += [Samus Y acceleration]
$A7:F942 BD A8 0F    LDA $0FA8,x[$7E:11A8]  ;|
$A7:F945 6F 34 0B 00 ADC $000B34[$7E:0B34]  ;|
$A7:F949 9D A8 0F    STA $0FA8,x[$7E:11A8]  ;/
$A7:F94C 85 14       STA $14    [$7E:0014]  ; $14.$12 = [enemy Y velocity]
$A7:F94E C9 0A 00    CMP #$000A             ;\
$A7:F951 30 07       BMI $07    [$F95A]     ;|
$A7:F953 A9 0A 00    LDA #$000A             ;} $14.$12 = min(A.0h, [$14].[$12])
...
$A7:F963 F0 0E       BEQ $0E    [$F973]
$A7:F965 A9 07 F4    LDA #$F407
$A7:F968 9D 92 0F    STA $0F92,x
$A7:F96B A9 5E F6    LDA #$F65E
$A7:F96E 9D B2 0F    STA $0FB2,x
$A7:F971 80 0C       BRA $0C    [$F97F]

$A7:F973 A9 45 F3    LDA #$F345
$A7:F976 9D 92 0F    STA $0F92,x[$7E:1192]
$A7:F979 A9 ED F5    LDA #$F5ED
$A7:F97C 9D B2 0F    STA $0FB2,x[$7E:11B2]

$A7:F97F A9 01 00    LDA #$0001
$A7:F982 9D 94 0F    STA $0F94,x[$7E:1194]
$A7:F985 9E A8 0F    STZ $0FA8,x[$7E:11A8]
$A7:F988 9E AA 0F    STZ $0FAA,x[$7E:11AA]

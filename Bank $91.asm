...
$91:80F7 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ;} $0A2A = facing right - normal jump - not aiming - not moving - gun not extended
$91:80FA 80 06       BRA $06    [$8102]

$91:80FC A9 4E 00    LDA #$004E             ;\
$91:80FF 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ;} $0A2A = facing left - normal jump - not aiming - not moving - gun not extended

$91:8102 A9 04 00    LDA #$0004             ;\
$91:8105 8D 30 0A    STA $0A30  [$7E:0A30]  ;} $0A30 = 4
...
$91:81EC 8D 28 0A    STA $0A28  [$7E:0A28]  ; $0A28 = [[Y] + 4]
...
$91:82E7 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = [Samus pose]
...
$91:82FE 8D 28 0A    STA $0A28  [$7E:0A28]  ; $0A28 = [$B62B + [Samus pose] * 8]
...
$91:830A AA          TAX                    ;|
$91:830B BD 32 83    LDA $8332,x[$91:8332]  ;} If [$8332 + [Samus movement type]] = 1: go to BRANCH_1
$91:830E 29 FF 00    AND #$00FF             ;|
$91:8311 C9 01 00    CMP #$0001             ;|
$91:8314 F0 05       BEQ $05    [$831B]     ;/

$91:8316 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ; $0A2E = [$8332 + [Samus movement type]]
$91:8319 18          CLC                    ;\
...
$91:8325 A9 02 00    LDA #$0002             ; $0A2E = 2
$91:8328 80 EC       BRA $EC    [$8316]     ; Return carry clear

$91:832A A9 01 00    LDA #$0001             ;\
$91:832D 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 1
$91:8330 38          SEC                    ;\
$91:8331 60          RTS                    ;} Return carry set

; Value for $0A2E. If 1 and [Samus X momentum] = 0, use 2 instead
...
;;; $85CE: Demo input instruction list ;;;
{
$91:85CE             dw 001E,0000,0000, 0001,0200,0200, 001A,0200,0000, 0001,0280,0080, 0034,0280,0000, 001E,0200,0000, 0049,0000,0000,
                        85FC,
                        8427
}
...
;;; $860D: Demo input instruction lists ;;;
{
$91:860D             dw 005A,0000,0000, 0001,0200,0200
$91:8619             dw 0001,0200,0000,
                        8448,8619

$91:8623             dw 012C,0000,0000, 0001,0010,0010, 00AA,0010,0000, 00F0,0000,0000, 0001,0200,0200
...
$91:8652 C9 B2 00    CMP #$00B2
$91:8655 10 12       BPL $12    [$8669]
$91:8657 A9 6A 86    LDA #$866A
$91:865A 8D 7A 0A    STA $0A7A  [$7E:0A7A]
$91:865D A9 23 86    LDA #$8623
$91:8660 8D 7E 0A    STA $0A7E  [$7E:0A7E]
$91:8663 A9 01 00    LDA #$0001
$91:8666 8D 7C 0A    STA $0A7C  [$7E:0A7C]
...
$91:866D D0 12       BNE $12    [$8681]
$91:866F A9 BF 83    LDA #$83BF
$91:8672 8D 7A 0A    STA $0A7A  [$7E:0A7A]
$91:8675 A9 4B 86    LDA #$864B
$91:8678 8D 7E 0A    STA $0A7E  [$7E:0A7E]
$91:867B A9 01 00    LDA #$0001
$91:867E 8D 7C 0A    STA $0A7C  [$7E:0A7C]
...
;;; $8694: Demo input instruction lists ;;;
{
$91:8694             dw 005A,0000,0000, 0001,0040,0040, 0028,0040,0000, 0001,0040,0040, 001D,0040,0000, 0046,0000,0000

$91:86B8             dw 0014,0000,0000, 0001,0200,0200, 0007,0200,0000, 0001,0280,0080, 0007,0280,0000, 0004,0200,0000, 003C,0000,0000, 0001,0040,0040, 0028,0040,0000, 0001,0040,0040, 0013,0040,0000,
                        8739,
                        8427
}
...
$91:8744 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:8747 22 33 F4 91 JSL $91F433[$91:F433]
...
;;; $8774: Demo input instruction lists ;;;
{
$91:8774             dw 8427
$91:8776             dw 8427
}
...
$91:881C 9C 2E 0A    STZ $0A2E  [$7E:0A2E]  ; $0A2E = 0
$91:881F 9C 30 0A    STZ $0A30  [$7E:0A30]  ; $0A30 = 0
$91:8822 9C 32 0A    STZ $0A32  [$7E:0A32]  ; $0A32 = 0
...
{
$91:8A56 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:8A59 22 33 F4 91 JSL $91F433[$91:F433]
...
$91:8A6E 22 FA CF 90 JSL $90CFFA[$90:CFFA]
$91:8A72 A9 CD 00    LDA #$00CD
$91:8A75 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:8A78 22 33 F4 91 JSL $91F433[$91:F433]
...
$91:8A87 22 FA CF 90 JSL $90CFFA[$90:CFFA]
$91:8A8B A9 CA 00    LDA #$00CA
$91:8A8E 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:8A91 22 33 F4 91 JSL $91F433[$91:F433]
...
;;; $8A9B: Demo input object pre-instruction - normal ;;;
{
$91:8A9B AD 98 09    LDA $0998  [$7E:0998]
$91:8A9E C9 2C 00    CMP #$002C
$91:8AA1 D0 0C       BNE $0C    [$8AAF]
$91:8AA3 A9 76 87    LDA #$8776
$91:8AA6 8D 7E 0A    STA $0A7E  [$7E:0A7E]
$91:8AA9 A9 01 00    LDA #$0001
$91:8AAC 8D 7C 0A    STA $0A7C  [$7E:0A7C]

$91:8AAF 60          RTS
}


;;; $8AB0: Demo input object pre-instruction - shinespark ;;;
{
$91:8AB0 AD 1F 0A    LDA $0A1F  [$7E:0A1F]
$91:8AB3 29 FF 00    AND #$00FF
$91:8AB6 C9 1A 00    CMP #$001A
$91:8AB9 F0 12       BEQ $12    [$8ACD]
$91:8ABB A9 9B 8A    LDA #$8A9B
$91:8ABE 8D 7A 0A    STA $0A7A  [$7E:0A7A]
$91:8AC1 A9 46 93    LDA #$9346
$91:8AC4 8D 7E 0A    STA $0A7E  [$7E:0A7E]
$91:8AC7 A9 01 00    LDA #$0001
$91:8ACA 8D 7C 0A    STA $0A7C  [$7E:0A7C]

$91:8ACD 60          RTS
}


;;; $8ACE: Demo input instruction lists ;;;
{
; Format is
;     nnnn iiii IIII
;
...
; Landing site
$91:8ACE             dw 0121,0000,0000, 0001,0200,0200, 0006,0200,0000, 0001,0A00,0800, 0003,0A00,0000, 0013,0200,0000, 0001,0280,0080, 0028,0280,0000, 0032,0200,0000, 0024,0000,0000, 0001,0100,0100, 0005,0100,0000, 000F,0000,0000, 0001,0200,0200, 0005,0200,0000, 0022,0000,0000,
                        0008,0040,0000, 0028,0000,0000, 0001,0040,0040, 0009,0040,0000, 0026,0000,0000, 0001,0040,0040, 0008,0040,0000, 0028,0000,0000, 0001,0040,0040, 0007,0040,0000, 0029,0000,0000, 0001,0040,0040, 0007,0040,0000, 0029,0000,0000, 0001,0040,0040, 0007,0040,0000,
                        0028,0000,0000, 0001,0040,0040, 0008,0040,0000, 0027,0000,0000, 0001,0040,0040, 0007,0040,0000, 002A,0000,0000, 0001,0040,0040, 0007,0040,0000, 002A,0000,0000, 0001,0040,0040, 0007,0040,0000, 0028,0000,0000, 0001,0040,0040, 0007,0040,0000, 0028,0000,0000,
                        0001,0040,0040, 0007,0040,0000, 0010,0000,0000, 0001,0100,0100, 001E,0100,0000, 0017,0000,0000, 0001,0800,0800, 0009,0800,0000, 0008,0000,0000, 0001,0800,0800, 0005,0800,0000, 0001,0000,0000, 0001,0800,0800, 0009,0000,0000, 0001,0200,0200, 0004,0200,0000,
                        00C4,0000,0000,
                        8427

; SBA
$91:9CD8             dw 001A,0000,0000, 0001,2000,2000, 0008,2000,0000, 0006,0000,0000, 0001,2000,2000, 0006,2000,0000, 0006,0000,0000, 0001,2000,2000, 0006,2000,0000, 0008,0000,0000, 0001,0080,0080, 0003,0080,0000, 0001,0180,0100, 0023,0180,0000, 0007,0100,0000, 0010,0000,0000,
                        0001,0080,0080, 0010,0080,0000, 0001,0280,0200, 0007,0280,0000, 0001,02C0,0040, 0004,02C0,0000, 000E,0240,0000, 0010,0040,0000, 0001,00C0,0080, 0008,00C0,0000, 0001,01C0,0100, 000B,01C0,0000, 0014,0140,0000, 0015,0040,0000, 0001,0440,0400, 0006,0440,0000,
                        0040,0040,0000, 0034,0000,0000,
                        8427

; Tourian entrance
$91:9DA6             dw 0195,0000,0000,
                        8427

; Crystal flash
$91:9DAE             dw 001B,0000,0000, 0001,0400,0400, 0005,0400,0000, 0005,0000,0000, 0001,0400,0400, 0007,0400,0000, 0009,0000,0000, 0001,2000,2000, 0006,2000,0000, 0006,0000,0000, 0001,2000,2000, 0005,2000,0000, 0008,0000,0000, 0001,2000,2000, 0007,2000,0000, 0031,0000,0000,
                        0001,0430,0430, 0009,0430,0000, 0001,0470,0040, 0010,0470,0000, 001E,0430,0000, 0001,0470,0040, 00BE,0470,0000, 0003,0070,0000, 0001,0030,0000, 0001,0010,0000, 013C,0000,0000,
                        8427
}
...
$91:D567 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
$91:D63F 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
$91:D7B9 89 01 00    BIT #$0001             ;} If [charged shot glow timer] & 1 = 0:
$91:D7BC D0 0D       BNE $0D    [$D7CB]     ;/
$91:D7BE 29 1E 00    AND #$001E             ;\
$91:D7C1 F0 0D       BEQ $0D    [$D7D0]     ;} If [charged shot glow timer] = 0: go to BRANCH_END_GLOW
$91:D7C3 A8          TAY                    ;\
...
$91:D8A0 8D 72 0A    STA $0A72  [$7E:0A72]
$91:D8A3 18          CLC
$91:D8A4 60          RTS
}
...
$91:D8A8 D0 06       BNE $06    [$D8B0]
$91:D8AA AD 48 0A    LDA $0A48  [$7E:0A48]
$91:D8AD D0 04       BNE $04    [$D8B3]
$91:D8AF 60          RTS

$91:D8B0 4C 54 D9    JMP $D954  [$91:D954]

$91:D8B3 C9 02 00    CMP #$0002
$91:D8B6 D0 21       BNE $21    [$D8D9]
$91:D8B8 AD 51 1F    LDA $1F51  [$7E:1F51]
$91:D8BB D0 19       BNE $19    [$D8D6]
...
$91:D93B 8D C0 0D    STA $0DC0  [$7E:0DC0]
$91:D93E 60          RTS

$91:D93F C9 56 C8    CMP #$C856
$91:D942 10 CC       BPL $CC    [$D910]
...
$91:D954 30 19       BMI $19    [$D96F]
$91:D956 89 01 00    BIT #$0001
$91:D959 F0 0C       BEQ $0C    [$D967]
...
$91:D96B EE 4A 0A    INC $0A4A  [$7E:0A4A]
$91:D96E 60          RTS
...
$91:DA43 9C CE 0A    STZ $0ACE  [$7E:0ACE]
...
; Samus palette table. Screw attack
...
$91:DA74 CE D0 0A    DEC $0AD0  [$7E:0AD0]
$91:DA77 F0 02       BEQ $02    [$DA7B]
$91:DA79 10 2C       BPL $2C    [$DAA7]
...
; Samus palette table, colours 0..9. [palette pointer], [timer]
...
$91:DE5C F0 2F       BEQ $2F    [$DE8D]     ;} If [$0B3C] = 0: go to BRANCH_MERGE
$91:DE5E 9C 3C 0B    STZ $0B3C  [$7E:0B3C]  ; $0B3C = 0
$91:DE61 9C 3E 0B    STZ $0B3E  [$7E:0B3E]  ; $0B3E = speed boost counter = 0
...
$91:E050 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = FFFFh
$91:E053 9C 30 0A    STZ $0A30  [$7E:0A30]  ; $0A30 = 0
$91:E056 9C 32 0A    STZ $0A32  [$7E:0A32]  ; $0A32 = 0
...
$91:E077 9C 2E 0A    STZ $0A2E  [$7E:0A2E]  ; $0A2E = 0
$91:E07A 9C 30 0A    STZ $0A30  [$7E:0A30]  ; $0A30 = 0
$91:E07D 9C 32 0A    STZ $0A32  [$7E:0A32]  ; $0A32 = 0
...
$91:E08E 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = FFFFh
$91:E091 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ; $0A2A = FFFFh
$91:E094 8D 2C 0A    STA $0A2C  [$7E:0A2C]  ; $0A2C = FFFFh
...
$91:E0A2 8D 5A 0A    STA $0A5A  [$7E:0A5A]  ;} $0A5A = $E0E6 (handle timer)
$91:E0A5 80 06       BRA $06    [$E0AD]

$91:E0A7 A9 0E E9    LDA #$E90E             ;\ Else ([area index] != Ceres):
$91:E0AA 8D 5A 0A    STA $0A5A  [$7E:0A5A]  ;} $0A5A = RTS
...
$91:E0C2 8D 72 0A    STA $0A72  [$7E:0A72]  ;} Samus visor palette timer = 601h
...
$91:E1F1 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ;} $0A2A = facing right - x-ray - standing
$91:E1F4 80 21       BRA $21    [$E217]     ; Go to BRANCH_MERGE

$91:E1F6 A9 D6 00    LDA #$00D6             ;\
$91:E1F9 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ;} $0A2A = facing left - x-ray - standing
...
$91:E418 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
$91:E45C 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = FFFFh
$91:E45F 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ; $0A2A = FFFFh
$91:E462 8D 2C 0A    STA $0A2C  [$7E:0A2C]  ; $0A2C = FFFFh
$91:E465 9C 2E 0A    STZ $0A2E  [$7E:0A2E]  ; $0A2E = 0
$91:E468 9C 30 0A    STZ $0A30  [$7E:0A30]  ; $0A30 = 0
$91:E46B 9C 32 0A    STZ $0A32  [$7E:0A32]  ; $0A32 = 0
$91:E46E A9 1F 00    LDA #$001F
$91:E471 22 84 F0 90 JSL $90F084[$90:F084]
...
$91:E4BA 90 2D       BCC $2D    [$E4E9]     ; If carry clear: return
...
$91:E4D7 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = FFFFh
$91:E4DA 8D 2A 0A    STA $0A2A  [$7E:0A2A]  ; $0A2A = FFFFh
$91:E4DD 8D 2C 0A    STA $0A2C  [$7E:0A2C]  ; $0A2C = FFFFh
$91:E4E0 9C 2E 0A    STZ $0A2E  [$7E:0A2E]  ; $0A2E = 0
$91:E4E3 9C 30 0A    STZ $0A30  [$7E:0A30]  ; $0A30 = 0
$91:E4E6 9C 32 0A    STZ $0A32  [$7E:0A32]  ; $0A32 = 0
...
$91:E52C 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
$91:E596 8D 5A 0A    STA $0A5A  [$7E:0A5A]  ;} $0A5A = RTS
$91:E599 38          SEC                    ;\
...
;;; $E60C:  ;;;
{
; Put Samus into crouching/falling drained pose
...
$91:E647 89 00 20    BIT #$2000
$91:E64A D0 23       BNE $23    [$E66F]
$91:E64C 9C AE 0A    STZ $0AAE  [$7E:0AAE]
$91:E64F 9C C0 0A    STZ $0AC0  [$7E:0AC0]
$91:E652 9C C2 0A    STZ $0AC2  [$7E:0AC2]
$91:E655 9C 3C 0B    STZ $0B3C  [$7E:0B3C]
$91:E658 9C 3E 0B    STZ $0B3E  [$7E:0B3E]
$91:E65B 9C CE 0A    STZ $0ACE  [$7E:0ACE]
$91:E65E 9C D0 0A    STZ $0AD0  [$7E:0AD0]
$91:E661 9C B0 0A    STZ $0AB0  [$7E:0AB0]
$91:E664 9C B2 0A    STZ $0AB2  [$7E:0AB2]
$91:E667 9C B8 0A    STZ $0AB8  [$7E:0AB8]
$91:E66A 9C BA 0A    STZ $0ABA  [$7E:0ABA]
$91:E66D 80 16       BRA $16    [$E685]

$91:E66F AD 3C 0B    LDA $0B3C  [$7E:0B3C]
$91:E672 F0 11       BEQ $11    [$E685]
$91:E674 AD 3E 0B    LDA $0B3E  [$7E:0B3E]
$91:E677 D0 0C       BNE $0C    [$E685]
$91:E679 8D D0 0A    STA $0AD0  [$7E:0AD0]
$91:E67C 9C CE 0A    STZ $0ACE  [$7E:0ACE]
$91:E67F AD 1F B6    LDA $B61F  [$91:B61F]
$91:E682 8D 3E 0B    STA $0B3E  [$7E:0B3E]

$91:E685 AD 32 0D    LDA $0D32  [$7E:0D32]
$91:E688 C9 F0 C4    CMP #$C4F0
$91:E68B F0 10       BEQ $10    [$E69D]
$91:E68D A9 02 00    LDA #$0002
$91:E690 22 F0 AC 90 JSL $90ACF0[$90:ACF0]
...
$91:E736 C9 00 00    CMP #$0000
$91:E739 F0 06       BEQ $06    [$E741]
$91:E73B C9 9B 00    CMP #$009B
$91:E73E F0 17       BEQ $17    [$E757]
$91:E740 60          RTS

$91:E741 AD A2 09    LDA $09A2  [$7E:09A2]
$91:E744 89 01 00    BIT #$0001
$91:E747 D0 06       BNE $06    [$E74F]
$91:E749 89 20 00    BIT #$0020
$91:E74C D0 01       BNE $01    [$E74F]
$91:E74E 60          RTS

$91:E74F A9 9B 00    LDA #$009B
$91:E752 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E755 80 13       BRA $13    [$E76A]

$91:E757 AD A2 09    LDA $09A2  [$7E:09A2]
$91:E75A 89 01 00    BIT #$0001
$91:E75D D0 16       BNE $16    [$E775]
$91:E75F 89 20 00    BIT #$0020
$91:E762 D0 11       BNE $11    [$E775]
$91:E764 A9 00 00    LDA #$0000
$91:E767 8D 1C 0A    STA $0A1C  [$7E:0A1C]

$91:E76A 22 33 F4 91 JSL $91F433[$91:F433]
...
$91:E781 A9 08 01    LDA #$0108
$91:E784 8D 22 0A    STA $0A22  [$7E:0A22]
...
$91:E795 F0 20       BEQ $20    [$E7B7]
$91:E797 C9 82 00    CMP #$0082
$91:E79A F0 1B       BEQ $1B    [$E7B7]
$91:E79C C9 1B 00    CMP #$001B
$91:E79F F0 07       BEQ $07    [$E7A8]
$91:E7A1 C9 1C 00    CMP #$001C
$91:E7A4 F0 02       BEQ $02    [$E7A8]
$91:E7A6 80 6D       BRA $6D    [$E815]

$91:E7A8 AD A2 09    LDA $09A2  [$7E:09A2]
$91:E7AB 89 08 00    BIT #$0008
$91:E7AE D0 16       BNE $16    [$E7C6]
$91:E7B0 89 00 02    BIT #$0200
$91:E7B3 F0 47       BEQ $47    [$E7FC]
$91:E7B5 80 5E       BRA $5E    [$E815]

$91:E7B7 AD A2 09    LDA $09A2  [$7E:09A2]
$91:E7BA 89 08 00    BIT #$0008
$91:E7BD D0 56       BNE $56    [$E815]
$91:E7BF 89 00 02    BIT #$0200
$91:E7C2 D0 1D       BNE $1D    [$E7E1]
$91:E7C4 80 36       BRA $36    [$E7FC]

$91:E7C6 AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E7C9 29 FF 00    AND #$00FF
$91:E7CC C9 04 00    CMP #$0004
$91:E7CF F0 08       BEQ $08    [$E7D9]
$91:E7D1 A9 81 00    LDA #$0081
$91:E7D4 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E7D7 80 3C       BRA $3C    [$E815]

$91:E7D9 A9 82 00    LDA #$0082
$91:E7DC 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E7DF 80 34       BRA $34    [$E815]

$91:E7E1 AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E7E4 29 FF 00    AND #$00FF
$91:E7E7 C9 04 00    CMP #$0004
$91:E7EA F0 08       BEQ $08    [$E7F4]
$91:E7EC A9 1B 00    LDA #$001B
$91:E7EF 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E7F2 80 21       BRA $21    [$E815]

$91:E7F4 A9 1C 00    LDA #$001C
$91:E7F7 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E7FA 80 19       BRA $19    [$E815]

$91:E7FC AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E7FF 29 FF 00    AND #$00FF
$91:E802 C9 04 00    CMP #$0004
$91:E805 F0 08       BEQ $08    [$E80F]
$91:E807 A9 19 00    LDA #$0019
$91:E80A 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E80D 80 06       BRA $06    [$E815]

$91:E80F A9 1A 00    LDA #$001A
$91:E812 8D 1C 0A    STA $0A1C  [$7E:0A1C]

$91:E815 22 33 F4 91 JSL $91F433[$91:F433]
...
$91:E828 A9 08 03    LDA #$0308
$91:E82B 8D 22 0A    STA $0A22  [$7E:0A22]
...
$91:E83D 89 02 00    BIT #$0002
$91:E840 F0 24       BEQ $24    [$E866]
$91:E842 AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E845 29 FF 00    AND #$00FF
$91:E848 C9 04 00    CMP #$0004
$91:E84B F0 08       BEQ $08    [$E855]
$91:E84D A9 79 00    LDA #$0079
$91:E850 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E853 80 06       BRA $06    [$E85B]

$91:E855 A9 7A 00    LDA #$007A
$91:E858 8D 1C 0A    STA $0A1C  [$7E:0A1C]

$91:E85B 22 33 F4 91 JSL $91F433[$91:F433]
...
$91:E86A 89 02 00    BIT #$0002
$91:E86D D0 24       BNE $24    [$E893]
$91:E86F AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E872 29 FF 00    AND #$00FF
$91:E875 C9 04 00    CMP #$0004
$91:E878 F0 08       BEQ $08    [$E882]
$91:E87A A9 1D 00    LDA #$001D
$91:E87D 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:E880 80 06       BRA $06    [$E888]

$91:E882 A9 41 00    LDA #$0041
$91:E885 8D 1C 0A    STA $0A1C  [$7E:0A1C]

$91:E888 22 33 F4 91 JSL $91F433[$91:F433]
...
$91:E897 89 08 00    BIT #$0008
$91:E89A D0 13       BNE $13    [$E8AF]
$91:E89C 89 00 02    BIT #$0200
$91:E89F D0 07       BNE $07    [$E8A8]
$91:E8A1 A9 03 00    LDA #$0003
$91:E8A4 8D 96 0A    STA $0A96  [$7E:0A96]
$91:E8A7 60          RTS

$91:E8A8 A9 0D 00    LDA #$000D
$91:E8AB 8D 96 0A    STA $0A96  [$7E:0A96]
$91:E8AE 60          RTS

$91:E8AF A9 17 00    LDA #$0017
$91:E8B2 8D 96 0A    STA $0A96  [$7E:0A96]
$91:E8B5 60          RTS
}


;;; $E8B6: Handles automatic transitions from collisions with blocks ;;;
{
...
$91:E8BF F0 08       BEQ $08    [$E8C9]     ;} If [$0DC6] != 0:
$91:E8C1 29 FF 00    AND #$00FF             ;\
$91:E8C4 0A          ASL A                  ;|
$91:E8C5 AA          TAX                    ;} Execute [$E8CC + [$0DC6] * 2]
...
$91:E8DB 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = [Samus pose]
$91:E8DE A9 05 00    LDA #$0005             ;\
$91:E8E1 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 5
$91:E8E4 60          RTS
}
...
$91:E8E8 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = [Samus pose]
$91:E8EB A9 05 00    LDA #$0005             ;\
$91:E8EE 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 5
$91:E8F1 60          RTS
}
...
;;; $E8F2:  ;;;
{
; Set pose for Samus downward movement with no block / solid enemy collision (i.e. falling)
$91:E8F2 AD C7 0D    LDA $0DC7  [$7E:0DC7]  ;\
$91:E8F5 29 FF 00    AND #$00FF             ;|
$91:E8F8 C9 04 00    CMP #$0004             ;} If [$0DC7] = 4 (grounded):
$91:E8FB D0 01       BNE $01    [$E8FE]     ;/
$91:E8FD 60          RTS                    ; Return

$91:E8FE 0A          ASL A                  ;\
$91:E8FF 0A          ASL A                  ;} X = [$0DC7] * 4
$91:E900 AA          TAX                    ;/
...
$91:E90F 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = [$E921 + [X]]
$91:E912 80 06       BRA $06    [$E91A]

$91:E914 BD 23 E9    LDA $E923,x[$91:E923]  ;\ Else (facing left):
$91:E917 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = [$E921 + [X] + 2]

$91:E91A A9 05 00    LDA #$0005             ;\
$91:E91D 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 5
$91:E920 60          RTS
...
;;; $E931:  ;;;
{
; Set pose for Samus downward movement after block / solid enemy collision (i.e. landing)
$91:E931 AD C7 0D    LDA $0DC7  [$7E:0DC7]  ;\
$91:E934 29 FF 00    AND #$00FF             ;|
$91:E937 C9 04 00    CMP #$0004             ;} If [$0DC7] = 4 (grounded): return
$91:E93A F0 14       BEQ $14    [$E950]     ;/
$91:E93C 0A          ASL A                  ;\
$91:E93D AA          TAX                    ;} Execute [$E951 + [$0DC7] * 2]
$91:E93E FC 51 E9    JSR ($E951,x)[$91:E95D];/
$91:E941 90 07       BCC $07    [$E94A]     ; If carry set:
$91:E943 A9 00 00    LDA #$0000             ;\
$91:E946 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 0
$91:E949 60          RTS                    ; Return

$91:E94A A9 05 00    LDA #$0005             ;\
$91:E94D 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 5
...
$91:E963 C9 03 00    CMP #$0003
$91:E966 F0 70       BEQ $70    [$E9D8]
$91:E968 C9 14 00    CMP #$0014
$91:E96B F0 6B       BEQ $6B    [$E9D8]
...
$91:E97D F0 3E       BEQ $3E    [$E9BD]
$91:E97F C9 02 00    CMP #$0002
$91:E982 F0 17       BEQ $17    [$E99B]
$91:E984 C9 07 00    CMP #$0007
$91:E987 F0 12       BEQ $12    [$E99B]

$91:E989 0A          ASL A
$91:E98A AA          TAX
$91:E98B BD F3 E9    LDA $E9F3,x[$91:EA01]
...
$91:E996 29 FF 00    AND #$00FF
$91:E999 80 EE       BRA $EE    [$E989]

$91:E99B A5 8B       LDA $8B    [$7E:008B]  ;\
$91:E99D 2C B2 09    BIT $09B2  [$7E:09B2]  ;} If not pressing shoot: go to BRANCH_E993
$91:E9A0 F0 F1       BEQ $F1    [$E993]     ;/
$91:E9A2 AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E9A5 29 FF 00    AND #$00FF
$91:E9A8 C9 04 00    CMP #$0004
$91:E9AB F0 08       BEQ $08    [$E9B5]
$91:E9AD A9 E6 00    LDA #$00E6
$91:E9B0 8D 28 0A    STA $0A28  [$7E:0A28]
$91:E9B3 18          CLC
$91:E9B4 60          RTS

$91:E9B5 A9 E7 00    LDA #$00E7
$91:E9B8 8D 28 0A    STA $0A28  [$7E:0A28]
$91:E9BB 18          CLC
$91:E9BC 60          RTS

$91:E9BD AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E9C0 29 FF 00    AND #$00FF
$91:E9C3 C9 04 00    CMP #$0004
$91:E9C6 F0 08       BEQ $08    [$E9D0]
$91:E9C8 A9 A4 00    LDA #$00A4
$91:E9CB 8D 28 0A    STA $0A28  [$7E:0A28]
$91:E9CE 18          CLC
$91:E9CF 60          RTS

$91:E9D0 A9 A5 00    LDA #$00A5
$91:E9D3 8D 28 0A    STA $0A28  [$7E:0A28]
$91:E9D6 18          CLC
$91:E9D7 60          RTS

$91:E9D8 AD 1E 0A    LDA $0A1E  [$7E:0A1E]
$91:E9DB 29 FF 00    AND #$00FF
$91:E9DE C9 04 00    CMP #$0004
$91:E9E1 F0 08       BEQ $08    [$E9EB]
$91:E9E3 A9 A6 00    LDA #$00A6
$91:E9E6 8D 28 0A    STA $0A28  [$7E:0A28]
$91:E9E9 18          CLC
$91:E9EA 60          RTS

$91:E9EB A9 A7 00    LDA #$00A7
$91:E9EE 8D 28 0A    STA $0A28  [$7E:0A28]
$91:E9F1 18          CLC
$91:E9F2 60          RTS

$91:E9F3             dw 00E0, 00E2, 00A4, 00E4, 00A4, 00A5, 00E5, 00A5, 00E3, 00E1
}
...
$91:EA18 C9 03 00    CMP #$0003
$91:EA1B 30 10       BMI $10    [$EA2D]
$91:EA1D AD 1C 0A    LDA $0A1C  [$7E:0A1C]
$91:EA20 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA23 18          CLC
$91:EA24 60          RTS
}
...
$91:EA28 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA2B 18          CLC
$91:EA2C 60          RTS
}
...
$91:EA33 C9 04 00    CMP #$0004
$91:EA36 F0 08       BEQ $08    [$EA40]
$91:EA38 A9 1D 00    LDA #$001D
$91:EA3B 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA3E 80 06       BRA $06    [$EA46]

$91:EA40 A9 41 00    LDA #$0041
$91:EA43 8D 28 0A    STA $0A28  [$7E:0A28]
...
$91:EA4E C9 04 00    CMP #$0004
$91:EA51 F0 08       BEQ $08    [$EA5B]
$91:EA53 A9 20 00    LDA #$0020
$91:EA56 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA59 80 06       BRA $06    [$EA61]

$91:EA5B A9 42 00    LDA #$0042
$91:EA5E 8D 28 0A    STA $0A28  [$7E:0A28]
...
$91:EA6D 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA70 18          CLC
$91:EA71 60          RTS
...
$91:EA86 C9 03 00    CMP #$0003
$91:EA89 30 10       BMI $10    [$EA9B]
$91:EA8B AD 1C 0A    LDA $0A1C  [$7E:0A1C]
$91:EA8E 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA91 18          CLC
$91:EA92 60          RTS
}
...
$91:EA96 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EA99 18          CLC
$91:EA9A 60          RTS
}
...
$91:EAA1 C9 04 00    CMP #$0004
$91:EAA4 F0 08       BEQ $08    [$EAAE]
$91:EAA6 A9 79 00    LDA #$0079
$91:EAA9 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EAAC 80 06       BRA $06    [$EAB4]

$91:EAAE A9 7A 00    LDA #$007A
$91:EAB1 8D 28 0A    STA $0A28  [$7E:0A28]
...
$91:EAB9 8D 28 0A    STA $0A28  [$7E:0A28]
$91:EABC 18          CLC
$91:EABD 60          RTS
}
...
;;; $EABE:  ;;;
{
; Set pose for wall jump triggered
...
$91:EACC 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = facing right - wall jump
$91:EACF 80 06       BRA $06    [$EAD7]

$91:EAD1 A9 84 00    LDA #$0084             ;\ Else (facing left):
$91:EAD4 8D 28 0A    STA $0A28  [$7E:0A28]  ;} $0A28 = facing left - wall jump

$91:EAD7 A9 05 00    LDA #$0005             ;\
$91:EADA 8D 2E 0A    STA $0A2E  [$7E:0A2E]  ;} $0A2E = 5
$91:EADD 60          RTS
}
...
$91:EBAC 68          PLA
$91:EBAD 80 16       BRA $16    [$EBC5]     ; Go to BRANCH_NOT_0A2C
...
$91:EBBE 0A          ASL A                  ;|
$91:EBBF AA          TAX                    ;} Execute [$EC3E + [$0A32]]
...
; BRANCH_RETURN
$91:EC10 9C C6 0D    STZ $0DC6  [$7E:0DC6]  ; $0DC6 = 0
$91:EC13 AB          PLB
$91:EC14 28          PLP
$91:EC15 6B          RTL
...
$91:EC5A 4C D0 EC    JMP $ECD0  [$91:ECD0]  ; Go to $ECD0
...
$91:EDA9 C9 1B E4    CMP #$E41B             ;} If [$0A5A] = $E41B (unused):
...
$91:EE4E C9 04 00    CMP #$0004
$91:EE51 F0 08       BEQ $08    [$EE5B]
$91:EE53 A9 02 00    LDA #$0002
$91:EE56 8D 52 0A    STA $0A52  [$7E:0A52]
$91:EE59 80 06       BRA $06    [$EE61]

$91:EE5B A9 01 00    LDA #$0001
$91:EE5E 8D 52 0A    STA $0A52  [$7E:0A52]
...
;;; $EE69:  ;;;
{
$91:EE69 9C 52 0A    STZ $0A52  [$7E:0A52]
...
$91:EF13 8D D0 0A    STA $0AD0  [$7E:0AD0]  ;} $0AD0 = 1
$91:EF16 9C CE 0A    STZ $0ACE  [$7E:0ACE]  ; $0ACE = 0
...
;;; $EF4F:  ;;;
{
$91:EF4F 22 95 BD 9B JSL $9BBD95[$9B:BD95]
}
...
;;; $EFBC:  ;;;
{
$91:EFBC 22 EB BE 9B JSL $9BBEEB[$9B:BEEB]
$91:EFC0 4C 53 EF    JMP $EF53  [$91:EF53]
}
...
$91:EFCA 0A          ASL A                  ;} Execute [$EFD0 + [$0DC6] * 2]
$91:EFCB AA          TAX                    ;|
...
$91:F019 C9 04 00    CMP #$0004             ;} If [$0DC7] = 4:
$91:F01C D0 04       BNE $04    [$F022]     ;/
$91:F01E 20 D3 F1    JSR $F1D3  [$91:F1D3]  ; Execute $F1D3
$91:F021 60          RTS                    ; Return

$91:F022 0A          ASL A                  ;\
$91:F023 AA          TAX                    ;} Execute [$F03A + [$0DC7] * 2]
...
$91:F036 20 D3 F1    JSR $F1D3  [$91:F1D3]  ; Execute $F1D3
$91:F039 60          RTS
...
$91:F1E2 9C 36 0B    STZ $0B36  [$7E:0B36]  ; Samus Y direction = 0
$91:F1E5 9C 38 0B    STZ $0B38  [$7E:0B38]  ; $0B38 = 0
$91:F1E8 9C 20 0B    STZ $0B20  [$7E:0B20]  ; $0B20 = 0
$91:F1EB 60          RTS
}
...
;;; $F245:  ;;;
{
$91:F245 9C 20 0B    STZ $0B20  [$7E:0B20]  ; $0B20 = 0
...
$91:F265 9C 20 0B    STZ $0B20  [$7E:0B20]
...
$91:F282 C9 03 00    CMP #$0003
$91:F285 30 39       BMI $39    [$F2C0]
$91:F287 A9 01 06    LDA #$0601
$91:F28A 8D 20 0B    STA $0B20  [$7E:0B20]
...
$91:F2A6 8D 20 0B    STA $0B20  [$7E:0B20]
...
;;; $F2C0:  ;;;
{
$91:F2C0 9C 20 0B    STZ $0B20  [$7E:0B20]
...
;;; $F2CE:  ;;;
{
$91:F2CE 9C 20 0B    STZ $0B20  [$7E:0B20]
$91:F2D1 18          CLC
$91:F2D2 60          RTS
}
...
$91:F2D6 9C CE 0D    STZ $0DCE  [$7E:0DCE]  ; $0DCE = 0
...
$91:F2F3 F0 23       BEQ $23    [$F318]     ;} If [$0DCE] = 0: return
...
;;; $F3A5: Handle grapple wall jump transition ;;;
{
; $0A32 = 6
...
;;; $F404:  ;;;
{
; If 0A1C isn't new, CLC and RTL.
; If it is, JSR $FDAE (check pose size),
; JSL 91:F433(check pose changes),
; JSL 91:FBBB(check movement type changes),
; JSL 91:FB08(handle animation frame),
...
$91:F416 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
;;; $F433:  ;;;
{
; Handle change of pose I guess, or initialise new pose?
$91:F433 08          PHP
$91:F434 8B          PHB
$91:F435 4B          PHK                    ;\
...
$91:F4E1 0A          ASL A                  ;|
$91:F4E2 AA          TAX                    ;|
$91:F4E3 BD 2C B6    LDA $B62C,x[$91:B63C]  ;} If direction shots are fired != up: return
...
$91:F4F5 0A          ASL A                  ;|
$91:F4F6 AA          TAX                    ;|
$91:F4F7 BD 2C B6    LDA $B62C,x[$91:B634]  ;} If previous direction shots are fired != up: return
...
$91:F507 8D 9A 0A    STA $0A9A  [$7E:0A9A]  ;} $0A9A = 1
...
;;; $F543:  ;;;
{
; If current pose is in a checklist,
; put Samus in superjump pose and JSL 90:CFFA,
; and move Samus up a pixel if she wasn't jumping previously
; (Stores new Y position to 0B14 also, unknown use).
; If Samus jumped and aimed up while standing and aiming up, sets 0A9A to 1.
; Also has stuff for shooting,
; triggers firing when Samus has charge and presses fire while spinjumping
$91:F543 AD 1C 0A    LDA $0A1C  [$7E:0A1C]
$91:F546 C9 4E 00    CMP #$004E
$91:F549 F0 26       BEQ $26    [$F571]
$91:F54B C9 4D 00    CMP #$004D
$91:F54E F0 14       BEQ $14    [$F564]
$91:F550 C9 15 00    CMP #$0015
$91:F553 F0 0F       BEQ $0F    [$F564]
$91:F555 C9 16 00    CMP #$0016
$91:F558 F0 17       BEQ $17    [$F571]
$91:F55A C9 6A 00    CMP #$006A
$91:F55D F0 12       BEQ $12    [$F571]
$91:F55F C9 69 00    CMP #$0069
$91:F562 D0 36       BNE $36    [$F59A]

$91:F564 AD 68 0A    LDA $0A68  [$7E:0A68]
$91:F567 F0 31       BEQ $31    [$F59A]
$91:F569 A9 C7 00    LDA #$00C7
$91:F56C 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:F56F 80 0B       BRA $0B    [$F57C]

$91:F571 AD 68 0A    LDA $0A68  [$7E:0A68]
$91:F574 F0 24       BEQ $24    [$F59A]
$91:F576 A9 C8 00    LDA #$00C8
$91:F579 8D 1C 0A    STA $0A1C  [$7E:0A1C]

$91:F57C 22 FA CF 90 JSL $90CFFA[$90:CFFA]
$91:F580 AD 23 0A    LDA $0A23  [$7E:0A23]
$91:F583 29 FF 00    AND #$00FF
$91:F586 C9 02 00    CMP #$0002
$91:F589 D0 0D       BNE $0D    [$F598]
$91:F58B AD FA 0A    LDA $0AFA  [$7E:0AFA]
$91:F58E 38          SEC
$91:F58F E9 01 00    SBC #$0001
$91:F592 8D FA 0A    STA $0AFA  [$7E:0AFA]
$91:F595 8D 14 0B    STA $0B14  [$7E:0B14]
...
$91:F7B6 C9 00 04    CMP #$0400
$91:F7B9 30 0F       BMI $0F    [$F7CA]
$91:F7BB A9 B4 00    LDA #$00B4
$91:F7BE 8D 68 0A    STA $0A68  [$7E:0A68]
$91:F7C1 A9 01 00    LDA #$0001             ;\
$91:F7C4 8D CC 0A    STA $0ACC  [$7E:0ACC]  ;} $0ACC = 1
$91:F7C7 9C CE 0A    STZ $0ACE  [$7E:0ACE]
...
$91:F908 2C B4 09    BIT $09B4  [$7E:09B4]  ;} If not pressing jump: go to BRANCH_F91D
$91:F90B F0 10       BEQ $10    [$F91D]     ;/
$91:F90D BD EA F9    LDA $F9EA,x[$91:F9F1]
$91:F910 29 FF 00    AND #$00FF
$91:F913 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:F916 80 19       BRA $19    [$F931]

$91:F918 C9 05 00    CMP #$0005
$91:F91B F0 0B       BEQ $0B    [$F928]

; BRANCH_F91D
$91:F91D BD C2 F9    LDA $F9C2,x[$91:F9C4]
$91:F920 29 FF 00    AND #$00FF
$91:F923 8D 1C 0A    STA $0A1C  [$7E:0A1C]
$91:F926 80 09       BRA $09    [$F931]

$91:F928 BD CC F9    LDA $F9CC,x[$91:F9CE]
$91:F92B 29 FF 00    AND #$00FF
...
$91:FD21 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
$91:FD8C 22 33 F4 91 JSL $91F433[$91:F433]  ; Execute $91:F433
...
$91:FE01 8D D0 0D    STA $0DD0  [$7E:0DD0]  ; $0DD0 = [A]
$91:FE04 AA          TAX                    ;\
$91:FE05 F0 06       BEQ $06    [$FE0D]     ;} If [$0DD0] != 0: (collision detected)
...
$91:FE23 8D D0 0D    STA $0DD0  [$7E:0DD0]  ; $0DD0 = [A]
$91:FE26 AA          TAX                    ;\
$91:FE27 F0 09       BEQ $09    [$FE32]     ;} If [$0DD0] != 0: (collision detected)
...
$91:FEC8 8D D0 0D    STA $0DD0  [$7E:0DD0]  ; $0DD0 = [A]
$91:FECB AA          TAX                    ;\
$91:FECC D0 0B       BNE $0B    [$FED9]     ;} If [$0DD0] = 0: (no collision detected)
...
$91:FF09 8D D0 0D    STA $0DD0  [$7E:0DD0]  ; $0DD0 = [A]
$91:FF0C AA          TAX                    ;\
$91:FF0D D0 0B       BNE $0B    [$FF1A]     ;} If [$0DD0] = 0: (no collision detected)

...
$94:8365 4A          LSR A                  ;|
$94:8366 4A          LSR A                  ;|
$94:8367 4A          LSR A                  ;} Calculate Samus top boundary row block index
$94:8368 4A          LSR A                  ;|
...
$94:83C4 4A          LSR A                  ;|
$94:83C5 4A          LSR A                  ;|
$94:83C6 4A          LSR A                  ;} Calculate Samus top boundary row block index
$94:83C7 4A          LSR A                  ;|
...
$94:8616 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$94:8619 4A          LSR A
$94:861A 4A          LSR A
$94:861B 4A          LSR A
$94:861C 4A          LSR A
...
$94:864C 30 05       BMI $05    [$8653]
$94:864E AD FA 0A    LDA $0AFA  [$7E:0AFA]
$94:8651 80 06       BRA $06    [$8659]

$94:8653 AD FA 0A    LDA $0AFA  [$7E:0AFA]
$94:8656 49 0F 00    EOR #$000F
...
$94:8667 38          SEC
$94:8668 ED D4 0D    SBC $0DD4  [$7E:0DD4]
$94:866B 3A          DEC A
$94:866C F0 02       BEQ $02    [$8670]
$94:866E 10 0E       BPL $0E    [$867E]

$94:8670 18          CLC
$94:8671 65 12       ADC $12    [$7E:0012]
$94:8673 10 03       BPL $03    [$8678]
$94:8675 A9 00 00    LDA #$0000

$94:8678 85 12       STA $12    [$7E:0012]
$94:867A 64 14       STZ $14    [$7E:0014]
$94:867C 38          SEC
$94:867D 60          RTS
...
$94:8693 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$94:8696 4A          LSR A
$94:8697 4A          LSR A
$94:8698 4A          LSR A
$94:8699 4A          LSR A
...
$94:86C7 30 05       BMI $05    [$86CE]
$94:86C9 AD FA 0A    LDA $0AFA  [$7E:0AFA]
$94:86CC 80 06       BRA $06    [$86D4]

$94:86CE AD FA 0A    LDA $0AFA  [$7E:0AFA]
$94:86D1 49 0F 00    EOR #$000F
...
$94:86E2 38          SEC
$94:86E3 ED D4 0D    SBC $0DD4  [$7E:0DD4]
$94:86E6 3A          DEC A
$94:86E7 F0 02       BEQ $02    [$86EB]
$94:86E9 10 0E       BPL $0E    [$86F9]

$94:86EB 18          CLC
$94:86EC 65 12       ADC $12    [$7E:0012]
$94:86EE 10 03       BPL $03    [$86F3]
$94:86F0 A9 00 00    LDA #$0000

$94:86F3 85 12       STA $12    [$7E:0012]
$94:86F5 64 14       STZ $14    [$7E:0014]
$94:86F7 38          SEC
$94:86F8 60          RTS
...
$94:8790 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$94:8793 4A          LSR A
$94:8794 4A          LSR A
$94:8795 4A          LSR A
$94:8796 4A          LSR A
...
$94:87BD 30 33       BMI $33    [$87F2]
$94:87BF 0A          ASL A
$94:87C0 30 05       BMI $05    [$87C7]
$94:87C2 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$94:87C5 80 06       BRA $06    [$87CD]

$94:87C7 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$94:87CA 49 0F 00    EOR #$000F
...
$94:87DB 38          SEC
$94:87DC ED D4 0D    SBC $0DD4  [$7E:0DD4]
$94:87DF 3A          DEC A
$94:87E0 F0 02       BEQ $02    [$87E4]
$94:87E2 10 0E       BPL $0E    [$87F2]

$94:87E4 18          CLC
$94:87E5 65 12       ADC $12    [$7E:0012]
$94:87E7 10 03       BPL $03    [$87EC]
$94:87E9 A9 00 00    LDA #$0000

$94:87EC 85 12       STA $12    [$7E:0012]
$94:87EE 64 14       STZ $14    [$7E:0014]
$94:87F0 38          SEC
$94:87F1 60          RTS
...
$94:8FD4 4C D6 84    JMP $84D6  [$94:84D6]  ; Go to block collision reaction - horizontal - slope - non-square
                                            
$94:8FD7 4C 2B 8D    JMP $8D2B  [$94:8D2B]  ; Go to block collision reaction - horizontal - slope - square
}


;;; $8FDA: Samus block collision reaction - vertical - slope ;;;
{
$94:8FDA AE C4 0D    LDX $0DC4  [$7E:0DC4]  ;\
$94:8FDD BF 02 64 7F LDA $7F6402,x[$7F:648B];|
$94:8FE1 29 1F 00    AND #$001F             ;} If [block BTS] & 1Fh >= 5:
$94:8FE4 C9 05 00    CMP #$0005             ;|
...
$94:8FF0 4C FE 86    JMP $86FE  [$94:86FE]  ; Go to block collision reaction - vertical - slope - non-square

$94:8FF3 4C BD 8D    JMP $8DBD  [$94:8DBD]  ; Go to block collision reaction - vertical - slope - square
}
...
{
; Check BTS.
; JSR $902B,BTS (8E83, 8ECF, 8F45, 8F0A, 8F45 for the rest. 10 entries, 20 bytes).
; JMP $8F49 when done (normal solid)
$94:904B AE C4 0D    LDX $0DC4  [$7E:0DC4]
$94:904E BF 02 64 7F LDA $7F6402,x[$7F:6691]
$94:9052 0A          ASL A
$94:9053 29 FF 01    AND #$01FF
$94:9056 AA          TAX
$94:9057 FC 2B 90    JSR ($902B,x)[$94:8ECF]
$94:905A 4C 49 8F    JMP $8F49  [$94:8F49]
}
...
$94:9076 29 00 FF    AND #$FF00             ;} If current BTS < 80h:
$94:9079 EB          XBA                    ;|
...
$94:90D2 29 00 FF    AND #$FF00
$94:90D5 EB          XBA
$94:90D6 30 0F       BMI $0F    [$90E7]
$94:90D8 0A          ASL A
$94:90D9 AA          TAX
$94:90DA BD 39 91    LDA $9139,x[$94:91C3]
$94:90DD 22 E7 84 84 JSL $8484E7[$84:84E7]
$94:90E1 90 03       BCC $03    [$90E6]
$94:90E3 4C 49 8F    JMP $8F49  [$94:8F49]
...
$94:90FC 90 03       BCC $03    [$9101]
$94:90FE 4C 49 8F    JMP $8F49  [$94:8F49]
...
$94:9300 29 00 FF    AND #$FF00
$94:9303 EB          XBA
$94:9304 30 0B       BMI $0B    [$9311]
$94:9306 0A          ASL A
$94:9307 AA          TAX
$94:9308 BD 6B 93    LDA $936B,x
...
$94:938E 8D 9C 09    STA $099C  [$7E:099C]  ;} Set door transition function pointer
...
$94:93D1 8D 9C 09    STA $099C  [$7E:099C]  ;} Set door transition function pointer
...
;; Returns:
;;     Carry: Set if collision, clear otherwise
;;     $12: If carry set: space to move Samus (0 if Samus top/bottom boundary is inside the block)
$94:952C DA          PHX
$94:952D 8A          TXA                    ;\
...
$94:958D 8A          TXA                    ;\
$94:958E 18          CLC                    ;|
$94:958F 6D A5 07    ADC $07A5  [$7E:07A5]  ;} X += [room width in blocks] * 2
...
$94:97D3 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:97D6 60          RTS
}
...
$94:98A8 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:98AB 60          RTS
}
...
$94:98DF 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:98E2 60          RTS
}
...
$94:98E6 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:98E9 60          RTS
}
...
$94:990C 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:990F 60          RTS
}
...
$94:9932 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:9935 60          RTS
}
...
$94:9942 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:9945 60          RTS
}
...
$94:9952 8D 6C 0A    STA $0A6C  [$7E:0A6C]  ;} $0A6C = $9F55
$94:9955 60          RTS
}
...
$94:9CE9 20 6A A0    JSR $A06A  [$94:A06A]
$94:9CEC 80 03       BRA $03    [$9CF1]

$94:9CEE 20 F4 9C    JSR $9CF4  [$94:9CF4]
...
$94:9D6C 4C 43 A5    JMP $A543  [$94:A543]
...
$94:9D8E 0A          ASL A
$94:9D8F A8          TAY
$94:9D90 AD 9F 07    LDA $079F  [$7F:079F]
$94:9D93 0A          ASL A
$94:9D94 AA          TAX
$94:9D95 BD 44 9E    LDA $9E44,x
$94:9D98 85 12       STA $12    [$7F:0012]
...
; Region dependent BTS for shotblock only
...
$94:A10F 5A          PHY
$94:A110 20 52 A0    JSR $A052  [$94:A052]
$94:A113 7A          PLY
$94:A114 E8          INX
$94:A115 E8          INX
$94:A116 88          DEY
...
$94:A135 5A          PHY
$94:A136 20 52 A0    JSR $A052  [$94:A052]
$94:A139 7A          PLY
$94:A13A 8A          TXA
$94:A13B 18          CLC
...
{
; Go to square collision (A66A) or slope collision (A543)
$94:A147 AE C4 0D    LDX $0DC4  [$7E:0DC4]  ;\
$94:A14A BF 02 64 7F LDA $7F6402,x[$7F:6CE9];} A = current BTS & 1Fh
$94:A14E 29 1F 00    AND #$001F             ;/
$94:A151 C9 05 00    CMP #$0005             ;\
$94:A154 90 03       BCC $03    [$A159]     ;} If A >= 5:
$94:A156 4C 43 A5    JMP $A543  [$94:A543]  ; Jump to $A543

$94:A159 4C 6A A6    JMP $A66A  [$94:A66A]  ; Else (A < 5): Jump to $A66A (square)
}
...
{
; Go to square collision (A71A) or slope collision (A569)
$94:A15E AE C4 0D    LDX $0DC4  [$7E:0DC4]  ;\
$94:A161 BF 02 64 7F LDA $7F6402,x[$7F:6AA5];} A = current BTS & 1Fh
$94:A165 29 1F 00    AND #$001F             ;/
$94:A168 C9 05 00    CMP #$0005             ;\
$94:A16B 90 03       BCC $03    [$A170]     ;} If A >= 5:
$94:A16D 4C 69 A5    JMP $A569  [$94:A569]  ; Jump to $A569

$94:A170 4C 1A A7    JMP $A71A  [$94:A71A]  ; Else (A < 5): Jump to $A71A (square)
}
...
$94:A1B8 B0 1B       BCS $1B    [$A1D5]
$94:A1BA DA          PHX
$94:A1BB 8E C4 0D    STX $0DC4  [$7E:0DC4]
$94:A1BE 4E C4 0D    LSR $0DC4  [$7E:0DC4]
...
$94:A1D0 90 02       BCC $02    [$A1D4]
$94:A1D2 C6 28       DEC $28    [$7E:0028]
...
$94:A272 85 16       STA $16    [$7E:0016]
$94:A274 BD 64 0B    LDA $0B64,x[$7E:0B64]
$94:A277 65 14       ADC $14    [$7E:0014]
$94:A279 9D 64 0B    STA $0B64,x[$7E:0B64]
$94:A27C 85 18       STA $18    [$7E:0018]
$94:A27E 24 14       BIT $14    [$7E:0014]
$94:A280 30 07       BMI $07    [$A289]
$94:A282 18          CLC
$94:A283 7D B4 0B    ADC $0BB4,x[$7E:0BB4]
$94:A286 3A          DEC A
$94:A287 80 04       BRA $04    [$A28D]

$94:A289 38          SEC
$94:A28A FD B4 0B    SBC $0BB4,x[$7E:0BB4]
...
$94:A29B C9 10 00    CMP #$0010
$94:A29E 10 1E       BPL $1E    [$A2BE]
$94:A2A0 A5 1D       LDA $1D    [$7E:001D]
$94:A2A2 29 FF 00    AND #$00FF
$94:A2A5 CD A9 07    CMP $07A9  [$7E:07A9]
$94:A2A8 10 14       BPL $14    [$A2BE]

; LOOP
$94:A2AA 20 B5 A1    JSR $A1B5  [$94:A1B5]
$94:A2AD 8A          TXA
$94:A2AE 18          CLC
$94:A2AF 6D A5 07    ADC $07A5  [$7E:07A5]
$94:A2B2 6D A5 07    ADC $07A5  [$7E:07A5]
$94:A2B5 AA          TAX
$94:A2B6 C6 26       DEC $26    [$7E:0026]
$94:A2B8 10 F0       BPL $F0    [$A2AA]
$94:A2BA A5 28       LDA $28    [$7E:0028]
$94:A2BC 30 04       BMI $04    [$A2C2]
...
$94:A2C2 FA          PLX
$94:A2C3 22 06 AE 90 JSL $90AE06[$90:AE06]
$94:A2C7 AB          PLB
$94:A2C8 38          SEC
$94:A2C9 6B          RTL
}
...
$94:A389 85 16       STA $16    [$7E:0016]
$94:A38B BD 64 0B    LDA $0B64,x[$7E:0B64]
$94:A38E 65 14       ADC $14    [$7E:0014]
$94:A390 9D 64 0B    STA $0B64,x[$7E:0B64]
$94:A393 85 18       STA $18    [$7E:0018]
$94:A395 24 14       BIT $14    [$7E:0014]
$94:A397 30 07       BMI $07    [$A3A0]
$94:A399 18          CLC
$94:A39A 7D B4 0B    ADC $0BB4,x[$7E:0BB6]
$94:A39D 3A          DEC A
$94:A39E 80 04       BRA $04    [$A3A4]

$94:A3A0 38          SEC
$94:A3A1 FD B4 0B    SBC $0BB4,x[$7E:0BB4]
...
;;; $A46F:  ;;;
{
; (Super) missile (only?) horizontal(?) collision detection
$94:A46F 8B          PHB
$94:A470 DA          PHX
$94:A471 4B          PHK
$94:A472 AB          PLB
...
;;; $A543: Block shot reaction - vertical - slope - non-square ;;;
{
...
;;; $A569: Block shot reaction - horizontal - slope - non-square ;;;
{
...
;;; $A601:  ;;;
{
$94:A601             dw 9D59, 9D5D, 9D59, 9D59, 9D5B, 9411, 9D59, 9D59, 9D5B, 9D5B, 9D5B, 9D5B, 9D5B, 9447, 9D5B, 9D5B
}
...
$94:A62A 85 1A       STA $1A    [$7E:001A]
$94:A62C BD 78 0B    LDA $0B78,x
$94:A62F 85 1C       STA $1C    [$7E:001C]
$94:A631 64 1E       STZ $1E    [$7E:001E]
$94:A633 64 20       STZ $20    [$7E:0020]
$94:A635 9C C4 0D    STZ $0DC4  [$7E:0DC4]
$94:A638 DA          PHX
$94:A639 20 1D 9C    JSR $9C1D  [$94:9C1D]  ; Calculate block at ([$1A], [$1C])
$94:A63C FA          PLX
$94:A63D BD 7C 0C    LDA $0C7C,x
$94:A640 D0 05       BNE $05    [$A647]
$94:A642 20 F4 9C    JSR $9CF4  [$94:9CF4]
$94:A645 80 1B       BRA $1B    [$A662]

$94:A647 AD C4 0D    LDA $0DC4  [$7E:0DC4]
$94:A64A C9 FF FF    CMP #$FFFF
...
;;; $A66A: Block shot reaction - vertical - slope - square ;;;
{
$94:A66A 0A          ASL A
$94:A66B 0A          ASL A
...
;;; $A71A: Block shot reaction - horizontal - slope - square ;;;
{
$94:A71A 0A          ASL A
$94:A71B 0A          ASL A
...
;;; $AB90:  ;;;
{
$94:AB90             dw AA9A, AA9C, AA9E, AA9A, AA9A, 9411, AA9A, AA9A, AA9C, AA9C, AB17, AA9C, AA9C, 9447, AA9C, AA9C
}
...
$94:ABE9 8D 98 0D    STA $0D98  [$7E:0D98]
...
$94:AC01 18          CLC
$94:AC02 69 08 00    ADC #$0008
$94:AC05 8D 84 0D    STA $0D84  [$7E:0D84]
$94:AC08 CE 98 0D    DEC $0D98  [$7E:0D98]
$94:AC0B D0 E9       BNE $E9    [$ABF6]
$94:AC0D 18          CLC
$94:AC0E 60          RTS
...
$94:AC17 0A          ASL A                  ;} $0D82 = [grapple beam end angle] * 2
...
$94:AC37 D0 03       BNE $03    [$AC3C]
$94:AC39 4C FB AC    JMP $ACFB  [$94:ACFB]

$94:AC3C 30 03       BMI $03    [$AC41]
$94:AC3E 4C 9E AC    JMP $AC9E  [$94:AC9E]

$94:AC41 AD FE 0C    LDA $0CFE  [$7E:0CFE]
$94:AC44 18          CLC
$94:AC45 6D 00 0D    ADC $0D00  [$7E:0D00]
$94:AC48 C9 08 00    CMP #$0008
$94:AC4B B0 06       BCS $06    [$AC53]
$94:AC4D 9C 00 0D    STZ $0D00  [$7E:0D00]
$94:AC50 A9 08 00    LDA #$0008

$94:AC53 8D 8C 0D    STA $0D8C  [$7E:0D8C]
$94:AC56 A9 08 00    LDA #$0008
$94:AC59 8D 8E 0D    STA $0D8E  [$7E:0D8E]
$94:AC5C AD FB 0C    LDA $0CFB  [$7E:0CFB]
$94:AC5F 29 FF 00    AND #$00FF
$94:AC62 0A          ASL A
$94:AC63 8D 82 0D    STA $0D82  [$7E:0D82]
$94:AC66 AD FE 0C    LDA $0CFE  [$7E:0CFE]
$94:AC69 CD 8C 0D    CMP $0D8C  [$7E:0D8C]
$94:AC6C F0 1E       BEQ $1E    [$AC8C]

$94:AC6E 8D 8A 0D    STA $0D8A  [$7E:0D8A]
$94:AC71 3A          DEC A
$94:AC72 18          CLC
...
$94:AC84 AD 8A 0D    LDA $0D8A  [$7E:0D8A]
$94:AC87 CD 8C 0D    CMP $0D8C  [$7E:0D8C]
$94:AC8A D0 E2       BNE $E2    [$AC6E]

$94:AC8C AD 8C 0D    LDA $0D8C  [$7E:0D8C]
$94:AC8F 8D FE 0C    STA $0CFE  [$7E:0CFE]
$94:AC92 AB          PLB
$94:AC93 18          CLC
$94:AC94 6B          RTL

$94:AC95 AD 8A 0D    LDA $0D8A  [$7E:0D8A]
$94:AC98 8D FE 0C    STA $0CFE  [$7E:0CFE]
$94:AC9B AB          PLB
$94:AC9C 38          SEC
$94:AC9D 6B          RTL
...
$94:ACE1 AD 8A 0D    LDA $0D8A  [$7E:0D8A]
$94:ACE4 CD 8C 0D    CMP $0D8C  [$7E:0D8C]
$94:ACE7 D0 E2       BNE $E2    [$ACCB]

$94:ACE9 AD 8C 0D    LDA $0D8C  [$7E:0D8C]
$94:ACEC 8D FE 0C    STA $0CFE  [$7E:0CFE]
$94:ACEF AB          PLB
$94:ACF0 18          CLC
$94:ACF1 6B          RTL
...
;;; $ACFE:  ;;;
{
; Handles all movement and collision detection for Samuss grappling
; JSR $AB90,X (X = 2*blocktype) is the actual collision code
$94:ACFE 8B          PHB
$94:ACFF 4B          PHK
$94:AD00 AB          PLB
$94:AD01 A0 00 01    LDY #$0100
$94:AD04 AD F4 0C    LDA $0CF4  [$7E:0CF4]
$94:AD07 89 01 00    BIT #$0001
$94:AD0A F0 03       BEQ $03    [$AD0F]
$94:AD0C A0 A0 00    LDY #$00A0

$94:AD0F AD 26 0D    LDA $0D26  [$7E:0D26]
$94:AD12 18          CLC
$94:AD13 6D 2E 0D    ADC $0D2E  [$7E:0D2E]
$94:AD16 10 17       BPL $17    [$AD2F]
$94:AD18 49 FF FF    EOR #$FFFF
$94:AD1B 1A          INC A
$94:AD1C 22 D6 82 80 JSL $8082D6[$80:82D6]
$94:AD20 AD F2 05    LDA $05F2  [$7E:05F2]
$94:AD23 49 FF FF    EOR #$FFFF
$94:AD26 1A          INC A
$94:AD27 F0 14       BEQ $14    [$AD3D]
$94:AD29 8D 9C 0D    STA $0D9C  [$7E:0D9C]
$94:AD2C 4C 10 AE    JMP $AE10  [$94:AE10]

$94:AD2F 22 D6 82 80 JSL $8082D6[$80:82D6]
$94:AD33 AD F2 05    LDA $05F2  [$7E:05F2]
$94:AD36 F0 05       BEQ $05    [$AD3D]
$94:AD38 8D 9C 0D    STA $0D9C  [$7E:0D9C]
$94:AD3B 80 03       BRA $03    [$AD40]
...
$94:ADCB F0 05       BEQ $05    [$ADD2]
$94:ADCD C9 05 00    CMP #$0005
$94:ADD0 D0 17       BNE $17    [$ADE9]

$94:ADD2 AD FE 0C    LDA $0CFE  [$7E:0CFE]
$94:ADD5 C9 08 00    CMP #$0008
$94:ADD8 D0 0F       BNE $0F    [$ADE9]
$94:ADDA A9 00 80    LDA #$8000
$94:ADDD 0C 36 0D    TSB $0D36  [$7E:0D36]
$94:ADE0 9C 26 0D    STZ $0D26  [$7E:0D26]
$94:ADE3 9C 2E 0D    STZ $0D2E  [$7E:0D2E]
$94:ADE6 AB          PLB
$94:ADE7 38          SEC
$94:ADE8 6B          RTL

$94:ADE9 A9 10 00    LDA #$0010
$94:ADEC 8D 30 0D    STA $0D30  [$7E:0D30]
...
$94:AE9B F0 05       BEQ $05    [$AEA2]
$94:AE9D C9 05 00    CMP #$0005
$94:AEA0 D0 17       BNE $17    [$AEB9]

$94:AEA2 AD FE 0C    LDA $0CFE  [$7E:0CFE]
$94:AEA5 C9 08 00    CMP #$0008
$94:AEA8 D0 0F       BNE $0F    [$AEB9]
$94:AEAA A9 00 80    LDA #$8000
$94:AEAD 0C 36 0D    TSB $0D36  [$7E:0D36]
$94:AEB0 9C 26 0D    STZ $0D26  [$7E:0D26]
$94:AEB3 9C 2E 0D    STZ $0D2E  [$7E:0D2E]
$94:AEB6 AB          PLB
$94:AEB7 38          SEC
$94:AEB8 6B          RTL

$94:AEB9 A9 10 00    LDA #$0010
$94:AEBC 8D 30 0D    STA $0D30  [$7E:0D30]
...
$94:AEE6 4D 26 0D    EOR $0D26  [$7E:0D26]
$94:AEE9 30 1A       BMI $1A    [$AF05]
$94:AEEB EE 38 0D    INC $0D38  [$7E:0D38]
$94:AEEE AD 38 0D    LDA $0D38  [$7E:0D38]
$94:AEF1 C9 20 00    CMP #$0020
$94:AEF4 D0 06       BNE $06    [$AEFC]
$94:AEF6 A9 C5 C8    LDA #$C8C5
$94:AEF9 8D 32 0D    STA $0D32  [$7E:0D32]

$94:AEFC 9C 26 0D    STZ $0D26  [$7E:0D26]
$94:AEFF 9C 2E 0D    STZ $0D2E  [$7E:0D2E]
$94:AF02 AB          PLB
$94:AF03 38          SEC
$94:AF04 6B          RTL

$94:AF05 9C 38 0D    STZ $0D38  [$7E:0D38]
$94:AF08 AB          PLB
$94:AF09 38          SEC
$94:AF0A 6B          RTL
}
...
$94:AF74 B0 08       BCS $08    [$AF7E]
$94:AF76 CE 98 0D    DEC $0D98  [$7E:0D98]
$94:AF79 10 BB       BPL $BB    [$AF36]
$94:AF7B AB          PLB
$94:AF7C 18          CLC
$94:AF7D 6B          RTL

$94:AF7E A9 C5 C8    LDA #$C8C5
$94:AF81 8D 32 0D    STA $0D32  [$7E:0D32]
$94:AF84 AB          PLB
$94:AF85 38          SEC
$94:AF86 6B          RTL
}
...
;;; $AFBA: Handle grapple beam graphics ;;;
{
...
$94:B0FC 38          SEC
$94:B0FD ED 15 09    SBC $0915  [$7E:0915]
$94:B100 89 00 FF    BIT #$FF00
$94:B103 D0 45       BNE $45    [$B14A]
$94:B105 AE 90 05    LDX $0590  [$7E:0590]
$94:B108 18          CLC
...
$94:B13F 9D 72 03    STA $0372,x[$7E:039E]
$94:B142 8A          TXA
$94:B143 18          CLC
$94:B144 69 04 00    ADC #$0004

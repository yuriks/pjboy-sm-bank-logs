...
$82:8774             dw 91F8, 896A, 0001, 0400, 0400, 0040, 0001, 04D3, 8925, ; Landing site
                        ...
                        9D9C, 8DC6, 0000, 0100, 0000, 00BB, FFE0, 017A, 8924, ; Charge beam
...
$82:87E2             dw A408, A36C, 0000, 0100, 0100, 008B, 0056, 01FD, 8924, ; Ice beam
                        ...
                        AF14, 967E, 0002, 0300, 0000, 008B, 004B, 03CA, 8924, ; Lava dive
...
$82:94A0 C9 08       CMP #$08               ;} If [$12] < 8: go to LOOP_WITHOUT_MAP_DATA
$82:94A2 30 E8       BMI $E8    [$948C]     ;/
$82:94A4 64 12       STZ $12    [$7E:0012]  ; $12 = 0
$82:94A6 E8          INX                    ; Increment X
$82:94A7 E0 00 01    CPX #$0100             ;\
$82:94AA 30 E0       BMI $E0    [$948C]     ;} If [X] < 100h: go to LOOP_WITHOUT_MAP_DATA
$82:94AC 28          PLP
...
$82:94C0 EB          XBA                    ;} $26 = [[$06]] << 8 | [[$06] + 1] (two map data bytes)
...
$82:94D3 EB          XBA                    ;} $28 = [[$09]] << 8 | [[$09] + 1] (two map tiles explored bytes)
...
$82:94DD A2 10 00    LDX #$0010             ; X = 10h (map bit index)
...
$82:94F1 A9 1F 00    LDA #$001F             ; A = 001Fh (blank tile)

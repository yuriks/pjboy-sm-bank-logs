...
$86:8136 10 0A       BPL $0A    [$8142]     ;} If [[Y]] is negative:
...
$86:85B4 29 1F 00    AND #$001F
$86:85B7 C9 05 00    CMP #$0005
$86:85BA B0 03       BCS $03    [$85BF]
$86:85BC 4C 76 86    JMP $8676  [$86:8676]

$86:85BF 4C 4E 87    JMP $874E  [$86:874E]
}
...
;;; $8846:  ;;;
{
$86:8846             dw 858A, 858E, 858A, 858A, 858A, 8506, 858A, 858A, 858C, 858C, 858C, 858C, 858C, 853C, 858A, 858C,
                        858A, 85AD, 858A, 858A, 858A, 8506, 858A, 858A, 858C, 858C, 858C, 858C, 858C, 853C, 858A, 858C
}
...
$86:888A 4E C4 0D    LSR $0DC4  [$7E:0DC4]
...
$86:88A2 4E C4 0D    LSR $0DC4  [$7E:0DC4]
...
;;; $88B6: Enemy projectile / block collision - horizontal ;;;
{
$86:88B6 DA          PHX
...
$86:88E5 3A          DEC A                  ;} $1A = ([enemy projectile Y position] + [$1E] - 1) / 10h - ([enemy projectile Y position] - [$1E]) / 10h (Y block span)
$86:88E6 38          SEC                    ;|
...
$86:88EF 85 20       STA $20    [$7E:0020]  ; $20 = [$1A] (Y block span)
...
$86:88F8 4A          LSR A                  ;|
$86:88F9 4A          LSR A                  ;|
$86:88FA 4A          LSR A                  ;} Calculate ([enemy projectile Y position] - [$1E]) / 10h * [room width]
...
$86:890B 18          CLC                    ;|
$86:890C 65 12       ADC $12    [$7E:0012]  ;} $16 = [enemy projectile $1A27] + [$12]
$86:890E 85 16       STA $16    [$7E:0016]  ;/
$86:8910 BD 4B 1A    LDA $1A4B,x[$7E:1A6D]  ;\
$86:8913 65 14       ADC $14    [$7E:0014]  ;} $18 = [enemy projectile X position] + [$14]
$86:8915 85 18       STA $18    [$7E:0018]  ;/
$86:8917 24 14       BIT $14    [$7E:0014]  ;\
$86:8919 30 06       BMI $06    [$8921]     ;} If [$14] >= 0:
$86:891B 18          CLC                    ;\
$86:891C 65 1C       ADC $1C    [$7E:001C]  ;} $22 = [$18] + [$1C] - 1
$86:891E 3A          DEC A                  ;/
$86:891F 80 03       BRA $03    [$8924]

$86:8921 38          SEC                    ;\ Else ([$14] < 0):
$86:8922 E5 1C       SBC $1C    [$7E:001C]  ;} $22 = [$18] - [$1C]
...
$86:8928 4A          LSR A                  ;|
$86:8929 4A          LSR A                  ;|
$86:892A 18          CLC                    ;} X = (([enemy projectile Y position] - [$1E]) / 10h * [room width] + [$22] / 10h) * 2
$86:892B 6D 16 42    ADC $4216  [$7E:4216]  ;|
$86:892E 0A          ASL A                  ;|
$86:892F AA          TAX                    ;/

; LOOP
$86:8930 20 86 88    JSR $8886  [$86:8886]
$86:8933 B0 1A       BCS $1A    [$894F]
$86:8935 8A          TXA
$86:8936 18          CLC
$86:8937 6D A5 07    ADC $07A5  [$7E:07A5]
$86:893A 6D A5 07    ADC $07A5  [$7E:07A5]
$86:893D AA          TAX
$86:893E C6 1A       DEC $1A    [$7E:001A]
$86:8940 10 EE       BPL $EE    [$8930]
$86:8942 FA          PLX
$86:8943 A5 16       LDA $16    [$7E:0016]
$86:8945 9D 27 1A    STA $1A27,x[$7E:1A49]
$86:8948 A5 18       LDA $18    [$7E:0018]
$86:894A 9D 4B 1A    STA $1A4B,x[$7E:1A6D]
$86:894D 18          CLC
$86:894E 60          RTS

$86:894F FA          PLX
$86:8950 9E 27 1A    STZ $1A27,x[$7E:1A41]
$86:8953 A5 22       LDA $22    [$7E:0022]
$86:8955 24 14       BIT $14    [$7E:0014]
$86:8957 30 10       BMI $10    [$8969]
$86:8959 29 F0 FF    AND #$FFF0
$86:895C 38          SEC
$86:895D E5 1C       SBC $1C    [$7E:001C]
$86:895F DD 4B 1A    CMP $1A4B,x[$7E:1A5D]
...
{
$86:8A39 22 11 81 80 JSL $808111[$80:8111]
$86:8A3D AE 54 0E    LDX $0E54  [$7E:0E54]
$86:8A40 BD 7E 0F    LDA $0F7E,x
$86:8A43 18          CLC
$86:8A44 69 0C 00    ADC #$000C
$86:8A47 99 93 1A    STA $1A93,y
$86:8A4A 69 48 00    ADC #$0048
$86:8A4D 99 DF 19    STA $19DF,y
$86:8A50 BD AE 0F    LDA $0FAE,x
$86:8A53 99 DB 1A    STA $1ADB,y
$86:8A56 AD E5 05    LDA $05E5  [$7E:05E5]
$86:8A59 29 1F 00    AND #$001F
$86:8A5C 38          SEC
$86:8A5D E9 10 00    SBC #$0010
$86:8A60 18          CLC
...
$86:8A80 29 00 FF    AND #$FF00             ;} $14 = [enemy projectile $1ADB] * 100h
$86:8A83 85 14       STA $14    [$7E:0014]  ;/
$86:8A85 BD DB 1A    LDA $1ADB,x            ;\
$86:8A88 EB          XBA                    ;|
$86:8A89 10 05       BPL $05    [$8A90]     ;|
$86:8A8B 09 00 FF    ORA #$FF00             ;|
$86:8A8E 80 03       BRA $03    [$8A93]     ;} $12 = ±[enemy projectile $1ADC]
                                            ;|
...
$86:8AA9 90 03       BCC $03    [$8AAE]     ;} If [enemy projectile Y position] >= [enemy projectile $19DF]:
...
;;; $8AAF: Enemy projectile ;;;
{
; The instruction list pointer here is garbage, overwritten by init AI
...
;;; $8CA4: Instruction list - enemy projectile $8E5E/$8E6C (Draygon's wall turret projectiles / ???) ;;;
{
...
$86:8CF9 9D 03 1A    STA $1A03,x[$7E:1A25]  ;} Enemy projectile pre-instruction = $8DFF
$86:8CFC 60          RTS
}
...
$86:8D00 9D 03 1A    STA $1A03,x            ;} Enemy projectile pre-instruction = $8DCA
$86:8D03 60          RTS
}
...
$86:8D09 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:8D0C A5 14       LDA $14    [$7E:0014]
$86:8D0E 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:8D11 AD 95 19    LDA $1995  [$7E:1995]
$86:8D14 9F DC 97 7E STA $7E97DC,x[$7E:97FE]
$86:8D18 85 12       STA $12    [$7E:0012]
$86:8D1A AD 93 19    LDA $1993  [$7E:1993]
$86:8D1D 85 14       STA $14    [$7E:0014]
$86:8D1F 22 43 B6 A0 JSL $A0B643[$A0:B643]  ; ($18.$16, $1C.$1A) = co-ordinates of point on quarter circle of radius [$14] at angle [$12] * pi / 80h radians
$86:8D23 A5 16       LDA $16    [$7E:0016]
$86:8D25 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:8D28 A5 18       LDA $18    [$7E:0018]
$86:8D2A 99 FF 1A    STA $1AFF,y[$7E:1B21]
$86:8D2D A5 1A       LDA $1A    [$7E:001A]
$86:8D2F 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:8D32 A5 1C       LDA $1C    [$7E:001C]
...
;;; $8D40: Initialisation AI - enemy projectile $8E5E (Draygon's wall turret projectiles) ;;;
{
$86:8D40 5A          PHY
$86:8D41 DA          PHX
$86:8D42 20 AB E7    JSR $E7AB  [$86:E7AB]
...
$86:8D4E 99 03 1A    STA $1A03,y[$7E:1A25]
$86:8D51 FA          PLX
$86:8D52 7A          PLY
$86:8D53 60          RTS
}
...
;;; $8D5C: Enemy projectile / power bomb collision ;;;
{
$86:8D5C 5A          PHY
$86:8D5D DA          PHX
$86:8D5E AD EB 0C    LDA $0CEB  [$7E:0CEB]
$86:8D61 29 FF 00    AND #$00FF
$86:8D64 85 12       STA $12    [$7E:0012]
$86:8D66 F0 2E       BEQ $2E    [$8D96]
$86:8D68 4A          LSR A
...
$86:8D88 49 FF FF    EOR #$FFFF
$86:8D8B 1A          INC A

$86:8D8C C5 14       CMP $14    [$7E:0014]
$86:8D8E B0 06       BCS $06    [$8D96]
$86:8D90 9E 97 19    STZ $1997,x[$7E:19B7]
$86:8D93 9C 66 0A    STZ $0A66  [$7E:0A66]
...
;;; $8D99: Instruction ;;;
{
$86:8D99 20 5C 8D    JSR $8D5C  [$86:8D5C]
$86:8D9C AD 66 0A    LDA $0A66  [$7E:0A66]
$86:8D9F 1A          INC A
$86:8DA0 C9 06 00    CMP #$0006
$86:8DA3 10 24       BPL $24    [$8DC9]
$86:8DA5 8D 66 0A    STA $0A66  [$7E:0A66]
$86:8DA8 9D 23 1B    STA $1B23,x[$7E:1B45]
$86:8DAB A9 00 01    LDA #$0100
$86:8DAE 9D FF 1A    STA $1AFF,x[$7E:1B21]
$86:8DB1 A9 CA 8D    LDA #$8DCA
$86:8DB4 9D 03 1A    STA $1A03,x[$7E:1A25]
$86:8DB7 BD D7 1B    LDA $1BD7,x[$7E:1BF9]
$86:8DBA 29 FF 7F    AND #$7FFF
$86:8DBD 09 00 20    ORA #$2000
$86:8DC0 9D D7 1B    STA $1BD7,x[$7E:1BF9]
$86:8DC3 9C A8 18    STZ $18A8  [$7E:18A8]

$86:8DC6 9C AA 18    STZ $18AA  [$7E:18AA]

$86:8DC9 60          RTS
}


;;; $8DCA: Pre-instruction ;;;
{
$86:8DCA 20 5C 8D    JSR $8D5C  [$86:8D5C]
$86:8DCD AD 6E 0A    LDA $0A6E  [$7E:0A6E]
$86:8DD0 D0 1E       BNE $1E    [$8DF0]
$86:8DD2 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$86:8DD5 9D 4B 1A    STA $1A4B,x[$7E:1A6D]
$86:8DD8 BD 23 1B    LDA $1B23,x[$7E:1B45]
$86:8DDB 0A          ASL A
$86:8DDC 0A          ASL A
$86:8DDD 18          CLC
$86:8DDE 6D FA 0A    ADC $0AFA  [$7E:0AFA]
$86:8DE1 38          SEC
$86:8DE2 E9 0C 00    SBC #$000C
$86:8DE5 9D 93 1A    STA $1A93,x[$7E:1AB5]
$86:8DE8 DE FF 1A    DEC $1AFF,x[$7E:1B21]
$86:8DEB BD FF 1A    LDA $1AFF,x[$7E:1B21]
$86:8DEE D0 0E       BNE $0E    [$8DFE]

$86:8DF0 9E 97 19    STZ $1997,x[$7E:19B9]
$86:8DF3 CE 66 0A    DEC $0A66  [$7E:0A66]
$86:8DF6 AD 66 0A    LDA $0A66  [$7E:0A66]
$86:8DF9 10 03       BPL $03    [$8DFE]
...
;;; $8DFF: Pre-instruction - enemy projectile $8E5E (Draygon's wall turret projectiles) ;;;
{
$86:8DFF 20 5C 8D    JSR $8D5C  [$86:8D5C]
$86:8E02 20 3E E7    JSR $E73E  [$86:E73E]
$86:8E05 20 22 E7    JSR $E722  [$86:E722]
$86:8E08 D0 01       BNE $01    [$8E0B]
$86:8E0A 60          RTS

$86:8E0B 9E 97 19    STZ $1997,x[$7E:19B7]
$86:8E0E 60          RTS
}
...
$86:8E30 49 FF FF    EOR #$FFFF
$86:8E33 1A          INC A

$86:8E34 C9 14 00    CMP #$0014
$86:8E37 10 0D       BPL $0D    [$8E46]
$86:8E39 A9 38 8C    LDA #$8C38
$86:8E3C 9D 47 1B    STA $1B47,x[$7E:1B67]
$86:8E3F A9 01 00    LDA #$0001
$86:8E42 9D 8F 1B    STA $1B8F,x[$7E:1BAF]
$86:8E45 60          RTS

$86:8E46 20 22 E7    JSR $E722  [$86:E722]
$86:8E49 D0 01       BNE $01    [$8E4C]
$86:8E4B 60          RTS

$86:8E4C 9E 97 19    STZ $1997,x[$7E:19B9]
$86:8E4F 60          RTS
}
...
$86:8E5E             dx 8D40,8DFF,8CA4,08,08,1080,0000,E138 ; Draygon's wall turret projectiles
$86:8E6C             dx 8E7A,8E99,8CA4,08,08,7000,0000,E138
}
...
$86:8E83 99 4B 1A    STA $1A4B,y
$86:8E86 A5 14       LDA $14    [$7E:0014]
$86:8E88 99 93 1A    STA $1A93,y
$86:8E8B A9 DF 8E    LDA #$8EDF
$86:8E8E 99 47 1B    STA $1B47,y
$86:8E91 A9 01 00    LDA #$0001
$86:8E94 99 8F 1B    STA $1B8F,y
$86:8E97 FA          PLX
$86:8E98 60          RTS
}
...
$86:8EA1 AD 7E 0F    LDA $0F7E  [$7E:0F7E]
$86:8EA4 38          SEC
...
{
$86:906B 20 B6 88    JSR $88B6  [$86:88B6]
$86:906E A9 00 0A    LDA #$0A00             ;\
$86:9071 8D BB 19    STA $19BB  [$7E:19BB]  ;} Enemy projectile VRAM graphics index = 0, palette 5
...
$86:90B2 60          RTS
$86:90B3 20 B6 88    JSR $88B6  [$86:88B6]
$86:90B6 B0 05       BCS $05    [$90BD]
$86:90B8 20 7B 89    JSR $897B  [$86:897B]
...
$86:90E6 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:90E9 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:90EC 99 FF 1A    STA $1AFF,y[$7E:1B21]
$86:90EF 99 23 1B    STA $1B23,y[$7E:1B45]
$86:90F2 99 27 1A    STA $1A27,y[$7E:1A49]
...
$86:9123 DD E7 91    CMP $91E7,x[$86:9209]
...
$86:916E 9D 23 1B    STA $1B23,x[$7E:1B45]
...
$86:9181 9D 6F 1A    STA $1A6F,x[$7E:1A91]
...
$86:9195 9E 97 19    STZ $1997,x[$7E:19B9]
$86:9198 8A          TXA
$86:9199 89 02 00    BIT #$0002
...
$86:91C3             dw 0000, 0000, 0FF0, 0EE0, 0CC0, 0AA0, 0880, 0660, 0440, 0220, 0FF0, 0EE0, 0CC0, 0AA0, 0880, 0660, 0440, 0220
$86:91E7             dw 0000, 0000, FF00, EE00, CC00, AA00, 8800, 6600, 4400, 2200, FF00, EE00, CC00, AA00, 8800, 6600, 4400, 2200
$86:920B             dw 0000, 0000, 0004, 0004, 0003, 0003, 0002, 0002, 0001, 0001, 0006, 0005, 0004, 0003, 0002, 0002, 0001, 0001
}
...
{
$86:9286 DA          PHX
$86:9287 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:928A AD 93 19    LDA $1993  [$7E:1993]
$86:928D 99 4B 1A    STA $1A4B,y[$7E:1A5B]
$86:9290 A9 BB 00    LDA #$00BB
$86:9293 99 93 1A    STA $1A93,y[$7E:1AA3]
$86:9296 A9 00 00    LDA #$0000
$86:9299 99 6F 1A    STA $1A6F,y[$7E:1A7F]
$86:929C 99 27 1A    STA $1A27,y[$7E:1A37]
$86:929F A9 00 00    LDA #$0000
...
$86:92BD 20 7B 89    JSR $897B  [$86:897B]
$86:92C0 B0 0F       BCS $0F    [$92D1]
$86:92C2 BD DB 1A    LDA $1ADB,x[$7E:1AEB]
$86:92C5 18          CLC
$86:92C6 69 18 00    ADC #$0018
$86:92C9 29 FF 3F    AND #$3FFF
$86:92CC 9D DB 1A    STA $1ADB,x[$7E:1AEB]
$86:92CF 28          PLP
$86:92D0 60          RTS

$86:92D1 9E 97 19    STZ $1997,x[$7E:19A7]
$86:92D4 28          PLP
$86:92D5 60          RTS
}
...
$86:92EA 09 00 FF    ORA #$FF00             ;} Enemy projectile X position += [enemy projectile $1AB7 high]
                                            ;|
...
$86:9307 09 00 FF    ORA #$FF00             ;} Enemy projectile Y position += [enemy projectile $1ADB high]
                                            ;|
...
$86:9325 09 00 FF    ORA #$FF00             ;} Enemy projectile X position += [enemy projectile $1AB7 high]
                                            ;|
...
$86:93A1 20 7B 89    JSR $897B  [$86:897B]
...
{
$86:940E 20 B6 88    JSR $88B6  [$86:88B6]
$86:9411 B0 0B       BCS $0B    [$941E]
$86:9413 20 7B 89    JSR $897B  [$86:897B]
...
;;; $947F: Initialisation AI - enemy projectile $9650/$965E (fireball explosion centre enemy projectile) ;;;
{
...
;;; $950C: RTS. Pre-instruction - enemy projectile $9650/$965E (fireball explosion centre enemy projectile) ;;;
{
; $9650: Ridley's fireball / Mother Brain's bomb horizontal explosion - centre
; $965E: Ridley's fireball vertical explosion - centre
$86:950C 60          RTS
...
;;; $950D: Pre-instruction - enemy projectile $966C/$967A ;;;
{
$86:950D 20 11 93    JSR $9311  [$86:9311]
$86:9510 20 7B 89    JSR $897B  [$86:897B]
$86:9513 90 0C       BCC $0C    [$9521]
$86:9515 A9 74 95    LDA #$9574
$86:9518 9D 47 1B    STA $1B47,x[$7E:1B5F]
$86:951B A9 01 00    LDA #$0001
$86:951E 9D 8F 1B    STA $1B8F,x[$7E:1BA7]
...
$86:9525 20 B6 88    JSR $88B6  [$86:88B6]
$86:9528 90 0C       BCC $0C    [$9536]
$86:952A A9 74 95    LDA #$9574
$86:952D 9D 47 1B    STA $1B47,x
$86:9530 A9 01 00    LDA #$0001
$86:9533 9D 8F 1B    STA $1B8F,x
...
{
$86:9537 20 B6 88    JSR $88B6  [$86:88B6]
$86:953A 90 03       BCC $03    [$953F]
$86:953C 9E 97 19    STZ $1997,x
...
{
$86:9540 20 7B 89    JSR $897B  [$86:897B]
$86:9543 90 03       BCC $03    [$9548]
$86:9545 9E 97 19    STZ $1997,x
...
;;; $95A0: Instruction list - enemy projectile $9650 ;;;
{
...
{
$86:95BA 5A          PHY
$86:95BB 9C 95 19    STZ $1995  [$7E:1995]
$86:95BE 8A          TXA
...
$86:95C6 9C 95 19    STZ $1995  [$7E:1995]
$86:95C9 8A          TXA
...
;;; $95D3: Instruction list - enemy projectile $965E ;;;
{
...
{
$86:95ED 5A          PHY
$86:95EE 9C 95 19    STZ $1995  [$7E:1995]
$86:95F1 8A          TXA
...
$86:95F9 9C 95 19    STZ $1995  [$7E:1995]
$86:95FC 8A          TXA
...
;;; $9606: Instruction list - enemy projectile $966C/$967A/$9688/$9696 ;;;
{
...
$86:9622 DE FF 1A    DEC $1AFF,x[$7E:1B19]
$86:9625 C2 20       REP #$20
$86:9627 30 0A       BMI $0A    [$9633]
$86:9629 5A          PHY
$86:962A 8A          TXA
...
$86:967A             dx 94DC,950D,9606,06,06,5003,0000,84FC ; Ridley's fireball / Mother Brain's bomb horizontal explosion - left
$86:9688             dx 94A0,9522,9606,06,06,5003,0000,84FC ; Ridley's fireball vertical explosion - up
$86:9696             dx 94B4,9522,9606,06,06,5003,0000,84FC ; Ridley's fireball vertical explosion - down
...
$86:970B 20 7B 89    JSR $897B  [$86:897B]
...
;;; $975C: Instruction list - enemy projectile $9C29 (Phantoon destroyable flames) / shot instruction list - enemy projectile $9C37 (Phantoon starting flames) ;;;
{
...
;;; $97AC: Instruction list ;;;
{
$86:97AC             dx 0008,81C0,
                        81AB,979A   ; Go to $979A
}


;;; $97B4: Instruction list ;;;
{
$86:97B4             dx 81D5,0004,  ; Timer = 0004h
$86:97B8             dx 0001,81FC,
                        0001,8000,
                        81C6,97B8,  ; Decrement timer and go to $97B8 if non-zero
                        81D5,0004,  ; Timer = 0004h
...
$86:9813 85 12       STA $12    [$7E:0012]
$86:9815 BD 93 1A    LDA $1A93,x[$7E:1AB3]
$86:9818 85 14       STA $14    [$7E:0014]
$86:981A A9 FF E4    LDA #$E4FF
$86:981D 22 0E 92 A0 JSL $A0920E[$A0:920E]  ; Spawn enemy drops
$86:9821 FA          PLX
$86:9822 7A          PLY
$86:9823 60          RTS
}
...
$86:983D 99 27 1A    STA $1A27,y[$7E:1A49]
$86:9840 99 6F 1A    STA $1A6F,y[$7E:1A91]
$86:9843 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:9846 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:9849 AD 7A 0F    LDA $0F7A  [$7E:0F7A]
$86:984C 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:984F AD 7E 0F    LDA $0F7E  [$7E:0F7E]
$86:9852 18          CLC
$86:9853 69 20 00    ADC #$0020
$86:9856 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:9859 A9 B4 97    LDA #$97B4
$86:985C 99 47 1B    STA $1B47,y[$7E:1B69]
$86:985F B9 D7 1B    LDA $1BD7,y[$7E:1BF9]
$86:9862 29 FF 0F    AND #$0FFF
$86:9865 09 00 20    ORA #$2000
...
$86:98CA 99 6F 1A    STA $1A6F,y[$7E:1A8D]
$86:98CD 99 DB 1A    STA $1ADB,y[$7E:1AF9]
$86:98D0 AD 93 19    LDA $1993  [$7E:1993]
$86:98D3 48          PHA
$86:98D4 29 0F 00    AND #$000F
$86:98D7 AA          TAX
$86:98D8 68          PLA
...
$86:98E3 29 FF 00    AND #$00FF
$86:98E6 99 4B 1A    STA $1A4B,y[$7E:1A69]
$86:98E9 A9 28 00    LDA #$0028
$86:98EC 99 93 1A    STA $1A93,y[$7E:1AB1]
$86:98EF A9 94 9A    LDA #$9A94
$86:98F2 99 03 1A    STA $1A03,y[$7E:1A21]
$86:98F5 28          PLP
$86:98F6 60          RTS
...
;;; $9981: Pre-instruction - enemy projectile $9C37 (Phantoon starting flames) ;;;
{
$86:9981 BD DB 1A    LDA $1ADB,x[$7E:1AFD]
$86:9984 18          CLC
$86:9985 69 10 00    ADC #$0010
$86:9988 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:998B 20 7B 89    JSR $897B  [$86:897B]
$86:998E 90 2E       BCC $2E    [$99BE]
$86:9990 BD D7 1B    LDA $1BD7,x[$7E:1BF9]
$86:9993 29 FF 0F    AND #$0FFF
$86:9996 09 00 80    ORA #$8000
$86:9999 9D D7 1B    STA $1BD7,x[$7E:1BF9]
$86:999C A9 BF 99    LDA #$99BF
$86:999F 9D 03 1A    STA $1A03,x[$7E:1A25]
$86:99A2 A9 6C 97    LDA #$976C
$86:99A5 9D 47 1B    STA $1B47,x[$7E:1B69]
$86:99A8 A9 01 00    LDA #$0001
$86:99AB 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:99AE A9 08 00    LDA #$0008
$86:99B1 9D FF 1A    STA $1AFF,x[$7E:1B21]
$86:99B4 BD 93 1A    LDA $1A93,x[$7E:1AB5]
$86:99B7 18          CLC
$86:99B8 69 08 00    ADC #$0008
...
;;; $99BF:  ;;;
{
$86:99BF DE FF 1A    DEC $1AFF,x[$7E:1B21]
$86:99C2 F0 02       BEQ $02    [$99C6]
$86:99C4 10 3A       BPL $3A    [$9A00]

$86:99C6 A9 01 9A    LDA #$9A01
$86:99C9 9D 03 1A    STA $1A03,x[$7E:1A25]
$86:99CC A9 72 97    LDA #$9772
$86:99CF 9D 47 1B    STA $1B47,x[$7E:1B69]
$86:99D2 A9 01 00    LDA #$0001
$86:99D5 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:99D8 BD 93 1A    LDA $1A93,x[$7E:1AB5]
$86:99DB 38          SEC
$86:99DC E9 08 00    SBC #$0008
$86:99DF 9D 93 1A    STA $1A93,x[$7E:1AB5]
$86:99E2 A9 00 FD    LDA #$FD00
$86:99E5 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:99E8 9E FF 1A    STZ $1AFF,x[$7E:1B21]
$86:99EB AD B6 05    LDA $05B6  [$7E:05B6]
$86:99EE 89 01 00    BIT #$0001
$86:99F1 D0 07       BNE $07    [$99FA]
$86:99F3 A9 80 00    LDA #$0080
$86:99F6 9D B7 1A    STA $1AB7,x[$7E:1AD7]
$86:99F9 60          RTS

$86:99FA A9 80 FF    LDA #$FF80
$86:99FD 9D B7 1A    STA $1AB7,x[$7E:1AD9]
...
$86:9A04 18          CLC
$86:9A05 69 10 00    ADC #$0010
$86:9A08 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:9A0B 20 7B 89    JSR $897B  [$86:897B]
$86:9A0E 90 15       BCC $15    [$9A25]
$86:9A10 BD FF 1A    LDA $1AFF,x[$7E:1B21]
$86:9A13 1A          INC A
$86:9A14 9D FF 1A    STA $1AFF,x[$7E:1B21]
$86:9A17 C9 03 00    CMP #$0003
$86:9A1A 10 0F       BPL $0F    [$9A2B]
$86:9A1C 0A          ASL A
$86:9A1D A8          TAY
$86:9A1E B9 3E 9A    LDA $9A3E,y[$86:9A40]
$86:9A21 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:9A24 60          RTS

$86:9A25 20 B6 88    JSR $88B6  [$86:88B6]
$86:9A28 B0 01       BCS $01    [$9A2B]
$86:9A2A 60          RTS

$86:9A2B A9 82 97    LDA #$9782
$86:9A2E 9D 47 1B    STA $1B47,x[$7E:1B69]
$86:9A31 A9 01 00    LDA #$0001
$86:9A34 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:9A37 A9 44 9A    LDA #$9A44
$86:9A3A 9D 03 1A    STA $1A03,x[$7E:1A25]
$86:9A3D 60          RTS
...
$86:9A82 C9 00 01    CMP #$0100
$86:9A85 30 0C       BMI $0C    [$9A93]

$86:9A87 A9 F8 97    LDA #$97F8
$86:9A8A 9D 47 1B    STA $1B47,x
$86:9A8D A9 01 00    LDA #$0001
$86:9A90 9D 8F 1B    STA $1B8F,x
...
$86:9A97 F0 0E       BEQ $0E    [$9AA7]
$86:9A99 DE B7 1A    DEC $1AB7,x[$7E:1AD5]
$86:9A9C F0 02       BEQ $02    [$9AA0]
$86:9A9E 10 39       BPL $39    [$9AD9]
...
$86:9AAA 18          CLC
$86:9AAB 69 10 00    ADC #$0010
$86:9AAE 9D DB 1A    STA $1ADB,x[$7E:1AF9]
$86:9AB1 20 7B 89    JSR $897B  [$86:897B]
$86:9AB4 90 23       BCC $23    [$9AD9]
$86:9AB6 A9 AC 97    LDA #$97AC
$86:9AB9 9D 47 1B    STA $1B47,x[$7E:1B65]
$86:9ABC A9 01 00    LDA #$0001
$86:9ABF 9D 8F 1B    STA $1B8F,x[$7E:1BAD]
$86:9AC2 BD 93 1A    LDA $1A93,x[$7E:1AB1]
$86:9AC5 18          CLC
$86:9AC6 69 08 00    ADC #$0008
$86:9AC9 9D 93 1A    STA $1A93,x[$7E:1AB1]
$86:9ACC A9 44 9A    LDA #$9A44
$86:9ACF 9D 03 1A    STA $1A03,x[$7E:1A21]
...
$86:9B17 C9 00 01    CMP #$0100
$86:9B1A 30 0C       BMI $0C    [$9B28]

$86:9B1C A9 F8 97    LDA #$97F8
$86:9B1F 9D 47 1B    STA $1B47,x[$7E:1B5B]
$86:9B22 A9 01 00    LDA #$0001
$86:9B25 9D 8F 1B    STA $1B8F,x[$7E:1BA3]
...
$86:9B2C F0 12       BEQ $12    [$9B40]
$86:9B2E A9 41 9B    LDA #$9B41
$86:9B31 9D 03 1A    STA $1A03,x[$7E:1A25]
$86:9B34 A9 B4 00    LDA #$00B4
$86:9B37 9D B7 1A    STA $1AB7,x[$7E:1AD9]
$86:9B3A A9 30 00    LDA #$0030
$86:9B3D 9D DB 1A    STA $1ADB,x[$7E:1AFD]
...
$86:9B88 9D 4B 1A    STA $1A4B,x[$7E:1A6D]
$86:9B8B AD 7E 0F    LDA $0F7E  [$7E:0F7E]
$86:9B8E 18          CLC
$86:9B8F 69 10 00    ADC #$0010
$86:9B92 9D 93 1A    STA $1A93,x[$7E:1AB5]
$86:9B95 A9 01 00    LDA #$0001
$86:9B98 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:9B9B A9 F8 97    LDA #$97F8
$86:9B9E 9D 47 1B    STA $1B47,x[$7E:1B69]
$86:9BA1 60          RTS
}
...
$86:9BA5 DA          PHX
$86:9BA6 85 18       STA $18    [$7E:0018]
$86:9BA8 98          TYA
$86:9BA9 85 1A       STA $1A    [$7E:001A]
...
{
$86:9C89             dx 8161,9DA5,  ; Pre-instruction = $9DA5
                        0004,8D9C,
                        0004,8DA3,
                        0004,8DB9,
                        0004,8DCF,
...
{
$86:9CA3 DA          PHX
$86:9CA4 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:9CA7 BD 7A 0F    LDA $0F7A,x
$86:9CAA 18          CLC
$86:9CAB 69 10 00    ADC #$0010
$86:9CAE 99 4B 1A    STA $1A4B,y
$86:9CB1 BD 7E 0F    LDA $0F7E,x
$86:9CB4 38          SEC
$86:9CB5 E9 60 00    SBC #$0060
$86:9CB8 99 93 1A    STA $1A93,y
$86:9CBB A9 00 00    LDA #$0000
$86:9CBE 99 6F 1A    STA $1A6F,y
$86:9CC1 99 27 1A    STA $1A27,y
$86:9CC4 AD 93 19    LDA $1993  [$7E:1993]
$86:9CC7 99 B7 1A    STA $1AB7,y
$86:9CCA A9 00 FC    LDA #$FC00
$86:9CCD 99 DB 1A    STA $1ADB,y
...
{
$86:9CD8 DA          PHX
$86:9CD9 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:9CDC AD 93 19    LDA $1993  [$7E:1993]
$86:9CDF 99 4B 1A    STA $1A4B,y
$86:9CE2 A9 38 01    LDA #$0138
$86:9CE5 99 93 1A    STA $1A93,y
$86:9CE8 A9 00 00    LDA #$0000
$86:9CEB 99 6F 1A    STA $1A6F,y
$86:9CEE 99 27 1A    STA $1A27,y
$86:9CF1 A9 00 00    LDA #$0000
$86:9CF4 99 B7 1A    STA $1AB7,y
...
$86:9D10 29 3F 00    AND #$003F
$86:9D13 AA          TAX
$86:9D14 AD E5 05    LDA $05E5  [$7E:05E5]
$86:9D17 89 01 00    BIT #$0001
$86:9D1A D0 05       BNE $05    [$9D21]
$86:9D1C 8A          TXA
$86:9D1D 49 FF FF    EOR #$FFFF
$86:9D20 AA          TAX

$86:9D21 8A          TXA
$86:9D22 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:9D25 18          CLC
$86:9D26 7D 7A 0F    ADC $0F7A,x[$7E:0F7A]
$86:9D29 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:9D2C A9 B0 01    LDA #$01B0
$86:9D2F 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:9D32 A9 00 00    LDA #$0000
$86:9D35 99 6F 1A    STA $1A6F,y[$7E:1A91]
$86:9D38 99 27 1A    STA $1A27,y[$7E:1A49]
$86:9D3B AD 93 19    LDA $1993  [$7E:1993]
$86:9D3E 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:9D41 A9 00 FB    LDA #$FB00
$86:9D44 99 DB 1A    STA $1ADB,y[$7E:1AFD]
...
$86:9D59 20 B6 88    JSR $88B6  [$86:88B6]
$86:9D5C B0 26       BCS $26    [$9D84]
$86:9D5E 20 7B 89    JSR $897B  [$86:897B]
$86:9D61 B0 21       BCS $21    [$9D84]
$86:9D63 BD B7 1A    LDA $1AB7,x[$7E:1AD9]
$86:9D66 18          CLC
$86:9D67 69 08 00    ADC #$0008
$86:9D6A 9D B7 1A    STA $1AB7,x[$7E:1AD9]
$86:9D6D C9 00 01    CMP #$0100
$86:9D70 30 03       BMI $03    [$9D75]
$86:9D72 A9 00 FF    LDA #$FF00

$86:9D75 9D B7 1A    STA $1AB7,x[$7E:1AD9]
$86:9D78 BD DB 1A    LDA $1ADB,x[$7E:1AFD]
$86:9D7B 18          CLC
$86:9D7C 69 40 00    ADC #$0040
$86:9D7F 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:9D82 28          PLP
$86:9D83 60          RTS

$86:9D84 9E 97 19    STZ $1997,x[$7E:19B9]
$86:9D87 28          PLP
$86:9D88 60          RTS
}
...
$86:9D8C 20 7B 89    JSR $897B  [$86:897B]
$86:9D8F B0 0F       BCS $0F    [$9DA0]
$86:9D91 BD DB 1A    LDA $1ADB,x
$86:9D94 18          CLC
$86:9D95 69 18 00    ADC #$0018
$86:9D98 29 FF 3F    AND #$3FFF
$86:9D9B 9D DB 1A    STA $1ADB,x
$86:9D9E 28          PLP
$86:9D9F 60          RTS

$86:9DA0 9E 97 19    STZ $1997,x
$86:9DA3 28          PLP
$86:9DA4 60          RTS
}


;;; $9DA5: Pre-instruction ;;;
{
$86:9DA5 08          PHP
$86:9DA6 C2 30       REP #$30
$86:9DA8 A9 00 00    LDA #$0000
$86:9DAB 9D BB 19    STA $19BB,x
$86:9DAE 28          PLP
$86:9DAF 60          RTS
}
...
$86:9E21 20 B6 88    JSR $88B6  [$86:88B6]
$86:9E24 B0 1B       BCS $1B    [$9E41]
$86:9E26 20 7B 89    JSR $897B  [$86:897B]
...
$86:9E86 20 B6 88    JSR $88B6  [$86:88B6]
...
$86:9F01 20 7B 89    JSR $897B  [$86:897B]
$86:9F04 B0 34       BCS $34    [$9F3A]
$86:9F06 20 B6 88    JSR $88B6  [$86:88B6]
...
;;; $A197: Instruction list / shot instruction list - enemy projectile $A379 ;;;
{
; Enemy projectile $E525 points here for its pre-instruction...

$86:A197             dx 81D5,0001   ; Timer = 0001h
...
;;; $A1C1: Instruction list ;;;
{
$86:A1C1             dx 81D5,0001,  ; Timer = 0001h
                        0006,8510,
                        0006,8517,
                        0007,8528,
                        0007,853E,
...
;;; $A1EB: Instruction list ;;;
{
$86:A1EB             dx 81D5,0001,  ; Timer = 0001h
                        000B,859D,
                        000B,85BD,
                        000C,85F1,
                        000C,8639,
...
;;; $A211: Instruction list ;;;
{
$86:A211             dx 81D5,0001,  ; Timer = 0001h
                        0008,86F5,
                        0008,86FC,
                        0009,870D,
                        0009,8723,
...
;;; $A23B: Instruction list ;;;
{
$86:A23B             dx 81D5,0001,  ; Timer = 0001h
                        0006,8782,
                        0006,8789,
                        0007,879A,
                        0007,87B0,
...
;;; $A265: Instruction list ;;;
{
$86:A265             dx 81D5,0001,  ; Timer = 0001h
                        000B,880F,
                        000B,882F,
                        000C,8863,
                        000C,88AB,
...
;;; $A2A1: Initialisation AI - enemy projectile $A379 ;;;
{
$86:A2A1 08          PHP
...
$86:A2B3 AE 93 19    LDX $1993  [$7E:1993]
$86:A2B6 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$86:A2B9 18          CLC
$86:A2BA 7D D6 A2    ADC $A2D6,x[$86:A2D6]
$86:A2BD 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:A2C0 AD FA 0A    LDA $0AFA  [$7E:0AFA]
$86:A2C3 18          CLC
$86:A2C4 69 50 00    ADC #$0050
$86:A2C7 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:A2CA BD E2 A2    LDA $A2E2,x[$86:A2E2]
$86:A2CD 99 47 1B    STA $1B47,y[$7E:1B69]
$86:A2D0 8A          TXA
$86:A2D1 99 FF 1A    STA $1AFF,y[$7E:1B21]
$86:A2D4 28          PLP
$86:A2D5 60          RTS

$86:A2D6             dw 0040, 0048, 0050, FFC0, FFB8, FFB0
$86:A2E2             dw A197, A1C1, A1EB, A211, A23B, A265
}
...
$86:A2F4 18          CLC
$86:A2F5 69 1C 00    ADC #$001C
$86:A2F8 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:A2FB A9 3C 00    LDA #$003C
$86:A2FE 99 FF 1A    STA $1AFF,y[$7E:1B21]
}
...
$86:A310 99 BB 19    STA $19BB,y[$7E:19DD]
$86:A313 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$86:A316 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:A319 28          PLP
$86:A31A 60          RTS
}
...
;;; $A327: RTS. Pre-instruction - enemy projectile $A379 ;;;
{
$86:A327 60          RTS
}
...
$86:A32B F0 07       BEQ $07    [$A334]
$86:A32D DE FF 1A    DEC $1AFF,x[$7E:1B21]
$86:A330 F0 02       BEQ $02    [$A334]
$86:A332 10 2F       BPL $2F    [$A363]

$86:A334 AD FA 0A    LDA $0AFA  [$7E:0AFA]
$86:A337 18          CLC
$86:A338 69 1C 00    ADC #$001C
...
$86:A348 30 19       BMI $19    [$A363]
$86:A34A A9 48 00    LDA #$0048
$86:A34D 8D FA 0A    STA $0AFA  [$7E:0AFA]
$86:A350 A9 01 00    LDA #$0001
$86:A353 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:A356 A9 8B A2    LDA #$A28B
$86:A359 9D 47 1B    STA $1B47,x[$7E:1B69]
$86:A35C A9 0E 00    LDA #$000E
$86:A35F 22 84 F0 90 JSL $90F084[$90:F084]
...
$86:A367 C9 48 00    CMP #$0048
$86:A36A D0 0C       BNE $0C    [$A378]
$86:A36C A9 01 00    LDA #$0001
$86:A36F 9D 8F 1B    STA $1B8F,x[$7E:1BAF]
$86:A372 A9 8B A2    LDA #$A28B
$86:A375 9D 47 1B    STA $1B47,x[$7E:1B67]

$86:A378 60          RTS
}


;;; $A387: Enemy projectiles - Ceres elevator ;;;
{
;                        __________________________________ Initialisation AI
;                       |     _____________________________ Pre-instruction
;                       |    |     ________________________ Instruction list
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:A379             dx A2A1,A327,A197,08,08,3000,0000,A197
...
;;; $A3A3: Initialisation AI / pre-instruction - enemy projectile $A3B2 (pre-Phantoon room enemy projectile) ;;;
{
...
;;; $A3AA: Instruction list - enemy projectile $A3B2 (pre-Phantoon room enemy projectile) ;;;
{
...
;;; $A3B2: Enemy projectile - pre-Phantoon room ;;;
{
;                        __________________________________ Initialisation AI
;                       |     _____________________________ Pre-instruction
;                       |    |     ________________________ Instruction list
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:A3B0             dx A3A3,A3A3,A3AA,00,00,3000,0000,84FC ; Pre-Phantoon room enemy projectile, fixes BG2 vertical scrolling?
}
...
$86:A3C1 9D 4B 1A    STA $1A4B,x[$7E:1A59]  ;} Enemy projectile X position = [enemy projectile $1AFF]
$86:A3C4 BD 23 1B    LDA $1B23,x[$7E:1B31]  ;\
$86:A3C7 9D 93 1A    STA $1A93,x[$7E:1AA1]  ;} Enemy projectile Y position = [enemy projectile $1B23]
$86:A3CA 60          RTS
}
...
$86:A3CB             dx 816A,               ; Clear pre-instruction
                        8230,3000,          ; Enemy projectile properties |= 3000h
                        81D5,0003,          ; Timer = 0003h
                        A3BE,
...
$86:A408             dx A3BE,
                        ...
                        8154                ; Delete
$86:A431             dx 81D5,0002           ; Timer = 0002h
$86:A435             dx A3BE,
...
;;; $A472: Instruction list - enemy projectile $A95B/$A969 (Bomb Torizo low-health drool) ;;;
{
$86:A472             dx 8161,A887,  ; Pre-instruction = $A887
                        8230,3000,  ; Enemy projectile properties |= 3000h
                        0005,8C54,
                        823C,EFFF   ; Enemy projectile properties &= EFFFh
$86:A482             dx 0040,8C54,
                        81AB,A482   ; Go to $A482
}


;;; $A48A: Instruction list ;;;
{
...
{
$86:A49E             dx 8230,3000,  ; Enemy projectile properties |= 3000h
                        0024,8C54,
                        81AB,A48E   ; Go to $A48E
}
...
;;; $A54B: Instruction list - enemy projectile $A993 (Bomb Torizo statue breaking) ;;;
{
...
$86:A731 18          CLC
$86:A732 65 14       ADC $14    [$7E:0014]
$86:A734 99 93 1A    STA $1A93,y
$86:A737 60          RTS

$86:A738             dw FFE2, FFD8, FFD1, FFE1, FFEB, FFFF, FFE4, FFD5, FFD0, FFE1, FFEB
$86:A74E             dw FFCC, FFE4, FFF5, 0009, 0015, 0014, FFCC, FFE5, FFF6, 0009, 0014
}
...
$86:A767 22 90 82 84 JSL $848290[$84:8290]
$86:A76B AE 93 19    LDX $1993  [$7E:1993]
$86:A76E BD AB A7    LDA $A7AB,x[$86:A7AB]
$86:A771 99 47 1B    STA $1B47,y[$7E:1B69]
...
$86:A798 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:A79B BD 0B A8    LDA $A80B,x[$86:A80B]
$86:A79E 99 23 1B    STA $1B23,y[$7E:1B45]
$86:A7A1 B9 D7 1B    LDA $1BD7,y[$7E:1BF9]
$86:A7A4 09 00 10    ORA #$1000
$86:A7A7 99 D7 1B    STA $1BD7,y[$7E:1BF9]
$86:A7AA 60          RTS

$86:A7AB             dw A4C3,A4D4,A4E5,A4F6,A507,A518,A529,A53A,A54B,A55C,A56D,A57E,A58F,A5A0,A5B1,A5C2
...
{
$86:A81B AE 54 0E    LDX $0E54  [$7E:0E54]
$86:A81E BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:A821 99 4B 1A    STA $1A4B,y[$7E:1A59]
$86:A824 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:A827 99 93 1A    STA $1A93,y[$7E:1AA1]
$86:A82A 3C B4 0F    BIT $0FB4,x[$7E:0FB4]
$86:A82D 30 06       BMI $06    [$A835]
$86:A82F EE 93 19    INC $1993  [$7E:1993]
$86:A832 EE 93 19    INC $1993  [$7E:1993]

$86:A835 EE 93 19    INC $1993  [$7E:1993]
$86:A838 EE 93 19    INC $1993  [$7E:1993]
$86:A83B AE 93 19    LDX $1993  [$7E:1993]
$86:A83E B9 4B 1A    LDA $1A4B,y[$7E:1A59]
$86:A841 18          CLC
$86:A842 7D 59 A8    ADC $A859,x[$86:A85D]
$86:A845 99 4B 1A    STA $1A4B,y[$7E:1A59]
$86:A848 99 FF 1A    STA $1AFF,y[$7E:1B0D]
$86:A84B B9 93 1A    LDA $1A93,y[$7E:1AA1]
$86:A84E 18          CLC
$86:A84F 7D 65 A8    ADC $A865,x[$86:A869]
$86:A852 99 93 1A    STA $1A93,y[$7E:1AA1]
$86:A855 99 23 1B    STA $1B23,y[$7E:1B31]
$86:A858 60          RTS

$86:A859             dw 0000, 000C, FFF4, 0000, 0010, FFF0
$86:A865             dw FFF8, FFF8, FFF8, FFEC, FFEC, FFEC
}


;;; $A871: Initialisation AI - enemy projectile $A9AF (torizo death explosion) ;;;
{
$86:A871 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:A874 BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:A877 99 4B 1A    STA $1A4B,y[$7E:1A63]
$86:A87A 99 FF 1A    STA $1AFF,y[$7E:1B17]
$86:A87D BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:A880 99 93 1A    STA $1A93,y[$7E:1AAB]
$86:A883 99 23 1B    STA $1B23,y[$7E:1B3B]
$86:A886 60          RTS
}
...
;;; $A887:  ;;;
{
$86:A887 20 B6 88    JSR $88B6  [$86:88B6]
$86:A88A B0 3F       BCS $3F    [$A8CB]
$86:A88C BD B7 1A    LDA $1AB7,x[$7E:1AC7]
$86:A88F 10 0E       BPL $0E    [$A89F]
$86:A891 18          CLC
$86:A892 69 04 00    ADC #$0004
$86:A895 30 03       BMI $03    [$A89A]
$86:A897 A9 03 00    LDA #$0003

$86:A89A 9D B7 1A    STA $1AB7,x[$7E:1AD3]
$86:A89D 80 0C       BRA $0C    [$A8AB]

$86:A89F 38          SEC
$86:A8A0 E9 04 00    SBC #$0004
$86:A8A3 10 03       BPL $03    [$A8A8]
$86:A8A5 A9 03 00    LDA #$0003

$86:A8A8 9D B7 1A    STA $1AB7,x[$7E:1AC7]

$86:A8AB 20 7B 89    JSR $897B  [$86:897B]
$86:A8AE 3C DB 1A    BIT $1ADB,x[$7E:1AEB]
$86:A8B1 30 02       BMI $02    [$A8B5]
$86:A8B3 B0 23       BCS $23    [$A8D8]

$86:A8B5 BD DB 1A    LDA $1ADB,x[$7E:1AEB]
$86:A8B8 18          CLC
$86:A8B9 69 10 00    ADC #$0010
$86:A8BC 9D DB 1A    STA $1ADB,x[$7E:1AEB]
$86:A8BF 29 00 F0    AND #$F000
$86:A8C2 C9 00 10    CMP #$1000
$86:A8C5 D0 03       BNE $03    [$A8CA]
$86:A8C7 9E 97 19    STZ $1997,x

$86:A8CA 60          RTS

$86:A8CB A9 8A A4    LDA #$A48A
$86:A8CE 9D 47 1B    STA $1B47,x
$86:A8D1 A9 01 00    LDA #$0001
$86:A8D4 9D 8F 1B    STA $1B8F,x
$86:A8D7 60          RTS

$86:A8D8 BD 93 1A    LDA $1A93,x[$7E:1AA3]
$86:A8DB 38          SEC
$86:A8DC E9 03 00    SBC #$0003
$86:A8DF 9D 93 1A    STA $1A93,x[$7E:1AA3]
$86:A8E2 A9 8E A4    LDA #$A48E
$86:A8E5 9D 47 1B    STA $1B47,x[$7E:1B57]
$86:A8E8 A9 01 00    LDA #$0001
$86:A8EB 9D 8F 1B    STA $1B8F,x[$7E:1B9F]
$86:A8EE 60          RTS
}


;;; $A8EF: Pre-instruction - Bomb Torizo statue breaking / enemy projectile $A977 ;;;
{
$86:A8EF 20 7B 89    JSR $897B  [$86:897B]
$86:A8F2 3C DB 1A    BIT $1ADB,x[$7E:1AFD]
$86:A8F5 30 02       BMI $02    [$A8F9]
$86:A8F7 B0 19       BCS $19    [$A912]

$86:A8F9 BD DB 1A    LDA $1ADB,x[$7E:1AFD]
$86:A8FC 18          CLC
$86:A8FD 6D 23 1B    ADC $1B23  [$7E:1B23]
$86:A900 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:A903 29 00 F0    AND #$F000
$86:A906 C9 00 10    CMP #$1000
$86:A909 D0 06       BNE $06    [$A911]
$86:A90B A9 00 10    LDA #$1000
$86:A90E 9D DB 1A    STA $1ADB,x

$86:A911 60          RTS

$86:A912 A9 18 A9    LDA #$A918
$86:A915 9D 03 1A    STA $1A03,x[$7E:1A25]
$86:A918 60          RTS
}
...
;;; $A91A:  ;;;
{
$86:A91A 9E B7 1A    STZ $1AB7,x
$86:A91D A5 8D       LDA $8D    [$7E:008D]
$86:A91F 89 00 01    BIT #$0100
$86:A922 F0 06       BEQ $06    [$A92A]
$86:A924 A9 00 01    LDA #$0100
$86:A927 9D B7 1A    STA $1AB7,x

$86:A92A A5 8D       LDA $8D    [$7E:008D]
$86:A92C 89 00 02    BIT #$0200
$86:A92F F0 06       BEQ $06    [$A937]
$86:A931 A9 00 FF    LDA #$FF00
$86:A934 9D B7 1A    STA $1AB7,x

$86:A937 20 B6 88    JSR $88B6  [$86:88B6]
$86:A93A 9E DB 1A    STZ $1ADB,x
$86:A93D A5 8D       LDA $8D    [$7E:008D]
$86:A93F 89 00 04    BIT #$0400
$86:A942 F0 06       BEQ $06    [$A94A]
$86:A944 A9 00 01    LDA #$0100
$86:A947 9D DB 1A    STA $1ADB,x

$86:A94A A5 8D       LDA $8D    [$7E:008D]
$86:A94C 89 00 08    BIT #$0800
$86:A94F F0 06       BEQ $06    [$A957]
$86:A951 A9 00 FF    LDA #$FF00
$86:A954 9D DB 1A    STA $1ADB,x

$86:A957 20 7B 89    JSR $897B  [$86:897B]
$86:A95A 60          RTS
}
...
$86:AA7E 99 4B 1A    STA $1A4B,y
$86:AA81 AD FA 0A    LDA $0AFA  [$7E:0AFA]
$86:AA84 38          SEC
$86:AA85 E9 24 00    SBC #$0024
...
$86:AB8F 85 12       STA $12    [$7E:0012]
$86:AB91 BD 93 1A    LDA $1A93,x[$7E:1AA9]
$86:AB94 85 14       STA $14    [$7E:0014]
$86:AB96 AD 9F 07    LDA $079F  [$7E:079F]
$86:AB99 F0 05       BEQ $05    [$ABA0]
$86:AB9B B9 02 00    LDA $0002,y[$86:AB86]
$86:AB9E 80 03       BRA $03    [$ABA3]

$86:ABA0 B9 00 00    LDA $0000,y[$86:AB84]
...
$86:ABB1 99 47 1B    STA $1B47,y[$7E:1B69]
...
{
$86:ABEB AE 54 0E    LDX $0E54  [$7E:0E54]
$86:ABEE BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:ABF1 85 12       STA $12    [$7E:0012]
$86:ABF3 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:ABF6 85 14       STA $14    [$7E:0014]
$86:ABF8 3C B4 0F    BIT $0FB4,x[$7E:0FB4]
$86:ABFB 30 05       BMI $05    [$AC02]
$86:ABFD A2 12 AC    LDX #$AC12
$86:AC00 80 03       BRA $03    [$AC05]

$86:AC02 A2 08 AC    LDX #$AC08

$86:AC05 4C AE AB    JMP $ABAE  [$86:ABAE]
...
{
$86:AC7C AE 54 0E    LDX $0E54  [$7E:0E54]
$86:AC7F BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:AC82 85 12       STA $12    [$7E:0012]
$86:AC84 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:AC87 85 14       STA $14    [$7E:0014]
$86:AC89 3C B4 0F    BIT $0FB4,x[$7E:0FB4]
$86:AC8C 30 05       BMI $05    [$AC93]
$86:AC8E A2 A3 AC    LDX #$ACA3
$86:AC91 80 03       BRA $03    [$AC96]

$86:AC93 A2 99 AC    LDX #$AC99

$86:AC96 4C AE AB    JMP $ABAE  [$86:ABAE]
...
{
$86:ACAD 20 B6 88    JSR $88B6  [$86:88B6]
$86:ACB0 B0 20       BCS $20    [$ACD2]
$86:ACB2 20 7B 89    JSR $897B  [$86:897B]
...
{
$86:ACFA 20 B6 88    JSR $88B6  [$86:88B6]
...
$86:AD09 20 7B 89    JSR $897B  [$86:897B]
...
{
$86:AE15 22 11 81 80 JSL $808111[$80:8111]
$86:AE19 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:AE1C AD E5 05    LDA $05E5  [$7E:05E5]
$86:AE1F 29 01 00    AND #$0001
$86:AE22 F0 05       BEQ $05    [$AE29]
$86:AE24 A9 F4 FF    LDA #$FFF4
$86:AE27 80 03       BRA $03    [$AE2C]

$86:AE29 A9 14 00    LDA #$0014

$86:AE2C 18          CLC
$86:AE2D 7D 7E 0F    ADC $0F7E,x[$7E:0F7E]
...
{
$86:AE6C 20 B6 88    JSR $88B6  [$86:88B6]
$86:AE6F B0 1E       BCS $1E    [$AE8F]
...
$86:AE86 C9 00 10    CMP #$1000
$86:AE89 D0 03       BNE $03    [$AE8E]
$86:AE8B 9E 97 19    STZ $1997,x

$86:AE8E 60          RTS

$86:AE8F A9 E5 AD    LDA #$ADE5
$86:AE92 9D 47 1B    STA $1B47,x[$7E:1B55]
$86:AE95 A9 01 00    LDA #$0001
$86:AE98 9D 8F 1B    STA $1B8F,x[$7E:1B9D]
$86:AE9B BD 4B 1A    LDA $1A4B,x[$7E:1A59]
$86:AE9E 9D FF 1A    STA $1AFF,x[$7E:1B0D]
$86:AEA1 BD 93 1A    LDA $1A93,x[$7E:1AA1]
$86:AEA4 9D 23 1B    STA $1B23,x[$7E:1B31]
$86:AEA7 60          RTS
}
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:AEA8             dx AE15,AE6C,ADBF,03,14,100A,0000,84FC ; Bomb Torizo sonic boom
$86:AEB6             dx AE15,AE6C,ADBF,03,14,1078,0000,84FC ; Golden Torizo sonic boom
}
...
;;; $AEDC: Instruction list - enemy projectile $AF76 ;;;
{
...
;;; $AEFC: Initialisation AI - enemy projectile $AF68/$AF76 (Wrecked Ship chozo spike clearing footsteps) ;;;
{
$86:AEFC AE 54 0E    LDX $0E54  [$7E:0E54]
$86:AEFF BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:AF02 18          CLC
$86:AF03 6D 93 19    ADC $1993  [$7E:1993]
$86:AF06 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:AF09 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:AF0C 18          CLC
$86:AF0D 69 1C 00    ADC #$001C
...
{
$86:AF14             dx 81D5,0040           ; Timer = 0040h
$86:AF18             dx AF36,
...
$86:AF46 99 FF 1A    STA $1AFF,y[$7E:1B1B]
$86:AF49 A9 BC 00    LDA #$00BC
$86:AF4C 99 23 1B    STA $1B23,y[$7E:1B3F]
$86:AF4F 60          RTS
}
...
$86:AF76             dx AEFC,84FB,AEDC,00,00,3000,0000,84FC
...
{
$86:B001 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:B004 BD 7A 0F    LDA $0F7A,x
$86:B007 85 12       STA $12    [$7E:0012]
$86:B009 BD 7E 0F    LDA $0F7E,x
$86:B00C 85 14       STA $14    [$7E:0014]
...
$86:B01F 99 FF 1A    STA $1AFF,y
$86:B022 30 05       BMI $05    [$B029]
$86:B024 A2 39 B0    LDX #$B039
$86:B027 80 03       BRA $03    [$B02C]

$86:B029 A2 2F B0    LDX #$B02F

$86:B02C 4C AE AB    JMP $ABAE  [$86:ABAE]

$86:B02F             dw B11C,0010,0080,FFFF,FE80
$86:B039             dw B104,FFF0,FF80,FFFF,FE80
}
...
$86:B048 20 B6 88    JSR $88B6  [$86:88B6]
...
$86:B060 20 7B 89    JSR $897B  [$86:897B]
...
;;; $B0B9:  ;;;
{
$86:B0B9 20 B6 88    JSR $88B6  [$86:88B6]
...
;;; $B0DD:  ;;;
{
$86:B0DD 20 7B 89    JSR $897B  [$86:897B]
...
;;; $B104: Instruction list - enemy projectile $B1C0 (Golden Torizo egg) ;;;
{
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:B1C0             dx B001,B043,B104,07,07,6064,0000,AB25 ; Golden Torizo egg
}
...
{
$86:B237 20 B6 88    JSR $88B6  [$86:88B6]
$86:B23A B0 20       BCS $20    [$B25C]
$86:B23C 20 7B 89    JSR $897B  [$86:897B]
...
;;; $B2C1: Instruction list - enemy projectile ;;;
{
...
{
$86:B328 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:B32B BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:B32E 85 12       STA $12    [$7E:0012]
$86:B330 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:B333 85 14       STA $14    [$7E:0014]
$86:B335 3C B4 0F    BIT $0FB4,x[$7E:0FB4]
$86:B338 30 05       BMI $05    [$B33F]
$86:B33A A2 80 B3    LDX #$B380
$86:B33D 80 03       BRA $03    [$B342]

$86:B33F A2 76 B3    LDX #$B376

$86:B342 20 AE AB    JSR $ABAE  [$86:ABAE]
$86:B345 22 11 81 80 JSL $808111[$80:8111]
$86:B349 29 1E 00    AND #$001E
$86:B34C 38          SEC
$86:B34D E9 10 00    SBC #$0010
$86:B350 18          CLC
$86:B351 69 C0 00    ADC #$00C0
$86:B354 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:B357 3C B4 0F    BIT $0FB4,x[$7E:0FB4]
$86:B35A 30 04       BMI $04    [$B360]
$86:B35C 18          CLC
$86:B35D 69 80 00    ADC #$0080
...
$86:B376             dw B410,0014,0400,FFE2,0400
$86:B380             dw B410,FFEC,FC00,FFE2,0400
}


;;; $B38A: Pre-instruction - enemy projectile $B428 (Golden Torizo eye beam) ;;;
{
$86:B38A 20 B6 88    JSR $88B6  [$86:88B6]
$86:B38D B0 06       BCS $06    [$B395]
$86:B38F 20 7B 89    JSR $897B  [$86:897B]
$86:B392 B0 09       BCS $09    [$B39D]
$86:B394 60          RTS

$86:B395 A9 CD B3    LDA #$B3CD
$86:B398 9D 47 1B    STA $1B47,x
$86:B39B 80 14       BRA $14    [$B3B1]
...
$86:B3AE 9D 47 1B    STA $1B47,x[$7E:1B69]

$86:B3B1 A9 01 00    LDA #$0001
$86:B3B4 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:B3B7 60          RTS
}
...
;;; $B3CD: Instruction list ;;;
{
$86:B3CD             dx 816A,       ; Clear pre-instruction
                        0004,8D9C,
                        0004,8DA3,
                        0004,8DB9,
                        0004,8DCF,
...
;;; $B3E5: Instruction list ;;;
{
$86:B3E5             dx 816A        ; Clear pre-instruction
...
;;; $B410: Instruction list - enemy projectile $B428 (Golden Torizo eye beam) ;;;
{
...
{
$86:B428             dx B328,B38A,B410,03,03,700A,0000,84FC ; Golden Torizo eye beam
}
...
{
$86:B443             dx 816A,               ; Clear pre-instruction
                        81D5,0001           ; Timer = 0001h
...
$86:B4A0 99 4B 1A    STA $1A4B,y[$7E:1A69]
$86:B4A3 99 FF 1A    STA $1AFF,y[$7E:1B1D]
$86:B4A6 A9 88 08    LDA #$0888
$86:B4A9 99 93 1A    STA $1A93,y[$7E:1AB1]
$86:B4AC 99 23 1B    STA $1B23,y[$7E:1B41]
$86:B4AF 60          RTS
}
...
;;; $B4BF: Instruction list - enemy projectile $B5CB (lava seahorse fireball) ;;;
{
...
$86:B58A 10 18       BPL $18    [$B5A4]
$86:B58C 18          CLC
$86:B58D 69 20 00    ADC #$0020
$86:B590 9D DB 1A    STA $1ADB,x[$7E:1AFB]
$86:B593 30 19       BMI $19    [$B5AE]
$86:B595 3C B7 1A    BIT $1AB7,x[$7E:1AD7]
$86:B598 10 05       BPL $05    [$B59F]
$86:B59A A9 D7 B4    LDA #$B4D7
$86:B59D 80 10       BRA $10    [$B5AF]

$86:B59F A9 E3 B4    LDA #$B4E3
...
$86:B5B5 9D 8F 1B    STA $1B8F,x[$7E:1BAF]
$86:B5B8 60          RTS
}
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:B5CB             dx B4EF,B535,B4BF,02,02,000A,0000,84FC ; Lava seahorse fireball
}


;;; $B5D9: Instruction list - enemy projectile $B743 (eye door projectile) ;;;
{
$86:B5D9             dx 0004,900B,
                        0003,9021,
                        0002,9037,
                        82A5,       ; Calculate direction towards Samus
                        8161,B6B9   ; Pre-instruction = $B6B9
$86:B5EB             dx 0010,904D,
                        81AB,B5EB   ; Go to $B5EB
}


;;; $B5F3: Instruction list ;;;
{
$86:B5F3             dx 816A,       ; Clear pre-instruction
                        0002,9037,
                        0003,9021,
                        0004,900B,
                        8154        ; Delete
...
;;; $B615: Instruction list - enemy projectile $B751 (eye door sweat) ;;;
{
...
{
$86:B62D AE 27 1C    LDX $1C27  [$7E:1C27]
$86:B630 BD C7 1D    LDA $1DC7,x[$7E:1E0D]
$86:B633 99 23 1B    STA $1B23,y[$7E:1B45]
$86:B636 22 90 82 84 JSL $848290[$84:8290]
$86:B63A AE 93 19    LDX $1993  [$7E:1993]
...
$86:B65B             dw FFF0,0010, FFA0,FFC0, FF80,FFE0, FFA0,0040, FF80,0020, 0010,0010, 0060,FFC0, 0070,FFC0,
                        0080,FFC0, 0090,FFC0
}
...
$86:B686 22 90 82 84 JSL $848290[$84:8290]
...
$86:B6A1 AE 93 19    LDX $1993  [$7E:1993]
$86:B6A4 BD B1 B6    LDA $B6B1,x[$86:B6B1]
$86:B6A7 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:B6AA BD B3 B6    LDA $B6B3,x[$86:B6B3]
$86:B6AD 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:B6B0 60          RTS
...
;;; $B6B9: Pre-instruction - eye door projectile ;;;
{
...
$86:B6B9 20 B6 88    JSR $88B6  [$86:88B6]  ; Enemy projectile / block collision - horizontal
$86:B6BC B0 49       BCS $49    [$B707]
$86:B6BE 20 7B 89    JSR $897B  [$86:897B]
$86:B6C1 B0 44       BCS $44    [$B707]
$86:B6C3 9B          TXY
...
$86:B6FD BF B0 D8 7E LDA $7ED8B0,x[$7E:D8B8]
$86:B701 2D E7 05    AND $05E7  [$7E:05E7]
$86:B704 D0 01       BNE $01    [$B707]
$86:B706 60          RTS

$86:B707 A9 F3 B5    LDA #$B5F3
$86:B70A 9D 47 1B    STA $1B47,x[$7E:1B67]
$86:B70D A9 01 00    LDA #$0001
$86:B710 9D 8F 1B    STA $1B8F,x[$7E:1BAF]
$86:B713 60          RTS
}
...
{
$86:B714 20 B6 88    JSR $88B6  [$86:88B6]
$86:B717 20 7B 89    JSR $897B  [$86:897B]
$86:B71A 3C DB 1A    BIT $1ADB,x[$7E:1AFD]
$86:B71D 30 02       BMI $02    [$B721]
$86:B71F B0 0B       BCS $0B    [$B72C]

$86:B721 BD DB 1A    LDA $1ADB,x[$7E:1AFD]
$86:B724 18          CLC
$86:B725 69 0C 00    ADC #$000C
$86:B728 9D DB 1A    STA $1ADB,x[$7E:1AFD]
$86:B72B 60          RTS

$86:B72C BD 93 1A    LDA $1A93,x[$7E:1AB5]
$86:B72F 38          SEC
$86:B730 E9 04 00    SBC #$0004
$86:B733 9D 93 1A    STA $1A93,x[$7E:1AB5]
$86:B736 A9 1D B6    LDA #$B61D
$86:B739 9D 47 1B    STA $1B47,x[$7E:1B69]
$86:B73C A9 01 00    LDA #$0001
$86:B73F 9D 8F 1B    STA $1B8F,x[$7E:1BB1]
$86:B742 60          RTS
}
...
{
; wtf is this data?
$86:B75F             db 94, 52, CE, 39, 08, 21, 84, 24, AD, 35, 29, 25, A5, 14, 42, 18,
                        08, 21, 84, 10, A5, 14, 42, 18, 63, 0C, 21, 04, 42, 08, 00, 00,
                        94, 52, CE, 39, 08, 21, 84, 24, 94, 52, CE, 39, 08, 21, 84, 24,
                        94, 52, CE, 39, 08, 21, 84, 24, 94, 52, CE, 39, 08, 21, 84, 24
}
...
{
$86:B87A AE 93 19    LDX $1993  [$7E:1993]
$86:B87D BD 4B 1A    LDA $1A4B,x[$7E:1A5F]
$86:B880 99 4B 1A    STA $1A4B,y[$7E:1A4F]
$86:B883 AD 5E 19    LDA $195E  [$7E:195E]
$86:B886 38          SEC
$86:B887 E9 04 00    SBC #$0004
...
{
$86:B88E AE 93 19    LDX $1993  [$7E:1993]
$86:B891 BD 0E B9    LDA $B90E,x[$86:B914]
$86:B894 99 4B 1A    STA $1A4B,y[$7E:1A67]
$86:B897 BD 16 B9    LDA $B916,x[$86:B91C]
$86:B89A 99 93 1A    STA $1A93,y[$7E:1AAF]
$86:B89D 8A          TXA
$86:B89E 0A          ASL A
$86:B89F 0A          ASL A
$86:B8A0 A8          TAY
...
$86:B8A7 9F 00 C0 7E STA $7EC000,x[$7E:C1F2]
$86:B8AB C8          INY
$86:B8AC C8          INY
$86:B8AD E8          INX
$86:B8AE E8          INX
...
{
$86:B8B5 AE 93 19    LDX $1993  [$7E:1993]
...
{
$86:B8E8 AE 93 19    LDX $1993  [$7E:1993]
...
{
$86:B8F8 AE 93 19    LDX $1993  [$7E:1993]
$86:B8FB BD 0E B9    LDA $B90E,x[$86:B914]
$86:B8FE 99 4B 1A    STA $1A4B,y[$7E:1A4F]
$86:B901 BD 16 B9    LDA $B916,x[$86:B91C]
$86:B904 99 93 1A    STA $1A93,y[$7E:1A97]
$86:B907 A9 00 FC    LDA #$FC00
$86:B90A 99 DB 1A    STA $1ADB,y[$7E:1ADF]
$86:B90D 60          RTS
}
...
;;; $B90E:  ;;;
{
$86:B90E             dw 0084,007A,009E,0068
$86:B916             dw 0090,0051,0080,0072

$86:B91E             dw 6BFF,033B,0216,0173
                        7F5F,7C1F,5816,300C
                        7F5A,7EC0,6DE0,54E0
                        6BFA,3BE0,2680,1580
}
...
;;; $BACC: Instruction list - enemy projectile $BACC ;;;
{
...
{
$86:BB30 AE 54 0E    LDX $0E54  [$7E:0E54]
$86:BB33 BF 22 80 7E LDA $7E8022,x
$86:BB37 99 4B 1A    STA $1A4B,y
$86:BB3A BF 24 80 7E LDA $7E8024,x
$86:BB3E 99 93 1A    STA $1A93,y
$86:BB41 5A          PHY
...
{
$86:BE03 20 B6 88    JSR $88B6  [$86:88B6]
$86:BE06 B0 06       BCS $06    [$BE0E]
$86:BE08 20 7B 89    JSR $897B  [$86:897B]
...
$86:BE1A 20 B6 88    JSR $88B6  [$86:88B6]
$86:BE1D 20 7B 89    JSR $897B  [$86:897B]
$86:BE20 60          RTS
...
$86:C035 A9 0C 00    LDA #$000C             ; A = Ch
...
$86:C742 A9 1D 00    LDA #$001D             ;} Spawn dust cloud / explosion enemy projectile
$86:C745 22 97 80 86 JSL $868097[$86:8097]  ;/
...
;;; $CAF6..CB12: Initialisation AI - enemy projectile $CBBB (time bomb set Japanese text) ;;;
{
...
$86:CC28 A9 0C 00    LDA #$000C             ; A = Ch
...
$86:CFFA 20 7B 89    JSR $897B  [$86:897B]
$86:CFFD B0 1B       BCS $1B    [$D01A]
$86:CFFF 20 B6 88    JSR $88B6  [$86:88B6]
...
$86:D0F2 20 B6 88    JSR $88B6  [$86:88B6]
$86:D0F5 B0 12       BCS $12    [$D109]
$86:D0F7 20 7B 89    JSR $897B  [$86:897B]
...
$86:D12E 20 B6 88    JSR $88B6  [$86:88B6]
$86:D131 B0 0F       BCS $0F    [$D142]
$86:D133 20 7B 89    JSR $897B  [$86:897B]
...
$86:D272 20 B6 88    JSR $88B6  [$86:88B6]
...
$86:D286 20 7B 89    JSR $897B  [$86:897B]
...
$86:D3C8 20 B6 88    JSR $88B6  [$86:88B6]
$86:D3CB B0 05       BCS $05    [$D3D2]
$86:D3CD 20 7B 89    JSR $897B  [$86:897B]
...
{
$86:D96A             dw D92E, D93A, D946, D94C, D958, D964, D934, D940, D952, D95E
}


;;; $D97E: Spike shooting plant function pointers ;;;
{
$86:D97E             dw DA8E, DA98, DA93, DA8E, DA9D, DA93, DAA2, DAB2, DAAA, DABA
}


;;; $D992: Initialisation AI - enemy projectile $DAFE (spike shooting plant spikes) ;;;
{
$86:D992 AD 93 19    LDA $1993  [$7E:1993]
$86:D995 99 FF 1A    STA $1AFF,y[$7E:1B21]
$86:D998 AA          TAX
$86:D999 BD 6A D9    LDA $D96A,x[$86:D96A]
$86:D99C 99 47 1B    STA $1B47,y[$7E:1B69]
$86:D99F AE 54 0E    LDX $0E54  [$7E:0E54]
$86:D9A2 BD 7A 0F    LDA $0F7A,x[$7E:0F7A]
$86:D9A5 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:D9A8 BD 7C 0F    LDA $0F7C,x[$7E:0F7C]
$86:D9AB 99 27 1A    STA $1A27,y[$7E:1A49]
$86:D9AE BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:D9B1 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:D9B4 BD 80 0F    LDA $0F80,x[$7E:0F80]
$86:D9B7 99 6F 1A    STA $1A6F,y[$7E:1A91]
$86:D9BA A9 00 FE    LDA #$FE00
$86:D9BD 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:D9C0 A9 00 02    LDA #$0200
$86:D9C3 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:D9C6 AD 93 19    LDA $1993  [$7E:1993]
$86:D9C9 C9 0C 00    CMP #$000C
$86:D9CC 30 0C       BMI $0C    [$D9DA]
$86:D9CE A9 80 FE    LDA #$FE80
$86:D9D1 99 DB 1A    STA $1ADB,y[$7E:1AFB]
$86:D9D4 A9 80 01    LDA #$0180
$86:D9D7 99 B7 1A    STA $1AB7,y[$7E:1AD7]

$86:D9DA 60          RTS
}


;;; $D9DB: Pre-instruction - enemy projectile $DAFE (spike shooting plant spikes) ;;;
{
$86:D9DB 9B          TXY
$86:D9DC BE FF 1A    LDX $1AFF,y[$7E:1B21]
$86:D9DF FC 7E D9    JSR ($D97E,x)[$86:DA8E]
$86:D9E2 20 C2 DA    JSR $DAC2  [$86:DAC2]
$86:D9E5 60          RTS
}
...
{
$86:DA8E BB          TYX
$86:DA8F 20 3A DA    JSR $DA3A  [$86:DA3A]
$86:DA92 60          RTS
}
...
{
$86:DA93 BB          TYX
$86:DA94 20 64 DA    JSR $DA64  [$86:DA64]
$86:DA97 60          RTS
}
...
{
$86:DA98 BB          TYX
$86:DA99 20 E6 D9    JSR $D9E6  [$86:D9E6]
$86:DA9C 60          RTS
}
...
{
$86:DA9D BB          TYX
$86:DA9E 20 10 DA    JSR $DA10  [$86:DA10]
$86:DAA1 60          RTS
}
...
{
$86:DAA2 BB          TYX
$86:DAA3 20 3A DA    JSR $DA3A  [$86:DA3A]
$86:DAA6 20 E6 D9    JSR $D9E6  [$86:D9E6]
$86:DAA9 60          RTS
}
...
{
$86:DAAA BB          TYX
$86:DAAB 20 3A DA    JSR $DA3A  [$86:DA3A]
$86:DAAE 20 10 DA    JSR $DA10  [$86:DA10]
$86:DAB1 60          RTS
}
...
{
$86:DAB2 BB          TYX
$86:DAB3 20 64 DA    JSR $DA64  [$86:DA64]
$86:DAB6 20 E6 D9    JSR $D9E6  [$86:D9E6]
$86:DAB9 60          RTS
}
...
{
$86:DABA BB          TYX
$86:DABB 20 64 DA    JSR $DA64  [$86:DA64]
$86:DABE 20 10 DA    JSR $DA10  [$86:DA10]
$86:DAC1 60          RTS
}
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:DAFE             dx D992,D9DB,D92E,02,02,0005,0000,84FC ; Spike shooting plant spikes
}
...
{
$86:DB5B FC FF 1A    JSR ($1AFF,x)
$86:DB5E 20 B6 DB    JSR $DBB6  [$86:DBB6]
$86:DB61 60          RTS
}
...
;;; $DBF2: Enemy projectile ;;;
{
$86:DBF2             dx DB18,DB5B,DB0C,02,02,0005,0000,84FC
}


;;; $DC00: (Shot) instruction list - enemy projectile $DE88 (spore spawners) ;;;
{
...
$86:DC66 85 12       STA $12    [$7E:0012]
$86:DC68 BD 93 1A    LDA $1A93,x[$7E:1AA5]
$86:DC6B 85 14       STA $14    [$7E:0014]
$86:DC6D A9 7F DF    LDA #$DF7F
...
;;; $DC77: Instruction - spawn spore ;;;
{
$86:DC77 DA          PHX
$86:DC78 5A          PHY
$86:DC79 BD 4B 1A    LDA $1A4B,x[$7E:1A65]
$86:DC7C 85 12       STA $12    [$7E:0012]
$86:DC7E BD 93 1A    LDA $1A93,x[$7E:1AAD]
$86:DC81 85 14       STA $14    [$7E:0014]
...
$86:DC90 99 4B 1A    STA $1A4B,y[$7E:1A5D]
$86:DC93 99 23 1B    STA $1B23,y[$7E:1B35]
$86:DC96 A5 14       LDA $14    [$7E:0014]
$86:DC98 99 93 1A    STA $1A93,y[$7E:1AA5]
...
$86:DCC6 18          CLC
$86:DCC7 69 A0 FF    ADC #$FFA0
$86:DCCA 99 93 1A    STA $1A93,y
$86:DCCD AD 7A 0F    LDA $0F7A  [$7E:0F7A]
$86:DCD0 99 4B 1A    STA $1A4B,y
$86:DCD3 60          RTS
}


;;; $DCD4: Initialisation AI - enemy projectile $DE88 (spore spawners) ;;;
{
...
$86:DCE2 99 93 1A    STA $1A93,y[$7E:1AAD]
$86:DCE5 60          RTS
...
$86:DD33 30 03       BMI $03    [$DD38]
$86:DD35 9E 97 19    STZ $1997,x[$7E:19A1]
...
;;; $DD46: Pre-instruction - enemy projectile $DE88 (spore spawners) ;;;
{
$86:DD46 AF 00 90 7E LDA $7E9000[$7E:9000]
$86:DD4A F0 01       BEQ $01    [$DD4D]
$86:DD4C 60          RTS

$86:DD4D BD 23 1B    LDA $1B23,x[$7E:1B3D]
$86:DD50 D0 16       BNE $16    [$DD68]
$86:DD52 A9 06 DC    LDA #$DC06
$86:DD55 9D 47 1B    STA $1B47,x[$7E:1B61]
$86:DD58 A9 01 00    LDA #$0001
$86:DD5B 9D 8F 1B    STA $1B8F,x[$7E:1BA9]
$86:DD5E 22 11 81 80 JSL $808111[$80:8111]
$86:DD62 29 FF 01    AND #$01FF
$86:DD65 9D 23 1B    STA $1B23,x[$7E:1B3D]

$86:DD68 DE 23 1B    DEC $1B23,x[$7E:1B3D]
$86:DD6B 60          RTS
}
...
$86:DE88             dx DCD4,DD46,DC00,02,02,2000,0000,DC00 ; Spore spawners
}


;;; $DE96: Instruction list - enemy projectile $DFBC/$DFCA (nami/fune fireball) ;;;
{
...
$86:DF2C 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:DF2F BD B8 DE    LDA $DEB8,x[$86:DED4]
$86:DF32 99 B7 1A    STA $1AB7,y[$7E:1AD9]
...
{
$86:DF39 FC FF 1A    JSR ($1AFF,x)[$86:DF6A]
$86:DF3C 20 94 DF    JSR $DF94  [$86:DF94]
$86:DF3F 60          RTS
}
...
;                       |    |    |    |  |  |    |     ___ Shot instruction list
;                       |    |    |    |  |  |    |    |
$86:DFBC             dx DED6,DF39,DE96,04,08,00C8,0000,84FC ; Nami fireball
$86:DFCA             dx DED6,DF39,DE96,04,08,003C,0000,84FC ; Fune fireball
}


;;; $DFD8: Instruction list - enemy projectile $E0E0 (lava thrown by lavaman) ;;;
{
$86:DFD8             dx 0001,AB0F,
                        8159        ; Sleep
}
...
$86:DFEF 85 12       STA $12    [$7E:0012]
$86:DFF1 BD 93 1A    LDA $1A93,x[$7E:1AB1]
$86:DFF4 85 14       STA $14    [$7E:0014]
$86:DFF6 A9 3F E8    LDA #$E83F
...
{
$86:E049 FC FF 1A    JSR ($1AFF,x)[$86:E07A]
$86:E04C 20 A4 E0    JSR $E0A4  [$86:E0A4]
$86:E04F 60          RTS
}
...
$86:E056 EB          XBA
$86:E057 22 EA AF A0 JSL $A0AFEA[$A0:AFEA]  ; Sign extend A
$86:E05B 18          CLC
...
$86:E080 EB          XBA
$86:E081 22 EA AF A0 JSL $A0AFEA[$A0:AFEA]  ; Sign extend A
$86:E085 18          CLC
...
;;; $E138: Instruction list - enemy projectile $E517/$E525 (eye door smoke) ;;;
{
...
$86:E5E2 22 90 82 84 JSL $848290[$84:8290]  ;} Calculate current PLM co-ordinates
$86:E5E6 BD 87 1C    LDA $1C87,x[$7E:1CD5]  ;\
$86:E5E9 99 FF 1A    STA $1AFF,y[$7E:1B21]  ;} Projectile $1AFF = [current PLM level data index]
$86:E5EC AD 29 1C    LDA $1C29  [$7E:1C29]  ;\
$86:E5EF 0A          ASL A                  ;|
$86:E5F0 0A          ASL A                  ;|
$86:E5F1 0A          ASL A                  ;} Projectile X position = [current PLM X position] * 10h
$86:E5F2 0A          ASL A                  ;|
...
$86:E5FA 0A          ASL A                  ;|
$86:E5FB 0A          ASL A                  ;|
$86:E5FC 0A          ASL A                  ;} Projectile Y position = [current PLM Y position] * 10h + [$12]
$86:E5FD 18          CLC                    ;|
...
{
; Returns 0000 if on screen, 0001 if off screen
$86:E6E0 DA          PHX
$86:E6E1 5A          PHY
$86:E6E2 BD 4B 1A    LDA $1A4B,x[$7E:1A6D]  ;\
$86:E6E5 CD 11 09    CMP $0911  [$7E:0911]  ;} Return 1 if enemy projectile is left of screen
$86:E6E8 30 32       BMI $32    [$E71C]     ;/
$86:E6EA AD 11 09    LDA $0911  [$7E:0911]  ;\
$86:E6ED 18          CLC                    ;|
$86:E6EE 69 00 01    ADC #$0100             ;|
$86:E6F1 8D 20 0E    STA $0E20  [$7E:0E20]  ;} Return 1 if enemy projectile is right of screen
...
$86:E6FF CD 15 09    CMP $0915  [$7E:0915]  ;} Return 1 if enemy projectile is above screen
$86:E702 30 18       BMI $18    [$E71C]     ;/
$86:E704 AD 15 09    LDA $0915  [$7E:0915]  ;\
$86:E707 18          CLC                    ;|
$86:E708 69 00 01    ADC #$0100             ;|
$86:E70B 8D 20 0E    STA $0E20  [$7E:0E20]  ;} Return 1 if enemy projectile is 32+ pixels below screen
$86:E70E BD 93 1A    LDA $1A93,x[$7E:1AB5]  ;|
$86:E711 CD 20 0E    CMP $0E20  [$7E:0E20]  ;|
$86:E714 10 06       BPL $06    [$E71C]     ;/
$86:E716 7A          PLY                    ;\
$86:E717 FA          PLX                    ;|
$86:E718 A9 00 00    LDA #$0000             ;} Else return 0
$86:E71B 60          RTS                    ;/

$86:E71C 7A          PLY                    ;\
$86:E71D FA          PLX                    ;|
$86:E71E A9 01 00    LDA #$0001             ;} Return 1
$86:E721 60          RTS                    ;/
}
...
$86:E761 BD 27 1A    LDA $1A27,x[$7E:1A2F]
$86:E764 38          SEC
$86:E765 FD FF 1A    SBC $1AFF,x[$7E:1B07]
$86:E768 9D 27 1A    STA $1A27,x[$7E:1A2F]
...
$86:E796 BD 6F 1A    LDA $1A6F,x[$7E:1A77]
$86:E799 38          SEC
$86:E79A FD 23 1B    SBC $1B23,x[$7E:1B2B]
$86:E79D 9D 6F 1A    STA $1A6F,x[$7E:1A77]
...
$86:E7AE 99 4B 1A    STA $1A4B,y[$7E:1A6D]
$86:E7B1 A5 14       LDA $14    [$7E:0014]
$86:E7B3 99 93 1A    STA $1A93,y[$7E:1AB5]
$86:E7B6 AD F6 0A    LDA $0AF6  [$7E:0AF6]
$86:E7B9 38          SEC
$86:E7BA F9 4B 1A    SBC $1A4B,y[$7E:1A6D]
$86:E7BD 85 12       STA $12    [$7E:0012]
$86:E7BF AD FA 0A    LDA $0AFA  [$7E:0AFA]
$86:E7C2 38          SEC
$86:E7C3 F9 93 1A    SBC $1A93,y[$7E:1AB5]
$86:E7C6 85 14       STA $14    [$7E:0014]
$86:E7C8 22 AE C0 A0 JSL $A0C0AE[$A0:C0AE]
$86:E7CC 49 FF 00    EOR #$00FF
$86:E7CF 1A          INC A
$86:E7D0 18          CLC
$86:E7D1 69 40 00    ADC #$0040
...
$86:E7E0 85 14       STA $14    [$7E:0014]
$86:E7E2 22 43 B6 A0 JSL $A0B643[$A0:B643]  ; ($18.$16, $1C.$1A) = co-ordinates of point on quarter circle of radius [$14] at angle [$12] * pi / 80h radians
$86:E7E6 A5 16       LDA $16    [$7E:0016]
$86:E7E8 99 B7 1A    STA $1AB7,y[$7E:1AD9]
$86:E7EB A5 18       LDA $18    [$7E:0018]
$86:E7ED 99 FF 1A    STA $1AFF,y[$7E:1B21]
$86:E7F0 A5 1A       LDA $1A    [$7E:001A]
$86:E7F2 99 DB 1A    STA $1ADB,y[$7E:1AFD]
$86:E7F5 A5 1C       LDA $1C    [$7E:001C]
$86:E7F7 99 23 1B    STA $1B23,y[$7E:1B45]
$86:E7FA 60          RTS
}


;;; $E7FB: Unused. Instruction list ;;;
{
...
;;; $E8F3: Instruction list - enemy projectile $EBA0 (Botwoon's body) ;;;
{
...
;;; $E9F1: Botwoon's body instruction list pointers ;;;
{
$86:E9F1             dw E8AF, E89B, E887, E873, E85F, E837, E823, E80F, E8F3, E8F3, E8F3, E8F3, E8F3, E8F3, E8F3, E8F3,
                        E8C3, E8ED, E8E7, E8E1, E8DB, E8D5, E8CF, E8C9, E8F3, E8F3, E8F3, E8F3, E8F3, E8F3, E8F3, E8F3
}
...
$86:EA4A D0 03       BNE $03    [$EA4F]     ;} If [Botwoon $0FA8] = 0:
...
$86:EA69 98          TYA                    ;} $7E:7800 + [Botwoon $0FA8] = [enemy projectile index]
$86:EA6A 9F 00 78 7E STA $7E7800,x[$7E:7818];/
$86:EA6E DA          PHX                    ;\
$86:EA6F AA          TAX                    ;|
$86:EA70 A9 02 00    LDA #$0002             ;} Enemy projectile $7E:F380 = 2
$86:EA73 9F 80 F3 7E STA $7EF380,x[$7E:F3A2];|
$86:EA77 FA          PLX                    ;/
$86:EA78 A9 01 00    LDA #$0001             ;\
$86:EA7B 9F 20 78 7E STA $7E7820,x[$7E:7838];} $7E:7820 + [Botwoon $0FA8] = 1
$86:EA7F 60          RTS
}
...
$86:EA84 F0 0E       BEQ $0E    [$EA94]     ;} If [Botwoon $7E:8020] != 0:
$86:EA86 BD B7 1A    LDA $1AB7,x[$7E:1AD9]  ;\
$86:EA89 C9 98 EA    CMP #$EA98             ;} If [enemy projectile function] = $EA98:
...
$86:EB7A 8F 3E 88 7E STA $7E883E[$7E:883E]  ;} Botwoon $7E:883E = 1
...
$86:EBCD 99 4B 1A    STA $1A4B,y[$7E:1A53]
$86:EBD0 BD 7E 0F    LDA $0F7E,x[$7E:0F7E]
$86:EBD3 99 93 1A    STA $1A93,y[$7E:1A9B]
$86:EBD6 A9 AE EB    LDA #$EBAE
$86:EBD9 99 47 1B    STA $1B47,y[$7E:1B4F]
$86:EBDC BB          TYX
$86:EBDD AD 0B 06    LDA $060B  [$7E:060B]
$86:EBE0 9F DC 97 7E STA $7E97DC,x[$7E:97E4]
$86:EBE4 85 12       STA $12    [$7E:0012]
$86:EBE6 AD 93 19    LDA $1993  [$7E:1993]
$86:EBE9 85 14       STA $14    [$7E:0014]
$86:EBEB 22 43 B6 A0 JSL $A0B643[$A0:B643]  ; ($18.$16, $1C.$1A) = co-ordinates of point on quarter circle of radius [$14] at angle [$12] * pi / 80h radians
$86:EBEF A5 16       LDA $16    [$7E:0016]
$86:EBF1 99 B7 1A    STA $1AB7,y[$7E:1ABF]
$86:EBF4 A5 18       LDA $18    [$7E:0018]
$86:EBF6 99 FF 1A    STA $1AFF,y[$7E:1B07]
$86:EBF9 A5 1A       LDA $1A    [$7E:001A]
$86:EBFB 99 DB 1A    STA $1ADB,y[$7E:1AE3]
$86:EBFE A5 1C       LDA $1C    [$7E:001C]
...
{
$86:EC05 20 3E E7    JSR $E73E  [$86:E73E]
$86:EC08 20 0C EC    JSR $EC0C  [$86:EC0C]
$86:EC0B 60          RTS
}
...
$86:F3F5 20 7B 89    JSR $897B  [$86:897B]

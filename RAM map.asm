...
$0A02..0E0B: Samus RAM (according to $91:E018)
{
    ...
    $0A64: Grapple connected flags
    {
        ...
        2: Related to Draygon releasing Samus
    }
...
$1F5B..FF: Stack. Lowest observed is $1FC5 by Kejardon, 1FB5 by Jathys
...
$7E:A000..BFFF: Tile table ($A000..A7FF is CRE if not in Ceres, $A470..AF is used for item PLMs). 8 byte entries. Indexed by the tile index of level data / custom background. Tilemap values for four 8x8 tiles
{
    + 0: Top left
    + 2: Top right
    + 4: Bottom left
